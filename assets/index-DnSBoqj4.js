...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function La(){return new Wr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:za(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ra(){return new Wr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:za(),fragmentShader:`
...
`,Cc=500,wc=4,Tc=300,Ec=500,Dc=100,Oc=2e3,kc=10,Ac=`photoSphereViewer`,jc=`psv--capture-event`,Mc=(e=>(e.ROTATE_UP=`ROTATE_UP`,e.ROTATE_DOWN=`ROTATE_DOWN`,e.ROTATE_RIGHT=`ROTATE_RIGHT`,e.ROTATE_LEFT=`ROTATE_LEFT`,e.ZOOM_IN=`ZOOM_IN`,e.ZOOM_OUT=`ZOOM_OUT`,e))(Mc||{}),Nc={MENU:`menu`,TWO_FINGERS:`twoFingers`,CTRL_ZOOM:`ctrlZoom`,ERROR:`error`,DESCRIPTION:`description`},Pc={Enter:`Enter`,Control:`Control`,Escape:`Escape`,Space:` `,PageUp:`PageUp`,PageDown:`PageDown`,ArrowLeft:`ArrowLeft`,ArrowUp:`ArrowUp`,ArrowRight:`ArrowRight`,ArrowDown:`ArrowDown`,Delete:`Delete`,Plus:`+`,Minus:`-`},Fc={arrow:mc,close:hc,download:gc,fullscreenIn:_c,fullscreenOut:vc,info:yc,menu:bc,zoomIn:xc,zoomOut:Sc},Ic={linear:e=>e,inQuad:e=>e*e,outQuad:e=>e*(2-e),inOutQuad:e=>e<.5?2*e*e:-1+(4-2*e)*e,inCubic:e=>e*e*e,outCubic:e=>--e*e*e+1,inOutCubic:e=>e<.5?4*e*e*e:(e-1)*(2*e-2)*(2*e-2)+1,inQuart:e=>e*e*e*e,outQuart:e=>1- --e*e*e*e,inOutQuart:e=>e<.5?8*e*e*e*e:1-8*--e*e*e*e,inQuint:e=>e*e*e*e*e,outQuint:e=>1+--e*e*e*e*e,inOutQuint:e=>e<.5?16*e*e*e*e*e:1+16*--e*e*e*e*e,inSine:e=>1-Math.cos(Math.PI/2*e),outSine:e=>Math.sin(Math.PI/2*e),inOutSine:e=>.5-.5*Math.cos(Math.PI*e),inExpo:e=>2**(10*(e-1)),outExpo:e=>1-2**(-10*e),inOutExpo:e=>(e=e*2-1)<0?.5*2**(10*e):1-.5*2**(-10*e),inCirc:e=>1-Math.sqrt(1-e*e),outCirc:e=>Math.sqrt(1-(e-1)*(e-1)),inOutCirc:e=>(e*=2)<1?.5-.5*Math.sqrt(1-e*e):.5+.5*Math.sqrt(1-(e-=2)*e)},X={};fc(X,{Animation:()=>Hl,Dynamic:()=>Ul,MultiDynamic:()=>Wl,PressHandler:()=>Gl,Slider:()=>ql,SliderDirection:()=>Kl,addClasses:()=>Kc,angle:()=>Bc,applyEulerInverse:()=>Il,checkClosedShadowDom:()=>Bl,checkStylesheet:()=>Rl,checkVersion:()=>zl,cleanCssPosition:()=>kl,clone:()=>ul,createTexture:()=>Pl,cssPositionIsOrdered:()=>Al,dasherize:()=>ol,deepEqual:()=>ml,deepmerge:()=>ll,distance:()=>zc,exitFullscreen:()=>il,firstNonNull:()=>pl,getAbortError:()=>vl,getAngle:()=>Hc,getClosest:()=>Yc,getConfigParser:()=>Ll,getElement:()=>Wc,getEventTarget:()=>Xc,getMatchingTarget:()=>Zc,getPosition:()=>Qc,getShortestArc:()=>Vc,getStyleProperty:()=>$c,getTouchData:()=>el,getXMPValue:()=>Sl,greatArcDistance:()=>Uc,hasParent:()=>Jc,invertResolvableBoolean:()=>_l,isAbortError:()=>yl,isEmpty:()=>dl,isExtendedPosition:()=>xl,isFullscreenEnabled:()=>nl,isNil:()=>fl,isPlainObject:()=>cl,keyPressMatch:()=>al,logWarn:()=>bl,mergePanoData:()=>Vl,parseAngle:()=>Nl,parsePoint:()=>Ol,parseSpeed:()=>jl,removeClasses:()=>qc,requestFullscreen:()=>rl,resolveBoolean:()=>gl,speedToDuration:()=>Ml,sum:()=>Rc,throttle:()=>sl,toggleClass:()=>Gc,wrap:()=>Lc});function Lc(e,t){let n=e%t;return n<0&&(n+=t),n}function Rc(e){return e.reduce((e,t)=>e+t,0)}function zc(e,t){return Math.sqrt((e.x-t.x)**2+(e.y-t.y)**2)}function Bc(e,t){return Math.atan2(t.y-e.y,t.x-e.x)}function Vc(e,t){return[0,Math.PI*2,-Math.PI*2].reduce((n,r)=>{let i=t-e+r;return Math.abs(i)<Math.abs(n)?i:n},1/0)}function Hc(e,t){return Math.acos(Math.cos(e.pitch)*Math.cos(t.pitch)*Math.cos(e.yaw-t.yaw)+Math.sin(e.pitch)*Math.sin(t.pitch))}function Uc([e,t],[n,r]){e-n>Math.PI?e-=2*Math.PI:e-n<-Math.PI&&(e+=2*Math.PI);let i=(n-e)*Math.cos((t+r)/2),a=r-t;return Math.sqrt(i*i+a*a)}function Wc(e){return typeof e==`string`?e.match(/^[a-z]/i)?document.getElementById(e):document.querySelector(e):e}function Gc(e,t,n){n===void 0?e.classList.toggle(t):n?e.classList.add(t):n||e.classList.remove(t)}function Kc(e,t){e.classList.add(...t.split(` `).filter(e=>!!e))}function qc(e,t){e.classList.remove(...t.split(` `).filter(e=>!!e))}function Jc(e,t){let n=e;do{if(n===t)return!0;n=n.parentElement}while(n);return!1}function Yc(e,t){if(!e?.matches)return null;let n=e;do{if(n.matches(t))return n;n=n.parentElement}while(n);return null}function Xc(e){return e?.composedPath()[0]||null}function Zc(e,t){return e?e.composedPath().find(e=>!(e instanceof HTMLElement)&&!(e instanceof SVGElement)?!1:e.matches(t)):null}function Qc(e){let t=0,n=0,r=e;for(;r;)t+=r.offsetLeft-r.scrollLeft+r.clientLeft,n+=r.offsetTop-r.scrollTop+r.clientTop,r=r.offsetParent;return t-=window.scrollX,n-=window.scrollY,{x:t,y:n}}function $c(e,t){return window.getComputedStyle(e).getPropertyValue(t)}function el(e){if(e.touches.length<2)return null;let t={x:e.touches[0].clientX,y:e.touches[0].clientY},n={x:e.touches[1].clientX,y:e.touches[1].clientY};return{distance:zc(t,n),angle:Bc(t,n),center:{x:(t.x+n.x)/2,y:(t.y+n.y)/2}}}var tl;function nl(e,t=!1){return t?e===tl:document.fullscreenElement===e}function rl(e,t=!1){t?(tl=e,e.classList.add(`psv-fullscreen-emulation`),document.dispatchEvent(new Event(`fullscreenchange`))):e.requestFullscreen()}function il(e=!1){e?(tl.classList.remove(`psv-fullscreen-emulation`),tl=null,document.dispatchEvent(new Event(`fullscreenchange`))):document.exitFullscreen()}function al(e,t){let n,r=!1,i=!1,a=!1,o=!1;return t===`+`?n=t:t.split(`+`).forEach(e=>{switch(e){case`Shift`:r=!0;break;case`Ctrl`:i=!0;break;case`Alt`:a=!0;break;case`Meta`:o=!0;break;case`Plus`:n=`+`;break;case`Minus`:n=`-`;break;default:n=e}}),r===e.shiftKey&&i===e.ctrlKey&&a===e.altKey&&o===e.metaKey&&n===e.key}function ol(e){return e.replace(/[A-Z](?:(?=[^A-Z])|[A-Z]*(?=[A-Z][^A-Z]|$))/g,(e,t)=>(t>0?`-`:``)+e.toLowerCase())}function sl(e,t){let n=!1;return function(...r){n||(n=!0,setTimeout(()=>{e.apply(this,r),n=!1},t))}}function cl(e){if(typeof e!=`object`||!e||Object.prototype.toString.call(e)!==`[object Object]`)return!1;if(Object.getPrototypeOf(e)===null)return!0;let t=e;for(;Object.getPrototypeOf(t)!==null;)t=Object.getPrototypeOf(t);return Object.getPrototypeOf(e)===t}function ll(e,t){let n=t;return function e(t,r){return Array.isArray(r)?(!t||!Array.isArray(t)?t=[]:t.length=0,r.forEach((n,r)=>{t[r]=e(null,n)})):typeof r==`object`?((!t||Array.isArray(t))&&(t={}),Object.keys(r).forEach(i=>{i!==`__proto__`&&(typeof r[i]!=`object`||!r[i]||!cl(r[i])?t[i]=r[i]:r[i]!==n&&(t[i]?e(t[i],r[i]):t[i]=e(null,r[i])))})):t=r,t}(e,t)}function ul(e){return ll(null,e)}function dl(e){return!e||Object.keys(e).length===0&&e.constructor===Object}function fl(e){return e==null}function pl(...e){for(let t of e)if(!fl(t))return t;return null}function ml(e,t){if(e===t)return!0;if(hl(e)&&hl(t)){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(let n of Object.keys(e))if(!ml(e[n],t[n]))return!1;return!0}return!1}function hl(e){return typeof e==`object`&&!!e}var Z=class e extends Error{constructor(t,n){super(n&&n instanceof Error?`${t}: ${n.message}`:t),this.name=`PSVError`,Error.captureStackTrace?.(this,e)}};function gl(e,t){cl(e)?(t(e.initial,!0),e.promise.then(e=>t(e,!1))):t(e,!0)}function _l(e){return{initial:!e.initial,promise:e.promise.then(e=>!e)}}function vl(){let e=Error(`Loading was aborted.`);return e.name=`AbortError`,e}function yl(e){return e?.name===`AbortError`}function bl(e){console.warn(`PhotoSphereViewer: ${e}`)}function xl(e){return!e||Array.isArray(e)?!1:[[`textureX`,`textureY`],[`yaw`,`pitch`]].some(([t,n])=>e[t]!==void 0&&e[n]!==void 0)}function Sl(e,t,n=!0){let r=e.match(`<GPano:`+t+`>(.*)</GPano:`+t+`>`);if(r!==null){let e=n?parseInt(r[1],10):parseFloat(r[1]);return isNaN(e)?null:e}if(r=e.match(`GPano:`+t+`="(.*?)"`),r!==null){let e=n?parseInt(r[1],10):parseFloat(r[1]);return isNaN(e)?null:e}return null}var Cl={top:`0%`,bottom:`100%`,left:`0%`,right:`100%`,center:`50%`},wl=[`left`,`center`,`right`],Tl=[`top`,`center`,`bottom`],El=[...wl,...Tl],Dl=`center`;function Ol(e){if(!e)return{x:.5,y:.5};if(typeof e==`object`)return e;let t=e.toLocaleLowerCase().split(` `).slice(0,2);t.length===1&&(t=Cl[t[0]]?[t[0],Dl]:[t[0],t[0]]);let n=t[1]!==`left`&&t[1]!==`right`&&t[0]!==`top`&&t[0]!==`bottom`;t=t.map(e=>Cl[e]||e),n||t.reverse();let r=t.join(` `).match(/^([0-9.]+)% ([0-9.]+)%$/);return r?{x:parseFloat(r[1])/100,y:parseFloat(r[2])/100}:{x:.5,y:.5}}function kl(e,{allowCenter:t,cssOrder:n}={allowCenter:!0,cssOrder:!0}){return e?(typeof e==`string`&&(e=e.split(` `)),e.length===1&&(e[0]===Dl?e=[Dl,Dl]:wl.indexOf(e[0])===-1?Tl.indexOf(e[0])!==-1&&(e=[e[0],Dl]):e=[Dl,e[0]]),e.length!==2||El.indexOf(e[0])===-1||El.indexOf(e[1])===-1?(bl(`Unparsable position ${e}`),null):!t&&e[0]===Dl&&e[1]===Dl?(bl(`Invalid position center center`),null):(n&&!Al(e)&&(e=[e[1],e[0]]),e[1]===Dl&&wl.indexOf(e[0])!==-1&&(e=[Dl,e[0]]),e[0]===Dl&&Tl.indexOf(e[1])!==-1&&(e=[e[1],Dl]),e)):null}function Al(e){return Tl.indexOf(e[0])!==-1&&wl.indexOf(e[1])!==-1}function jl(e){let t;if(typeof e==`string`){let n=e.toString().trim(),r=parseFloat(n.replace(/^(-?[0-9]+(?:\.[0-9]*)?).*$/,`$1`)),i=n.replace(/^-?[0-9]+(?:\.[0-9]*)?(.*)$/,`$1`).trim();switch(i.match(/(pm|per minute)$/)&&(r/=60),i){case`dpm`:case`degrees per minute`:case`dps`:case`degrees per second`:t=V.degToRad(r);break;case`rdpm`:case`radians per minute`:case`rdps`:case`radians per second`:t=r;break;case`rpm`:case`revolutions per minute`:case`rps`:case`revolutions per second`:t=r*Math.PI*2;break;default:throw new Z(`Unknown speed unit "${i}"`)}}else t=e;return t}function Ml(e,t){if(typeof e!=`number`){let n=jl(e);return t/Math.abs(n)*1e3}return Math.abs(e)}function Nl(e,t=!1,n=t){let r;if(typeof e==`string`){let t=e.toLowerCase().trim().match(/^(-?[0-9]+(?:\.[0-9]*)?)(.*)$/);if(!t)throw new Z(`Unknown angle "${e}"`);let n=parseFloat(t[1]),i=t[2];if(i)switch(i){case`deg`:case`degs`:r=V.degToRad(n);break;case`rad`:case`rads`:r=n;break;default:throw new Z(`Unknown angle unit "${i}"`)}else r=n}else if(typeof e==`number`&&!isNaN(e))r=e;else throw new Z(`Unknown angle "${e}"`);return r=Lc(t?r+Math.PI:r,Math.PI*2),t?V.clamp(r-Math.PI,-Math.PI/(n?2:1),Math.PI/(n?2:1)):r}function Pl(e,t=!1){let n=new Mt(e);return n.needsUpdate=!0,n.minFilter=t?c:o,n.generateMipmaps=t,n.anisotropy=t?2:1,n}var Fl=new ut;function Il(e,t){Fl.setFromEuler(t).invert(),e.applyQuaternion(Fl)}function Ll(e,t){let n=function(n){let r=ul({...e,...n}),i={};for(let[n,a]of Object.entries(r)){if(t&&n in t)a=t[n](a,{rawConfig:r,defValue:e[n]});else if(!(n in e)){bl(`Unknown option ${n}`);continue}i[n]=a}return i};return n.defaults=e,n.parsers=t||{},n}function Rl(e,t){$c(e,`--psv-${t}-loaded`)!==`true`&&console.error(`PhotoSphereViewer: stylesheet "@photo-sphere-viewer/${t}/index.css" is not loaded`)}function zl(e,t,n){t&&t!==n&&console.error(`PhotoSphereViewer: @photo-sphere-viewer/${e} is in version ${t} but @photo-sphere-viewer/core is in version ${n}`)}function Bl(e){do{if(e instanceof ShadowRoot&&e.mode===`closed`){console.error(`PhotoSphereViewer: closed shadow DOM detected, the viewer might not work as expected`);return}e=e.parentNode}while(e)}function Vl(e,t,n,r){let i={isEquirectangular:!0,fullWidth:pl(n?.fullWidth,r?.fullWidth),fullHeight:pl(n?.fullHeight,r?.fullHeight),croppedWidth:e,croppedHeight:t,croppedX:pl(n?.croppedX,r?.croppedX),croppedY:pl(n?.croppedY,r?.croppedY),poseHeading:pl(n?.poseHeading,r?.poseHeading,0),posePitch:pl(n?.posePitch,r?.posePitch,0),poseRoll:pl(n?.poseRoll,r?.poseRoll,0),initialHeading:r?.initialHeading,initialPitch:r?.initialPitch,initialFov:r?.initialFov};return!i.fullWidth&&!i.fullHeight&&(i.fullWidth=Math.max(e,t*2),i.fullHeight=Math.round(i.fullWidth/2)),i.fullWidth||=i.fullHeight*2,i.fullHeight||=Math.round(i.fullWidth/2),i.croppedX===null&&(i.croppedX=Math.round((i.fullWidth-e)/2)),i.croppedY===null&&(i.croppedY=Math.round((i.fullHeight-t)/2)),Math.abs(i.fullWidth-i.fullHeight*2)>1&&(bl(`Invalid panoData, fullWidth should be twice fullHeight`),i.fullHeight=Math.round(i.fullWidth/2)),i.croppedX+i.croppedWidth>i.fullWidth&&(bl(`Invalid panoData, croppedX + croppedWidth > fullWidth`),i.croppedX=i.fullWidth-i.croppedWidth),i.croppedY+i.croppedHeight>i.fullHeight&&(bl(`Invalid panoData, croppedY + croppedHeight > fullHeight`),i.croppedY=i.fullHeight-i.croppedHeight),i.croppedX<0&&(bl(`Invalid panoData, croppedX < 0`),i.croppedX=0),i.croppedY<0&&(bl(`Invalid panoData, croppedY < 0`),i.croppedY=0),i}var Hl=class{constructor(e){this.easing=Ic.linear,this.callbacks=[],this.resolved=!1,this.cancelled=!1,this.options=e,e?(e.easing&&(this.easing=typeof e.easing==`function`?e.easing:Ic[e.easing]||Ic.linear),this.delayTimeout=setTimeout(()=>{this.delayTimeout=void 0,this.animationFrame=window.requestAnimationFrame(e=>this.__run(e))},e.delay||0)):this.resolved=!0}__run(e){if(this.cancelled)return;this.start||=e;let t=(e-this.start)/this.options.duration,n={};if(t<1){for(let[e,r]of Object.entries(this.options.properties))r&&(n[e]=r.start+(r.end-r.start)*this.easing(t));this.options.onTick(n,t),this.animationFrame=window.requestAnimationFrame(e=>this.__run(e))}else{for(let[e,t]of Object.entries(this.options.properties))t&&(n[e]=t.end);this.options.onTick(n,1),this.__resolve(!0),this.animationFrame=void 0}}__resolve(e){e?this.resolved=!0:this.cancelled=!0,this.callbacks.forEach(t=>t(e)),this.callbacks.length=0}then(e){return this.resolved||this.cancelled?Promise.resolve(this.resolved).then(e):new Promise(e=>{this.callbacks.push(e)}).then(e)}cancel(){!this.cancelled&&!this.resolved&&(this.__resolve(!1),this.delayTimeout&&=(window.clearTimeout(this.delayTimeout),void 0),this.animationFrame&&=(window.cancelAnimationFrame(this.animationFrame),void 0))}},Ul=class{constructor(e,t){if(this.fn=e,this.mode=0,this.speed=0,this.speedMult=0,this.currentSpeed=0,this.target=0,this.__current=0,this.min=t.min,this.max=t.max,this.wrap=t.wrap,this.current=t.defaultValue,this.wrap&&this.min!==0)throw new Z(`invalid config`);this.fn&&this.fn(this.current)}get current(){return this.__current}set current(e){this.__current=e}setSpeed(e){this.speed=e}goto(e,t=1){this.mode=2,this.target=this.wrap?Lc(e,this.max):V.clamp(e,this.min,this.max),this.speedMult=t}step(e,t=1){t===0?this.setValue(this.current+e):(this.mode!==2&&(this.target=this.current),this.goto(this.target+e,t))}roll(e=!1,t=1){this.mode=1,this.target=e?-1/0:1/0,this.speedMult=t}stop(){this.mode=0}setValue(e){return this.target=this.wrap?Lc(e,this.max):V.clamp(e,this.min,this.max),this.mode=0,this.currentSpeed=0,this.target!==this.current&&(this.current=this.target,this.fn&&this.fn(this.current),!0)}update(e){if(this.mode===2){this.wrap&&Math.abs(this.target-this.current)>this.max/2&&(this.current=this.current<this.target?this.current+this.max:this.current-this.max);let e=this.currentSpeed*this.currentSpeed/(this.speed*this.speedMult*4);Math.abs(this.target-this.current)<=e&&(this.mode=0)}let t=this.mode===0?0:this.speed*this.speedMult;this.target<this.current&&(t=-t),this.currentSpeed<t?this.currentSpeed=Math.min(t,this.currentSpeed+e/1e3*this.speed*this.speedMult*2):this.currentSpeed>t&&(this.currentSpeed=Math.max(t,this.currentSpeed-e/1e3*this.speed*this.speedMult*2));let n=null;return this.current>this.target&&this.currentSpeed?n=Math.max(this.target,this.current+this.currentSpeed*e/1e3):this.current<this.target&&this.currentSpeed&&(n=Math.min(this.target,this.current+this.currentSpeed*e/1e3)),n!==null&&(n=this.wrap?Lc(n,this.max):V.clamp(n,this.min,this.max),n!==this.current)&&(this.current=n,this.fn&&this.fn(this.current),!0)}},Wl=class{constructor(e,t){this.fn=e,this.dynamics=t,this.fn&&this.fn(this.current)}get current(){return Object.entries(this.dynamics).reduce((e,[t,n])=>(e[t]=n.current,e),{})}setSpeed(e){for(let t of Object.values(this.dynamics))t.setSpeed(e)}goto(e,t=1){for(let[n,r]of Object.entries(e))this.dynamics[n].goto(r,t)}step(e,t=1){if(t===0)this.setValue(Object.keys(e).reduce((t,n)=>(t[n]=e[n]+this.dynamics[n].current,t),{}));else for(let[n,r]of Object.entries(e))this.dynamics[n].step(r,t)}roll(e,t=1){for(let[n,r]of Object.entries(e))this.dynamics[n].roll(r,t)}stop(){for(let e of Object.values(this.dynamics))e.stop()}setValue(e){let t=!1;for(let[n,r]of Object.entries(e))t=this.dynamics[n].setValue(r)||t;return t&&this.fn&&this.fn(this.current),t}update(e){let t=!1;for(let n of Object.values(this.dynamics))t=n.update(e)||t;return t&&this.fn&&this.fn(this.current),t}},Gl=class{constructor(e=200){this.delay=e,this.time=0,this.delay=e}get pending(){return this.time!==0}down(e){this.timeout&&=(clearTimeout(this.timeout),void 0),this.time=new Date().getTime(),this.data=e}up(e){this.time&&(Date.now()-this.time<this.delay?this.timeout=setTimeout(()=>{e(this.data),this.timeout=void 0,this.time=0,this.data=void 0},this.delay):(e(this.data),this.time=0,this.data=void 0))}},Kl=(e=>(e.VERTICAL=`VERTICAL`,e.HORIZONTAL=`HORIZONTAL`,e))(Kl||{}),ql=class{constructor(e,t,n){this.container=e,this.direction=t,this.listener=n,this.mousedown=!1,this.mouseover=!1,this.container.addEventListener(`click`,this),this.container.addEventListener(`mousedown`,this),this.container.addEventListener(`mouseenter`,this),this.container.addEventListener(`mouseleave`,this),this.container.addEventListener(`touchstart`,this),this.container.addEventListener(`mousemove`,this,!0),this.container.addEventListener(`touchmove`,this,!0),window.addEventListener(`mouseup`,this),window.addEventListener(`touchend`,this)}get isVertical(){return this.direction===`VERTICAL`}get isHorizontal(){return this.direction===`HORIZONTAL`}destroy(){window.removeEventListener(`mouseup`,this),window.removeEventListener(`touchend`,this)}handleEvent(e){switch(e.type){case`click`:e.stopPropagation();break;case`mousedown`:this.__onMouseDown(e);break;case`mouseenter`:this.__onMouseEnter(e);break;case`mouseleave`:this.__onMouseLeave(e);break;case`touchstart`:this.__onTouchStart(e);break;case`mousemove`:this.__onMouseMove(e);break;case`touchmove`:this.__onTouchMove(e);break;case`mouseup`:this.__onMouseUp(e);break;case`touchend`:this.__onTouchEnd(e)}}__onMouseDown(e){this.mousedown=!0,this.__update(e.clientX,e.clientY,!0)}__onMouseEnter(e){this.mouseover=!0,this.__update(e.clientX,e.clientY,!0)}__onTouchStart(e){this.mouseover=!0,this.mousedown=!0;let t=e.changedTouches[0];this.__update(t.clientX,t.clientY,!0)}__onMouseMove(e){(this.mousedown||this.mouseover)&&(e.stopPropagation(),this.__update(e.clientX,e.clientY,!0))}__onTouchMove(e){if(this.mousedown||this.mouseover){e.stopPropagation();let t=e.changedTouches[0];this.__update(t.clientX,t.clientY,!0)}}__onMouseUp(e){this.mousedown&&(this.mousedown=!1,this.__update(e.clientX,e.clientY,!1))}__onMouseLeave(e){this.mouseover&&(this.mouseover=!1,this.__update(e.clientX,e.clientY,!0))}__onTouchEnd(e){if(this.mousedown){this.mouseover=!1,this.mousedown=!1;let t=e.changedTouches[0];this.__update(t.clientX,t.clientY,!1)}}__update(e,t,n){let r=this.container.getBoundingClientRect(),i;i=this.isVertical?V.clamp((r.bottom-t)/r.height,0,1):V.clamp((e-r.left)/r.width,0,1),this.listener({value:i,click:!n,mousedown:this.mousedown,mouseover:this.mouseover,cursor:{clientX:e,clientY:t}})}},Q={};fc(Q,{BeforeAnimateEvent:()=>Zl,BeforeRenderEvent:()=>$l,BeforeRotateEvent:()=>tu,ClickEvent:()=>ru,ConfigChangedEvent:()=>au,DoubleClickEvent:()=>su,FullscreenEvent:()=>lu,HideNotificationEvent:()=>du,HideOverlayEvent:()=>pu,HidePanelEvent:()=>hu,HideTooltipEvent:()=>_u,KeypressEvent:()=>yu,LoadProgressEvent:()=>xu,ObjectEnterEvent:()=>ed,ObjectEvent:()=>Qu,ObjectHoverEvent:()=>id,ObjectLeaveEvent:()=>nd,PanoramaErrorEvent:()=>Du,PanoramaLoadEvent:()=>Cu,PanoramaLoadedEvent:()=>Tu,PositionUpdatedEvent:()=>ju,ReadyEvent:()=>Fu,RenderEvent:()=>Lu,RollUpdatedEvent:()=>Nu,ShowNotificationEvent:()=>zu,ShowOverlayEvent:()=>Vu,ShowPanelEvent:()=>Uu,ShowTooltipEvent:()=>Gu,SizeUpdatedEvent:()=>qu,StopAllEvent:()=>Yu,TransitionDoneEvent:()=>ku,ViewerEvent:()=>$,ZoomUpdatedEvent:()=>Zu});var Jl=class extends Event{constructor(e,t=!1){super(e,{cancelable:t})}},Yl=class extends EventTarget{dispatchEvent(e){return super.dispatchEvent(e)}addEventListener(e,t,n){super.addEventListener(e,t,n)}removeEventListener(e,t,n){super.removeEventListener(e,t,n)}},$=class extends Jl{},Xl=class e extends ${constructor(t,n){super(e.type,!0),this.position=t,this.zoomLevel=n}};Xl.type=`before-animate`;var Zl=Xl,Ql=class e extends ${constructor(t,n){super(e.type),this.timestamp=t,this.elapsed=n}};Ql.type=`before-render`;var $l=Ql,eu=class e extends ${constructor(t){super(e.type,!0),this.position=t}};eu.type=`before-rotate`;var tu=eu,nu=class e extends ${constructor(t){super(e.type),this.data=t}};nu.type=`click`;var ru=nu,iu=class e extends ${constructor(t){super(e.type),this.options=t}containsOptions(...e){return e.some(e=>this.options.includes(e))}};iu.type=`config-changed`;var au=iu,ou=class e extends ${constructor(t){super(e.type),this.data=t}};ou.type=`dblclick`;var su=ou,cu=class e extends ${constructor(t){super(e.type),this.fullscreenEnabled=t}};cu.type=`fullscreen`;var lu=cu,uu=class e extends ${constructor(t){super(e.type),this.notificationId=t}};uu.type=`hide-notification`;var du=uu,fu=class e extends ${constructor(t){super(e.type),this.overlayId=t}};fu.type=`hide-overlay`;var pu=fu,mu=class e extends ${constructor(t){super(e.type),this.panelId=t}};mu.type=`hide-panel`;var hu=mu,gu=class e extends ${constructor(t){super(e.type),this.tooltipData=t}};gu.type=`hide-tooltip`;var _u=gu,vu=class e extends ${constructor(t,n){super(e.type,!0),this.key=t,this.originalEvent=n}matches(e){return al(this.originalEvent,e)}};vu.type=`key-press`;var yu=vu,bu=class e extends ${constructor(t){super(e.type),this.progress=t}};bu.type=`load-progress`;var xu=bu,Su=class e extends ${constructor(t){super(e.type),this.panorama=t}};Su.type=`panorama-load`;var Cu=Su,wu=class e extends ${constructor(t){super(e.type),this.data=t}};wu.type=`panorama-loaded`;var Tu=wu,Eu=class e extends ${constructor(t,n){super(e.type),this.panorama=t,this.error=n}};Eu.type=`panorama-error`;var Du=Eu,Ou=class e extends ${constructor(t){super(e.type),this.completed=t}};Ou.type=`transition-done`;var ku=Ou,Au=class e extends ${constructor(t){super(e.type),this.position=t}};Au.type=`position-updated`;var ju=Au,Mu=class e extends ${constructor(t){super(e.type),this.roll=t}};Mu.type=`roll-updated`;var Nu=Mu,Pu=class e extends ${constructor(){super(e.type)}};Pu.type=`ready`;var Fu=Pu,Iu=class e extends ${constructor(){super(e.type)}};Iu.type=`render`;var Lu=Iu,Ru=class e extends ${constructor(t){super(e.type),this.notificationId=t}};Ru.type=`show-notification`;var zu=Ru,Bu=class e extends ${constructor(t){super(e.type),this.overlayId=t}};Bu.type=`show-overlay`;var Vu=Bu,Hu=class e extends ${constructor(t){super(e.type),this.panelId=t}};Hu.type=`show-panel`;var Uu=Hu,Wu=class e extends ${constructor(t,n){super(e.type),this.tooltip=t,this.tooltipData=n}};Wu.type=`show-tooltip`;var Gu=Wu,Ku=class e extends ${constructor(t){super(e.type),this.size=t}};Ku.type=`size-updated`;var qu=Ku,Ju=class e extends ${constructor(){super(e.type)}};Ju.type=`stop-all`;var Yu=Ju,Xu=class e extends ${constructor(t){super(e.type),this.zoomLevel=t}};Xu.type=`zoom-updated`;var Zu=Xu,Qu=class extends ${constructor(e,t,n,r,i){super(e),this.originalEvent=t,this.object=n,this.viewerPoint=r,this.userDataKey=i}},$u=class e extends Qu{constructor(t,n,r,i){super(e.type,t,n,r,i)}};$u.type=`enter-object`;var ed=$u,td=class e extends Qu{constructor(t,n,r,i){super(e.type,t,n,r,i)}};td.type=`leave-object`;var nd=td,rd=class e extends Qu{constructor(t,n,r,i){super(e.type,t,n,r,i)}};rd.type=`hover-object`;var id=rd,ad=class{constructor(e){this.viewer=e}init(){}destroy(){}supportsTransition(e){return!1}supportsPreload(e){return!1}textureCoordsToSphericalCoords(e,t){throw new Z(`Current adapter does not support texture coordinates.`)}sphericalCoordsToTextureCoords(e,t){throw new Z(`Current adapter does not support texture coordinates.`)}};ad.supportsDownload=!1;function od(e){if(e){for(let[,t]of[[`_`,e],...Object.entries(e)])if(t.prototype instanceof ad)return zl(t.id,t.VERSION,`5.14.0`),t}return null}var sd=`${Ac}_touchSupport`,cd={loaded:!1,pixelRatio:1,isWebGLSupported:!1,maxTextureWidth:0,isTouchEnabled:null,__maxCanvasWidth:null,isIphone:!1,get maxCanvasWidth(){return this.__maxCanvasWidth===null&&(this.__maxCanvasWidth=dd(this.maxTextureWidth)),this.__maxCanvasWidth},load(){if(!this.loaded){let e=ld();this.pixelRatio=window.devicePixelRatio||1,this.isWebGLSupported=!!e,this.maxTextureWidth=e?e.getParameter(e.MAX_TEXTURE_SIZE):0,this.isTouchEnabled=ud(),this.isIphone=/iPhone/i.test(navigator.userAgent),this.loaded=!0}if(!cd.isWebGLSupported)throw new Z(`WebGL 2 is not supported.`);if(cd.maxTextureWidth===0)throw new Z(`Unable to detect system capabilities`)}};function ld(){try{return document.createElement(`canvas`).getContext(`webgl2`)}catch{return null}}function ud(){let e=`ontouchstart`in window||navigator.maxTouchPoints>0;sd in localStorage&&(e=localStorage[sd]===`true`);let t=new Promise(t=>{let n=()=>{window.removeEventListener(`mousedown`,r),window.removeEventListener(`touchstart`,i),clearTimeout(o)},r=()=>{n(),localStorage[sd]=!1,t(!1)},i=()=>{n(),localStorage[sd]=!0,t(!0)},a=()=>{n(),localStorage[sd]=e,t(e)};window.addEventListener(`mousedown`,r,!1),window.addEventListener(`touchstart`,i,!1);let o=setTimeout(a,1e4)});return{initial:e,promise:t}}function dd(e){let t=e,n=!1,r=document.createElement(`canvas`),i=r.getContext(`2d`);for(r.width=1,r.height=1;t>1024&&!n;){let e=document.createElement(`canvas`),r=e.getContext(`2d`);e.width=t,e.height=t/2;try{r.fillStyle=`white`,r.fillRect(t-1,t/2-1,1,1),i.drawImage(e,t-1,t/2-1,1,1,0,0,1,1),i.getImageData(0,0,1,1).data[0]>0&&(n=!0)}catch{}e.width=0,e.height=0,n||(t/=2)}if(n)return t;throw new Z(`Unable to detect system capabilities`)}var fd=Ll({resolution:64,useXmpData:!0,blur:!1},{resolution:e=>{if(!e||!V.isPowerOfTwo(e))throw new Z(`EquirectangularAdapter resolution must be power of two.`);return e}}),pd=class e extends ad{static withConfig(t){return[e,t]}constructor(e,t){super(e),this.config=fd(t),this.SPHERE_SEGMENTS=this.config.resolution,this.SPHERE_HORIZONTAL_SEGMENTS=this.SPHERE_SEGMENTS/2}supportsTransition(){return!0}supportsPreload(){return!0}textureCoordsToSphericalCoords(e,t){if(fl(e.textureX)||fl(e.textureY))throw new Z(`Texture position is missing 'textureX' or 'textureY'`);let n=(e.textureX+t.croppedX)/t.fullWidth*Math.PI*2,r=(e.textureY+t.croppedY)/t.fullHeight*Math.PI;return{yaw:n>=Math.PI?n-Math.PI:n+Math.PI,pitch:Math.PI/2-r}}sphericalCoordsToTextureCoords(e,t){let n=e.yaw/Math.PI/2*t.fullWidth,r=e.pitch/Math.PI*t.fullHeight,i=Math.round(e.yaw<Math.PI?n+t.fullWidth/2:n-t.fullWidth/2)-t.croppedX,a=Math.round(t.fullHeight/2-r)-t.croppedY;return(i<0||i>t.croppedWidth||a<0||a>t.croppedHeight)&&(i=a=void 0),{textureX:i,textureY:a}}async loadTexture(e,t=!0,n,r=this.config.useXmpData){if(typeof e!=`string`&&(typeof e!=`object`||!e.path))return Promise.reject(new Z(`Invalid panorama url, are you using the right adapter?`));let i;i=typeof e==`string`?{path:e,data:n}:{data:n,...e};let a=await this.viewer.textureLoader.loadFile(i.path,t?e=>this.viewer.textureLoader.dispatchProgress(e):null,i.path),o=r?await this.loadXMP(a):null,s=await this.viewer.textureLoader.blobToImage(a);typeof i.data==`function`&&(i.data=i.data(s,o));let c=Vl(s.width,s.height,i.data,o);return{panorama:e,texture:this.createEquirectangularTexture(s),panoData:c,cacheKey:i.path}}async loadXMP(e){let t=await this.loadBlobAsString(e),n=t.indexOf(`<x:xmpmeta`);if(n===-1)return null;let r=t.indexOf(`</x:xmpmeta>`,n);if(r===-1)return null;let i=t.substring(n,r);return i.includes(`GPano:`)?{fullWidth:Sl(i,`FullPanoWidthPixels`),fullHeight:Sl(i,`FullPanoHeightPixels`),croppedWidth:Sl(i,`CroppedAreaImageWidthPixels`),croppedHeight:Sl(i,`CroppedAreaImageHeightPixels`),croppedX:Sl(i,`CroppedAreaLeftPixels`),croppedY:Sl(i,`CroppedAreaTopPixels`),poseHeading:Sl(i,`PoseHeadingDegrees`,!1),posePitch:Sl(i,`PosePitchDegrees`,!1),poseRoll:Sl(i,`PoseRollDegrees`,!1),initialHeading:Sl(i,`InitialViewHeadingDegrees`,!1),initialPitch:Sl(i,`InitialViewPitchDegrees`,!1),initialFov:Sl(i,`InitialHorizontalFOVDegrees`,!1)}:null}loadBlobAsString(e){return new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(r.result),r.onerror=n,r.readAsText(e)})}createEquirectangularTexture(e){if(this.config.blur||e.width>cd.maxTextureWidth){let t=Math.min(1,cd.maxCanvasWidth/e.width),n=new OffscreenCanvas(Math.floor(e.width*t),Math.floor(e.height*t)),r=n.getContext(`2d`);return this.config.blur&&(r.filter=`blur(${n.width/2048}px)`),r.drawImage(e,0,0,n.width,n.height),Pl(n)}return Pl(e)}createMesh(e){let t=e.croppedX/e.fullWidth*2*Math.PI,n=e.croppedWidth/e.fullWidth*2*Math.PI,r=e.croppedY/e.fullHeight*Math.PI,i=e.croppedHeight/e.fullHeight*Math.PI;return new Nr(new gi(kc,Math.round(this.SPHERE_SEGMENTS/(2*Math.PI)*n),Math.round(this.SPHERE_HORIZONTAL_SEGMENTS/Math.PI*i),-Math.PI/2+t,n,r,i).scale(-1,1,1),new or({depthTest:!1,depthWrite:!1}))}setTexture(e,t){e.material.map=t.texture}setTextureOpacity(e,t){e.material.opacity=t,e.material.transparent=t<1}disposeTexture({texture:e}){e.dispose()}disposeMesh(e){e.geometry.dispose(),e.material.dispose()}};pd.id=`equirectangular`,pd.VERSION=`5.14.0`,pd.supportsDownload=!0;var md=pd,hd=class e extends md{static withConfig(t){return[e,t]}constructor(e,t){super(e,{resolution:t?.resolution??64,useXmpData:!1})}async loadTexture(e,t){let n=await super.loadTexture(e,t,null,!1);return n.panoData=null,n}createMesh(){let e=new gi(kc,this.SPHERE_SEGMENTS,this.SPHERE_HORIZONTAL_SEGMENTS).scale(-1,1,1).toNonIndexed(),t=e.getAttribute(`uv`),n=e.getAttribute(`normal`);for(let e=0;e<t.count;e++)for(let r=0;r<3;r++){let i=e*3+r,a=n.getX(i),o=n.getY(i),s=n.getZ(i),c=.947;if(e<t.count/6){let e=a===0&&s===0?1:Math.acos(o)/Math.sqrt(a*a+s*s)*(2/Math.PI);t.setXY(i,c/4*a*e+1/4,c/2*s*e+1/2)}else{let e=a===0&&s===0?1:Math.acos(-o)/Math.sqrt(a*a+s*s)*(2/Math.PI);t.setXY(i,-a*(c/4)*e+3/4,c/2*s*e+1/2)}}return e.rotateX(-Math.PI/2),e.rotateY(Math.PI),new Nr(e,new or({depthTest:!1,depthWrite:!1}))}};hd.id=`dual-fisheye`,hd.VERSION=`5.14.0`;var gd=class e{constructor(t,n){this.parent=t,this.children=[],this.state={visible:!0},this.viewer=t instanceof e?t.viewer:t,this.container=document.createElement(n.tagName??`div`),this.container.className=n.className||``,this.parent.children.push(this),this.parent.container.appendChild(this.container)}destroy(){this.parent.container.removeChild(this.container);let e=this.parent.children.indexOf(this);e!==-1&&this.parent.children.splice(e,1),this.children.slice().forEach(e=>e.destroy()),this.children.length=0}toggle(e=!this.isVisible()){e?this.show():this.hide()}hide(e){this.container.style.display=`none`,this.state.visible=!1}show(e){this.container.style.display=``,this.state.visible=!0}isVisible(){return this.state.visible}},_d=Ll({id:null,tagName:null,className:null,title:null,hoverScale:!1,collapsable:!1,tabbable:!0,icon:null,iconActive:null}),vd=class extends gd{constructor(e,t){super(e,{tagName:t.tagName,className:`psv-button ${t.hoverScale?`psv-button--hover-scale`:``} ${t.className||``}`}),this.state={visible:!0,enabled:!0,supported:!0,collapsed:!1,active:!1,width:0},this.config=_d(t),t.id||(this.config.id=this.constructor.id),t.icon&&this.__setIcon(t.icon),this.state.width=this.container.offsetWidth,this.config.title?this.container.title=this.viewer.config.lang[this.config.title]??this.config.title:this.id&&this.id in this.viewer.config.lang&&(this.container.title=this.viewer.config.lang[this.id]),t.tabbable&&(this.container.tabIndex=0),this.container.addEventListener(`click`,e=>{this.state.enabled&&this.onClick(),e.stopPropagation()}),this.container.addEventListener(`keydown`,e=>{e.key===Pc.Enter&&this.state.enabled&&(this.onClick(),e.stopPropagation())})}get id(){return this.config.id}get title(){return this.container.title}get content(){return this.container.innerHTML}get width(){return this.state.width}get collapsable(){return this.config.collapsable}show(e=!0){this.isVisible()||(this.state.visible=!0,this.state.collapsed||(this.container.style.display=``),e&&this.viewer.navbar.autoSize())}hide(e=!0){this.isVisible()&&(this.state.visible=!1,this.container.style.display=`none`,e&&this.viewer.navbar.autoSize())}checkSupported(){gl(this.isSupported(),(e,t)=>{this.state&&(this.state.supported=e,t?e||this.hide():this.toggle(e))})}autoSize(){}isSupported(){return!0}toggleActive(e=!this.state.active){e!==this.state.active&&(this.state.active=e,Gc(this.container,`psv-button--active`,this.state.active),this.config.iconActive&&this.__setIcon(this.state.active?this.config.iconActive:this.config.icon))}disable(){this.container.classList.add(`psv-button--disabled`),this.state.enabled=!1}enable(){this.container.classList.remove(`psv-button--disabled`),this.state.enabled=!0}collapse(){this.state.collapsed=!0,this.container.style.display=`none`}uncollapse(){this.state.collapsed=!1,this.state.visible&&(this.container.style.display=``)}__setIcon(e){this.container.innerHTML=e,Kc(this.container.querySelector(`svg`),`psv-button-svg`)}},yd=class extends vd{constructor(e,t){super(e,{id:t.id??`psvButton-${Math.random().toString(36).substring(2)}`,className:`psv-custom-button ${t.className||``}`,hoverScale:!1,collapsable:t.collapsable!==!1,tabbable:t.tabbable!==!1,title:t.title}),this.customOnClick=t.onClick,t.content&&(typeof t.content==`string`?this.container.innerHTML=t.content:(this.container.classList.add(`psv-custom-button--no-padding`),t.content.style.height=`100%`,t.content.attachViewer?.(this.viewer),this.container.appendChild(t.content))),this.state.width=this.container.offsetWidth,t.disabled&&this.disable(),t.visible===!1&&this.hide()}onClick(){this.customOnClick?.(this.viewer)}},bd=class extends vd{constructor(e){super(e,{className:`psv-description-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:Fc.info}),this.mode=0,this.viewer.addEventListener(du.type,this),this.viewer.addEventListener(zu.type,this),this.viewer.addEventListener(hu.type,this),this.viewer.addEventListener(Uu.type,this),this.viewer.addEventListener(au.type,this)}destroy(){this.viewer.removeEventListener(du.type,this),this.viewer.removeEventListener(zu.type,this),this.viewer.removeEventListener(hu.type,this),this.viewer.removeEventListener(Uu.type,this),this.viewer.removeEventListener(au.type,this),super.destroy()}handleEvent(e){if(e instanceof au){e.containsOptions(`description`)&&this.autoSize(!0);return}if(!this.mode)return;let t=!1;e instanceof du?t=this.mode===1:e instanceof zu?t=this.mode===1&&e.notificationId!==Nc.DESCRIPTION:e instanceof hu?t=this.mode===2:e instanceof Uu&&(t=this.mode===2&&e.panelId!==Nc.DESCRIPTION),t&&(this.toggleActive(!1),this.mode=0)}onClick(){this.mode?this.__close():this.__open()}hide(e){super.hide(e),this.mode&&this.__close()}autoSize(e=!1){if(e){let e=this.viewer.navbar.getButton(`caption`,!1),t=e&&!e.isVisible(),n=!!this.viewer.config.description;t||n?this.show(!1):this.hide(!1)}}__close(){switch(this.mode){case 1:this.viewer.notification.hide(Nc.DESCRIPTION);break;case 2:this.viewer.panel.hide(Nc.DESCRIPTION)}}__open(){this.toggleActive(!0),this.viewer.config.description?(this.mode=2,this.viewer.panel.show({id:Nc.DESCRIPTION,content:`${this.viewer.config.caption?`<p>${this.viewer.config.caption}</p>`:``}${this.viewer.config.description}`})):(this.mode=1,this.viewer.notification.show({id:Nc.DESCRIPTION,content:this.viewer.config.caption}))}};bd.id=`description`;var xd=class extends vd{constructor(e){super(e,{tagName:`a`,className:`psv-download-button`,hoverScale:!0,collapsable:!0,tabbable:!0,icon:Fc.download}),this.viewer.addEventListener(au.type,this),this.viewer.addEventListener(Tu.type,this)}destroy(){this.viewer.removeEventListener(au.type,this),this.viewer.removeEventListener(Tu.type,this),super.destroy()}handleEvent(e){e instanceof au?(e.containsOptions(`downloadUrl`)&&this.checkSupported(),e.containsOptions(`downloadUrl`,`downloadName`)&&this.__update()):e instanceof Tu&&this.__update()}onClick(){}checkSupported(){this.viewer.adapter.constructor.supportsDownload||this.viewer.config.downloadUrl?this.show():this.hide()}__update(){let e=this.container;e.href=this.viewer.config.downloadUrl||this.viewer.config.panorama,e.target=`_blank`,e.download=e.href.startsWith(`data:`)&&!this.viewer.config.downloadName?`panorama.`+e.href.substring(0,e.href.indexOf(`;`)).split(`/`).pop():this.viewer.config.downloadName||e.href.split(`/`).pop()}};xd.id=`download`;var Sd=class extends vd{constructor(e){super(e,{className:`psv-fullscreen-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:Fc.fullscreenIn,iconActive:Fc.fullscreenOut}),this.viewer.addEventListener(lu.type,this)}destroy(){this.viewer.removeEventListener(lu.type,this),super.destroy()}handleEvent(e){e instanceof lu&&this.toggleActive(e.fullscreenEnabled)}onClick(){this.viewer.toggleFullscreen()}};Sd.id=`fullscreen`;var Cd=`psvButton`,wd=(e,t)=>`
<div class="psv-panel-menu psv-panel-menu--stripped">
  <h1 class="psv-panel-menu-title">${Fc.menu} ${t}</h1>
...
`,Td=class extends vd{constructor(e){super(e,{className:`psv-menu-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:Fc.menu}),this.viewer.addEventListener(Uu.type,this),this.viewer.addEventListener(hu.type,this),super.hide()}destroy(){this.viewer.removeEventListener(Uu.type,this),this.viewer.removeEventListener(hu.type,this),super.destroy()}handleEvent(e){e instanceof Uu?this.toggleActive(e.panelId===Nc.MENU):e instanceof hu&&this.toggleActive(!1)}onClick(){this.state.active?this.__hideMenu():this.__showMenu()}hide(e){super.hide(e),this.__hideMenu()}show(e){super.show(e),this.state.active&&this.__showMenu()}__showMenu(){this.viewer.panel.show({id:Nc.MENU,content:wd(this.viewer.navbar.collapsed,this.viewer.config.lang.menu),noMargin:!0,clickHandler:e=>{let t=e?Yc(e,`.psv-panel-menu-item`):void 0,n=t?t.dataset[Cd]:void 0;n&&(this.viewer.navbar.getButton(n).onClick(),this.__hideMenu())}})}__hideMenu(){this.viewer.panel.hide(Nc.MENU)}};Td.id=`menu`;function Ed(e){let t=0;switch(e){case 0:t=90;break;case 1:t=-90;break;case 3:t=180;break;default:t=0}return Fc.arrow.replace(`rotate(0`,`rotate(${t}`)}var Dd=class extends vd{constructor(e,t){super(e,{className:`psv-move-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:Ed(t)}),this.direction=t,this.handler=new Gl,this.container.addEventListener(`mousedown`,this),this.container.addEventListener(`keydown`,this),this.container.addEventListener(`keyup`,this),this.viewer.container.addEventListener(`mouseup`,this),this.viewer.container.addEventListener(`touchend`,this)}destroy(){this.__onMouseUp(),this.viewer.container.removeEventListener(`mouseup`,this),this.viewer.container.removeEventListener(`touchend`,this),super.destroy()}handleEvent(e){switch(e.type){case`mousedown`:this.__onMouseDown();break;case`mouseup`:this.__onMouseUp();break;case`touchend`:this.__onMouseUp();break;case`keydown`:e.key===Pc.Enter&&this.__onMouseDown();break;case`keyup`:e.key===Pc.Enter&&this.__onMouseUp()}}onClick(){}isSupported(){return _l(cd.isTouchEnabled)}__onMouseDown(){if(!this.state.enabled)return;let e={};switch(this.direction){case 0:e.pitch=!1;break;case 1:e.pitch=!0;break;case 3:e.yaw=!1;break;default:e.yaw=!0}this.viewer.stopAll(),this.viewer.dynamics.position.roll(e),this.handler.down()}__onMouseUp(){this.state.enabled&&this.handler.up(()=>{this.viewer.dynamics.position.stop(),this.viewer.resetIdleTimer()})}};Dd.groupId=`move`;var Od=class extends Dd{constructor(e){super(e,1)}};Od.id=`moveDown`;var kd=class extends Dd{constructor(e){super(e,2)}};kd.id=`moveLeft`;var Ad=class extends Dd{constructor(e){super(e,3)}};Ad.id=`moveRight`;var jd=class extends Dd{constructor(e){super(e,0)}};jd.id=`moveUp`;var Md=class extends vd{constructor(e,t,n){super(e,{className:`psv-zoom-button`,hoverScale:!0,collapsable:!1,tabbable:!0,icon:t}),this.direction=n,this.handler=new Gl,this.container.addEventListener(`mousedown`,this),this.container.addEventListener(`keydown`,this),this.container.addEventListener(`keyup`,this),this.viewer.container.addEventListener(`mouseup`,this),this.viewer.container.addEventListener(`touchend`,this)}destroy(){this.__onMouseUp(),this.viewer.container.removeEventListener(`mouseup`,this),this.viewer.container.removeEventListener(`touchend`,this),super.destroy()}handleEvent(e){switch(e.type){case`mousedown`:this.__onMouseDown();break;case`mouseup`:this.__onMouseUp();break;case`touchend`:this.__onMouseUp();break;case`keydown`:e.key===Pc.Enter&&this.__onMouseDown();break;case`keyup`:e.key===Pc.Enter&&this.__onMouseUp()}}onClick(){}isSupported(){return _l(cd.isTouchEnabled)}__onMouseDown(){this.state.enabled&&(this.viewer.dynamics.zoom.roll(this.direction===1),this.handler.down())}__onMouseUp(){this.state.enabled&&this.handler.up(()=>this.viewer.dynamics.zoom.stop())}};Md.groupId=`zoom`;var Nd=class extends Md{constructor(e){super(e,Fc.zoomIn,0)}};Nd.id=`zoomIn`;var Pd=class extends Md{constructor(e){super(e,Fc.zoomOut,1)}};Pd.id=`zoomOut`;var Fd=class extends vd{constructor(e){super(e,{className:`psv-zoom-range`,hoverScale:!1,collapsable:!1,tabbable:!1}),this.zoomRange=document.createElement(`div`),this.zoomRange.className=`psv-zoom-range-line`,this.container.appendChild(this.zoomRange),this.zoomValue=document.createElement(`div`),this.zoomValue.className=`psv-zoom-range-handle`,this.zoomRange.appendChild(this.zoomValue),this.slider=new ql(this.container,`HORIZONTAL`,e=>this.__onSliderUpdate(e)),this.mediaMinWidth=parseInt($c(this.container,`max-width`),10),this.viewer.addEventListener(Zu.type,this),this.viewer.state.ready?this.__moveZoomValue(this.viewer.getZoomLevel()):this.viewer.addEventListener(Fu.type,this)}destroy(){this.slider.destroy(),this.viewer.removeEventListener(Zu.type,this),this.viewer.removeEventListener(Fu.type,this),super.destroy()}handleEvent(e){e instanceof Zu?this.__moveZoomValue(e.zoomLevel):e instanceof Fu&&this.__moveZoomValue(this.viewer.getZoomLevel())}onClick(){}isSupported(){return _l(cd.isTouchEnabled)}autoSize(){this.state.supported&&(this.viewer.state.size.width<=this.mediaMinWidth&&this.state.visible?this.hide(!1):this.viewer.state.size.width>this.mediaMinWidth&&!this.state.visible&&this.show(!1))}__moveZoomValue(e){this.zoomValue.style.left=e/100*this.zoomRange.offsetWidth-this.zoomValue.offsetWidth/2+`px`}__onSliderUpdate(e){e.mousedown&&this.viewer.zoom(e.value*100)}};Fd.id=`zoomRange`,Fd.groupId=`zoom`;var Id=class extends Yl{constructor(e){super(),this.viewer=e}init(){}destroy(){}},Ld=class extends Id{constructor(e,t){super(e),this.config=this.constructor.configParser(t)}setOption(e,t){this.setOptions({[e]:t})}setOptions(e){let t={...this.config,...e},n=this.constructor,r=n.configParser,i=n.readonlyOptions,a=n.id;for(let[n,o]of Object.entries(e)){if(!(n in r.defaults)){bl(`${a}: Unknown option "${n}"`);continue}if(i.includes(n)){bl(`${a}: Option "${n}" cannot be updated`);continue}n in r.parsers&&(o=r.parsers[n](o,{rawConfig:t,defValue:r.defaults[n]})),this.config[n]=o}}};Ld.readonlyOptions=[];function Rd(e){if(e){for(let[,t]of[[`_`,e],...Object.entries(e)])if(t.prototype instanceof Id)return zl(t.id,t.VERSION,`5.14.0`),t}return null}var zd={panorama:null,container:null,adapter:[md,null],plugins:[],caption:null,description:null,downloadUrl:null,downloadName:null,loadingImg:null,loadingTxt:``,size:null,fisheye:0,minFov:30,maxFov:90,defaultZoomLvl:50,defaultYaw:0,defaultPitch:0,sphereCorrection:null,moveSpeed:1,zoomSpeed:1,moveInertia:.8,mousewheel:!0,mousemove:!0,mousewheelCtrlKey:!1,touchmoveTwoFingers:!1,panoData:null,requestHeaders:null,canvasBackground:`#000`,defaultTransition:{speed:1500,rotation:!0,effect:`fade`},rendererParameters:{alpha:!0,antialias:!0},withCredentials:()=>!1,navbar:[`zoom`,`move`,`download`,`description`,`caption`,`fullscreen`],lang:{zoom:`Zoom`,zoomOut:`Zoom out`,zoomIn:`Zoom in`,moveUp:`Move up`,moveDown:`Move down`,moveLeft:`Move left`,moveRight:`Move right`,description:`Description`,download:`Download`,fullscreen:`Fullscreen`,loading:`Loading...`,menu:`Menu`,close:`Close`,twoFingers:`Use two fingers to navigate`,ctrlZoom:`Use ctrl + scroll to zoom the image`,loadError:`The panorama cannot be loaded`,webglError:`Your browser does not seem to support WebGL`},keyboard:`fullscreen`,keyboardActions:{[Pc.ArrowUp]:`ROTATE_UP`,[Pc.ArrowDown]:`ROTATE_DOWN`,[Pc.ArrowRight]:`ROTATE_RIGHT`,[Pc.ArrowLeft]:`ROTATE_LEFT`,[Pc.PageUp]:`ZOOM_IN`,[Pc.PageDown]:`ZOOM_OUT`,[Pc.Plus]:`ZOOM_IN`,[Pc.Minus]:`ZOOM_OUT`}},Bd={panorama:`Use setPanorama method to change the panorama`,panoData:`Use setPanorama method to change the panorama`,container:`Cannot change viewer container`,adapter:`Cannot change adapter`,plugins:`Cannot change plugins`},Vd={container:e=>{if(!e)throw new Z(`No value given for container.`);return e},adapter:(e,{defValue:t})=>{if(e=e?Array.isArray(e)?[od(e[0]),e[1]]:[od(e),null]:t,!e[0])throw new Z(`An undefined value was given for adapter.`);if(!e[0].id)throw new Z(`Adapter has no id.`);return e},defaultYaw:e=>Nl(e),defaultPitch:e=>Nl(e,!0),defaultZoomLvl:e=>V.clamp(e,0,100),minFov:(e,{rawConfig:t})=>(t.maxFov<e&&(bl(`maxFov cannot be lower than minFov`),e=t.maxFov),V.clamp(e,1,179)),maxFov:(e,{rawConfig:t})=>(e<t.minFov&&(e=t.minFov),V.clamp(e,1,179)),moveInertia:(e,{defValue:t})=>e===!0?t:e===!1?0:e,lang:e=>({...zd.lang,...e}),fisheye:e=>e===!0?1:e===!1?0:e,requestHeaders:e=>e&&typeof e==`object`?()=>e:typeof e==`function`?e:null,withCredentials:e=>typeof e==`boolean`?()=>e:typeof e==`function`?e:()=>!1,defaultTransition:(e,{defValue:t})=>e===null||e.speed===0?null:{...t,...e},rendererParameters:(e,{defValue:t})=>({...e,...t}),plugins:e=>e.map((e,t)=>{if(e=Array.isArray(e)?[Rd(e[0]),e[1]]:[Rd(e),null],!e[0])throw new Z(`An undefined value was given for plugin ${t}.`);if(!e[0].id)throw new Z(`Plugin ${t} has no id.`);return e}),navbar:e=>e===!1?null:e===!0?ul(zd.navbar):typeof e==`string`?e.split(/[ ,]/):e},Hd=Ll(zd,Vd),Ud=class extends vd{constructor(e){super(e,{className:`psv-caption`,hoverScale:!1,collapsable:!1,tabbable:!0}),this.contentWidth=0,this.state.width=0,this.contentElt=document.createElement(`div`),this.contentElt.className=`psv-caption-content`,this.container.appendChild(this.contentElt),this.setCaption(this.viewer.config.caption)}hide(){this.contentElt.style.display=`none`,this.state.visible=!1}show(){this.contentElt.style.display=``,this.state.visible=!0}onClick(){}setCaption(e){this.show(),this.contentElt.innerHTML=e??``,this.contentWidth=this.contentElt.innerHTML?this.contentElt.offsetWidth:0,this.autoSize()}autoSize(){this.toggle(this.container.offsetWidth>=this.contentWidth),this.__refreshButton()}__refreshButton(){this.viewer.navbar.getButton(bd.id,!1)?.autoSize(!0)}};Ud.id=`caption`;var Wd={},Gd={};function Kd(e,t){if(!e.id)throw new Z(`Button id is required`);if(Wd[e.id]=e,e.groupId&&(Gd[e.groupId]=Gd[e.groupId]||[]).push(e),t){let n=zd.navbar;switch(t){case`start`:n.unshift(e.id);break;case`end`:n.push(e.id);break;default:{let[r,i]=t.split(`:`),a=n.indexOf(r);if(!r||!i||a===-1)throw new Z(`Invalid defaultPosition ${t}`);n.splice(a+ +(i===`right`),0,e.id)}}}}[Pd,Fd,Nd,bd,Ud,xd,Sd,kd,Ad,jd,Od].forEach(e=>Kd(e));var qd=class extends gd{constructor(e){super(e,{className:`psv-navbar ${jc}`}),this.collapsed=[],this.state.visible=!1}show(){this.viewer.container.classList.add(`psv--has-navbar`),this.container.classList.add(`psv-navbar--open`),this.state.visible=!0}hide(){this.viewer.container.classList.remove(`psv--has-navbar`),this.container.classList.remove(`psv-navbar--open`),this.state.visible=!1}setButtons(e){this.children.slice().forEach(e=>e.destroy()),this.children.length=0,e.indexOf(Ud.id)!==-1&&e.indexOf(bd.id)===-1&&e.splice(e.indexOf(Ud.id),0,bd.id),e.forEach(e=>{typeof e==`object`?new yd(this,e):Wd[e]?new Wd[e](this):Gd[e]?Gd[e].forEach(e=>{new e(this)}):bl(`Unknown button ${e}`)}),new Td(this),this.children.forEach(e=>{e instanceof vd&&e.checkSupported()}),this.autoSize()}setCaption(e){this.children.some(t=>t instanceof Ud&&(t.setCaption(e),!0))}getButton(e,t=!0){let n=this.children.find(t=>t instanceof vd&&t.id===e);return!n&&t&&bl(`button "${e}" not found in the navbar`),n}focusButton(e){this.isVisible()&&(this.getButton(e,!1)?.container||this.container.firstElementChild)?.focus()}autoSize(){this.children.forEach(e=>{e instanceof vd&&e.autoSize()});let e=this.container.offsetWidth,t=0,n=[];this.children.forEach(e=>{e.isVisible()&&e instanceof vd&&(t+=e.width,e.collapsable&&n.push(e))}),t!==0&&(e<t&&n.length>0?(n.forEach(e=>e.collapse()),this.collapsed=n,this.getButton(Td.id).show(!1)):e>=t&&this.collapsed.length>0&&(this.collapsed.forEach(e=>e.uncollapse()),this.collapsed=[],this.getButton(Td.id).hide(!1)),this.getButton(Ud.id,!1)?.autoSize())}};Ni.enabled=!1;var Jd={enabled:!0,maxItems:10,ttl:600,items:{},purgeInterval:null,init(){Ni.enabled&&=(bl(`ThreeJS cache should be disabled`),!1),!this.purgeInterval&&this.enabled&&(this.purgeInterval=setInterval(()=>this.purge(),6e4))},add(e,t,n){this.enabled&&t&&(this.items[t]=this.items[t]??{files:{},lastAccess:null},this.items[t].files[e]=n,this.items[t].lastAccess=Date.now())},get(e,t){if(this.enabled&&t&&this.items[t])return this.items[t].lastAccess=Date.now(),this.items[t].files[e]},remove(e,t){this.enabled&&t&&this.items[t]&&(delete this.items[t].files[e],Object.keys(this.items[t].files).length===0&&delete this.items[t])},purge(){Object.entries(this.items).sort(([,e],[,t])=>t.lastAccess-e.lastAccess).forEach(([e,{lastAccess:t}],n)=>{n>0&&(Date.now()-t>=this.ttl*1e3||n>=this.maxItems)&&delete this.items[e]})}},Yd=class extends gd{constructor(e){super(e,{className:`psv-loader-container`}),this.loader=document.createElement(`div`),this.loader.className=`psv-loader`,this.container.appendChild(this.loader),this.size=this.loader.offsetWidth,this.canvas=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`),this.canvas.setAttribute(`class`,`psv-loader-canvas`),this.canvas.setAttribute(`viewBox`,`0 0 ${this.size} ${this.size}`),this.loader.appendChild(this.canvas),this.textColor=$c(this.loader,`color`),this.color=$c(this.canvas,`color`),this.border=parseInt($c(this.loader,`--psv-loader-border`),10),this.thickness=parseInt($c(this.loader,`--psv-loader-tickness`),10);let t=this.size/2;this.canvas.innerHTML=`
            <circle cx="${t}" cy="${t}" r="${t}" fill="${this.color}"/>
            <path d="" fill="none" stroke="${this.textColor}" stroke-width="${this.thickness}" stroke-linecap="round"/>
        `,this.viewer.addEventListener(au.type,this),this.__updateContent(),this.hide()}destroy(){this.viewer.removeEventListener(au.type,this),super.destroy()}handleEvent(e){e instanceof au&&e.containsOptions(`loadingImg`,`loadingTxt`,`lang`)&&this.__updateContent()}setProgress(e){this.container.classList.remove(`psv-loader--undefined`);let t=V.clamp(e,0,99.999)/100*Math.PI*2,n=this.size/2,r=n,i=this.thickness/2+this.border,a=(this.size-this.thickness)/2-this.border,o=Math.sin(t)*a+n,s=-Math.cos(t)*a+n,c=e>50?`1`:`0`;this.canvas.querySelector(`path`).setAttributeNS(null,`d`,`M ${r} ${i} A ${a} ${a} 0 ${c} 1 ${o} ${s}`)}showUndefined(){this.show(),this.setProgress(25),this.container.classList.add(`psv-loader--undefined`)}__updateContent(){let e=this.loader.querySelector(`.psv-loader-image, .psv-loader-text`);e&&this.loader.removeChild(e);let t;if(this.viewer.config.loadingImg?(t=document.createElement(`img`),t.className=`psv-loader-image`,t.src=this.viewer.config.loadingImg):this.viewer.config.loadingTxt!==null&&(t=document.createElement(`div`),t.className=`psv-loader-text`,t.innerHTML=this.viewer.config.loadingTxt||this.viewer.config.lang.loading),t){let e=Math.round(Math.sqrt(2*(this.size/2-this.thickness/2-this.border)**2));t.style.maxWidth=e+`px`,t.style.maxHeight=e+`px`,this.loader.appendChild(t)}}},Xd=class extends gd{constructor(e){super(e,{className:`psv-notification`}),this.state={visible:!1,contentId:null,timeout:null},this.content=document.createElement(`div`),this.content.className=`psv-notification-content`,this.container.appendChild(this.content),this.content.addEventListener(`click`,()=>this.hide())}isVisible(e){return this.state.visible&&(!e||!this.state.contentId||this.state.contentId===e)}toggle(){throw new Z(`Notification cannot be toggled`)}show(e){this.state.timeout&&(clearTimeout(this.state.timeout),this.state.timeout=null),typeof e==`string`&&(e={content:e}),this.state.contentId=e.id||null,this.content.innerHTML=e.content,this.container.classList.add(`psv-notification--visible`),this.state.visible=!0,this.viewer.dispatchEvent(new zu(this.state.contentId)),e.timeout&&(this.state.timeout=setTimeout(()=>this.hide(this.state.contentId),e.timeout))}hide(e){if(this.isVisible(e)){let e=this.state.contentId;this.container.classList.remove(`psv-notification--visible`),this.state.visible=!1,this.state.contentId=null,this.viewer.dispatchEvent(new du(e))}}},Zd=class extends gd{constructor(e){super(e,{className:`psv-overlay ${jc}`}),this.state={visible:!1,contentId:null,dismissible:!0},this.image=document.createElement(`div`),this.image.className=`psv-overlay-image`,this.container.appendChild(this.image),this.title=document.createElement(`div`),this.title.className=`psv-overlay-title`,this.container.appendChild(this.title),this.text=document.createElement(`div`),this.text.className=`psv-overlay-text`,this.container.appendChild(this.text),this.container.addEventListener(`click`,this),this.viewer.addEventListener(yu.type,this),super.hide()}destroy(){this.viewer.removeEventListener(yu.type,this),super.destroy()}handleEvent(e){e.type===`click`?this.isVisible()&&this.state.dismissible&&(this.hide(),e.stopPropagation()):e instanceof yu&&this.isVisible()&&this.state.dismissible&&e.matches(Pc.Escape)&&(this.hide(),e.preventDefault())}isVisible(e){return this.state.visible&&(!e||!this.state.contentId||this.state.contentId===e)}toggle(){throw new Z(`Overlay cannot be toggled`)}show(e){typeof e==`string`&&(e={title:e}),this.state.contentId=e.id||null,this.state.dismissible=e.dismissible!==!1,this.image.innerHTML=e.image||``,this.title.innerHTML=e.title||``,this.text.innerHTML=e.text||``,super.show(),this.viewer.dispatchEvent(new Vu(this.state.contentId))}hide(e){if(this.isVisible(e)){let e=this.state.contentId;super.hide(),this.state.contentId=null,this.viewer.dispatchEvent(new pu(e))}}},Qd=200,$d=`psv-panel-content--no-interaction`,ef=class extends gd{constructor(e){super(e,{className:`psv-panel ${jc}`}),this.state={visible:!1,contentId:null,mouseX:0,mouseY:0,mousedown:!1,clickHandler:null,keyHandler:null,width:{}};let t=document.createElement(`div`);t.className=`psv-panel-resizer`,this.container.appendChild(t);let n=document.createElement(`div`);n.className=`psv-panel-close-button`,n.innerHTML=Fc.close,n.title=e.config.lang.close,this.container.appendChild(n),this.content=document.createElement(`div`),this.content.className=`psv-panel-content`,this.container.appendChild(this.content),n.addEventListener(`click`,()=>this.hide()),t.addEventListener(`mousedown`,this),t.addEventListener(`touchstart`,this),this.viewer.container.addEventListener(`mouseup`,this),this.viewer.container.addEventListener(`touchend`,this),this.viewer.container.addEventListener(`mousemove`,this),this.viewer.container.addEventListener(`touchmove`,this),this.viewer.addEventListener(yu.type,this)}destroy(){this.viewer.removeEventListener(yu.type,this),this.viewer.container.removeEventListener(`mousemove`,this),this.viewer.container.removeEventListener(`touchmove`,this),this.viewer.container.removeEventListener(`mouseup`,this),this.viewer.container.removeEventListener(`touchend`,this),super.destroy()}handleEvent(e){switch(e.type){case`mousedown`:this.__onMouseDown(e);break;case`touchstart`:this.__onTouchStart(e);break;case`mousemove`:this.__onMouseMove(e);break;case`touchmove`:this.__onTouchMove(e);break;case`mouseup`:this.__onMouseUp(e);break;case`touchend`:this.__onTouchEnd(e);break;case yu.type:this.__onKeyPress(e)}}isVisible(e){return this.state.visible&&(!e||!this.state.contentId||this.state.contentId===e)}toggle(){throw new Z(`Panel cannot be toggled`)}show(e){typeof e==`string`&&(e={content:e});let t=this.isVisible(e.id);this.state.contentId=e.id||null,this.state.visible=!0,this.state.clickHandler&&(this.content.removeEventListener(`click`,this.state.clickHandler),this.content.removeEventListener(`keydown`,this.state.keyHandler),this.state.clickHandler=null,this.state.keyHandler=null),e.id&&this.state.width[e.id]?this.container.style.width=this.state.width[e.id]:e.width?this.container.style.width=e.width:this.container.style.width=null,this.content.innerHTML=e.content,this.content.scrollTop=0,this.container.classList.add(`psv-panel--open`),Gc(this.content,`psv-panel-content--no-margin`,e.noMargin===!0),e.clickHandler&&(this.state.clickHandler=t=>{e.clickHandler(Xc(t))},this.state.keyHandler=t=>{t.key===Pc.Enter&&e.clickHandler(Xc(t))},this.content.addEventListener(`click`,this.state.clickHandler),this.content.addEventListener(`keydown`,this.state.keyHandler),t||setTimeout(()=>{this.content.querySelector(`a,button,[tabindex]`)?.focus()},300)),this.viewer.dispatchEvent(new Uu(this.state.contentId))}hide(e){if(this.isVisible(e)){let e=this.state.contentId;this.state.visible=!1,this.state.contentId=null,this.content.innerHTML=null,this.container.classList.remove(`psv-panel--open`),this.state.clickHandler&&(this.content.removeEventListener(`click`,this.state.clickHandler),this.content.removeEventListener(`keydown`,this.state.keyHandler),this.state.clickHandler=null,this.state.keyHandler=null),this.viewer.dispatchEvent(new hu(e))}}__onMouseDown(e){e.stopPropagation(),this.__startResize(e.clientX,e.clientY)}__onTouchStart(e){if(e.stopPropagation(),e.touches.length===1){let t=e.touches[0];this.__startResize(t.clientX,t.clientY)}}__onMouseUp(e){this.state.mousedown&&(e.stopPropagation(),this.state.mousedown=!1,this.content.classList.remove($d))}__onTouchEnd(e){this.state.mousedown&&(e.stopPropagation(),e.touches.length===0&&(this.state.mousedown=!1,this.content.classList.remove($d)))}__onMouseMove(e){this.state.mousedown&&(e.stopPropagation(),this.__resize(e.clientX,e.clientY))}__onTouchMove(e){if(this.state.mousedown){let t=e.touches[0];this.__resize(t.clientX,t.clientY)}}__onKeyPress(e){this.isVisible()&&e.matches(Pc.Escape)&&(this.hide(),e.preventDefault())}__startResize(e,t){this.state.mouseX=e,this.state.mouseY=t,this.state.mousedown=!0,this.content.classList.add($d)}__resize(e,t){let n=e,r=t,i=Math.max(Qd,this.container.offsetWidth-(n-this.state.mouseX))+`px`;this.state.contentId&&(this.state.width[this.state.contentId]=i),this.container.style.width=i,this.state.mouseX=n,this.state.mouseY=r}},tf=class extends gd{constructor(e,t){super(e,{className:`psv-tooltip`}),this.state={visible:!0,arrow:0,border:0,state:0,width:0,height:0,pos:``,config:null,data:null,hideTimeout:null},this.content=document.createElement(`div`),this.content.className=`psv-tooltip-content`,this.container.appendChild(this.content),this.arrow=document.createElement(`div`),this.arrow.className=`psv-tooltip-arrow`,this.container.appendChild(this.arrow),this.container.addEventListener(`transitionend`,this),this.container.addEventListener(`touchdown`,e=>e.stopPropagation()),this.container.addEventListener(`mousedown`,e=>e.stopPropagation()),this.container.style.top=`-1000px`,this.container.style.left=`-1000px`,this.show(t)}handleEvent(e){e.type===`transitionend`&&this.__onTransitionEnd(e)}destroy(){clearTimeout(this.state.hideTimeout),delete this.state.data,super.destroy()}toggle(){throw new Z(`Tooltip cannot be toggled`)}show(e){if(this.state.state!==0)throw new Z(`Initialized tooltip cannot be re-initialized`);e.className&&Kc(this.container,e.className),e.style&&Object.assign(this.container.style,e.style),this.state.state=3,this.update(e.content,e),this.state.data=e.data,this.state.state=1,this.viewer.dispatchEvent(new Gu(this,this.state.data)),this.__waitImages()}update(e,t){this.content.innerHTML=e;let n=this.container.getBoundingClientRect();this.state.width=n.right-n.left,this.state.height=n.bottom-n.top,this.state.arrow=parseInt($c(this.arrow,`border-top-width`),10),this.state.border=parseInt($c(this.container,`border-top-left-radius`),10),this.move(t??this.state.config),this.__waitImages()}move(e){if(this.state.state!==1&&this.state.state!==3)throw new Z(`Uninitialized tooltip cannot be moved`);e.box=e.box??this.state.config?.box??{width:0,height:0},this.state.config=e;let t=this.container,n=this.arrow,r={posClass:kl(e.position,{allowCenter:!1,cssOrder:!1})||[`top`,`center`],width:this.state.width,height:this.state.height,top:0,left:0,arrowTop:0,arrowLeft:0};this.__computeTooltipPosition(r,e);let i=null,a=null;if(r.top<0?i=`bottom`:r.top+r.height>this.viewer.state.size.height&&(i=`top`),r.left<0?a=`right`:r.left+r.width>this.viewer.state.size.width&&(a=`left`),a||i){let t=Al(r.posClass);i&&(r.posClass[+!t]=i),a&&(r.posClass[+!!t]=a),this.__computeTooltipPosition(r,e)}t.style.top=r.top+`px`,t.style.left=r.left+`px`,n.style.top=r.arrowTop+`px`,n.style.left=r.arrowLeft+`px`;let o=r.posClass.join(`-`);o!==this.state.pos&&(t.classList.remove(`psv-tooltip--${this.state.pos}`),this.state.pos=o,t.classList.add(`psv-tooltip--${this.state.pos}`))}hide(){this.container.classList.remove(`psv-tooltip--visible`),this.state.state=2,this.viewer.dispatchEvent(new _u(this.state.data));let e=parseFloat($c(this.container,`transition-duration`));this.state.hideTimeout=setTimeout(()=>{this.destroy()},e*2)}__onTransitionEnd(e){if(e.propertyName===`transform`)switch(this.state.state){case 1:this.container.classList.add(`psv-tooltip--visible`),this.state.state=3;break;case 2:this.state.state=0,this.destroy()}}__computeTooltipPosition(e,t){let n=this.state.arrow,r=t.top,i=e.height,a=t.left,o=e.width,s=n+this.state.border,c=t.box.width/2+n*2,l=t.box.height/2+n*2;switch(e.posClass.join(`-`)){case`top-left`:e.top=r-l-i,e.left=a+s-o,e.arrowTop=i,e.arrowLeft=o-s-n;break;case`top-center`:e.top=r-l-i,e.left=a-o/2,e.arrowTop=i,e.arrowLeft=o/2-n;break;case`top-right`:e.top=r-l-i,e.left=a-s,e.arrowTop=i,e.arrowLeft=n;break;case`bottom-left`:e.top=r+l,e.left=a+s-o,e.arrowTop=-n*2,e.arrowLeft=o-s-n;break;case`bottom-center`:e.top=r+l,e.left=a-o/2,e.arrowTop=-n*2,e.arrowLeft=o/2-n;break;case`bottom-right`:e.top=r+l,e.left=a-s,e.arrowTop=-n*2,e.arrowLeft=n;break;case`left-top`:e.top=r+s-i,e.left=a-c-o,e.arrowTop=i-s-n,e.arrowLeft=o;break;case`center-left`:e.top=r-i/2,e.left=a-c-o,e.arrowTop=i/2-n,e.arrowLeft=o;break;case`left-bottom`:e.top=r-s,e.left=a-c-o,e.arrowTop=n,e.arrowLeft=o;break;case`right-top`:e.top=r+s-i,e.left=a+c,e.arrowTop=i-s-n,e.arrowLeft=-n*2;break;case`center-right`:e.top=r-i/2,e.left=a+c,e.arrowTop=i/2-n,e.arrowLeft=-n*2;break;case`right-bottom`:e.top=r-s,e.left=a+c,e.arrowTop=n,e.arrowLeft=-n*2}}__waitImages(){let e=this.content.querySelectorAll(`img`);if(e.length>0){let t=[];e.forEach(e=>{e.complete||t.push(new Promise(t=>{e.onload=t,e.onerror=t}))}),t.length&&Promise.all(t).then(()=>{if(this.state.state===1||this.state.state===3){let e=this.container.getBoundingClientRect();this.state.width=e.right-e.left,this.state.height=e.bottom-e.top,this.move(this.state.config)}})}}},nf=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="15 15 70 70"><path fill="currentColor" d="M50,16.2c-18.6,0-33.8,15.1-33.8,33.8S31.4,83.7,50,83.7S83.8,68.6,83.8,50S68.6,16.2,50,16.2z M50,80.2c-16.7,0-30.2-13.6-30.2-30.2S33.3,19.7,50,19.7S80.3,33.3,80.3,50S66.7,80.2,50,80.2z"/><rect fill="currentColor" x="48" y="31.7" width="4" height="28"/><rect fill="currentColor" x="48" y="63.2" width="4" height="5"/><!--Created by Shastry from the Noun Project--></svg>
`,rf=class{constructor(e){this.viewer=e,this.config=e.config,this.state=e.state}destroy(){}},af=new U,of=new xn(0,0,0,`ZXY`),sf=class extends rf{constructor(e){super(e)}fovToZoomLevel(e){let t=Math.round((e-this.config.minFov)/(this.config.maxFov-this.config.minFov)*100);return V.clamp(t-2*(t-50),0,100)}zoomLevelToFov(e){return this.config.maxFov+e/100*(this.config.minFov-this.config.maxFov)}vFovToHFov(e){return V.radToDeg(2*Math.atan(Math.tan(V.degToRad(e)/2)*this.state.aspect))}hFovToVFov(e){return V.radToDeg(2*Math.atan(Math.tan(V.degToRad(e)/2)/this.state.aspect))}getAnimationProperties(e,t,n){let r=!fl(t),i=!fl(n),a={},o=null;if(r){let n=this.viewer.getPosition(),r=Vc(n.yaw,t.yaw);a.yaw={start:n.yaw,end:n.yaw+r},a.pitch={start:n.pitch,end:t.pitch},o=Ml(e,Hc(n,t))}if(i){let t=this.viewer.getZoomLevel(),r=Math.abs(n-t);a.zoom={start:t,end:n},o===null&&(o=Ml(e,Math.PI/4*r/100))}return o=o===null?typeof e==`number`?e:Cc:Math.max(Cc,o),{duration:o,properties:a}}getTransitionOptions(e){let t,n=this.config.defaultTransition??zd.defaultTransition;return t=e.transition===!1||e.transition===null?null:e.transition===!0?{...n}:typeof e.transition==`object`?{...n,...e.transition}:this.config.defaultTransition,t}textureCoordsToSphericalCoords(e){if(!this.state.textureData?.panoData)throw new Z(`Current adapter does not support texture coordinates or no texture has been loaded`);let t=this.viewer.adapter.textureCoordsToSphericalCoords(e,this.state.textureData.panoData);return!of.equals(this.viewer.renderer.panoramaPose)||!of.equals(this.viewer.renderer.sphereCorrection)?(this.sphericalCoordsToVector3(t,af),af.applyEuler(this.viewer.renderer.panoramaPose),af.applyEuler(this.viewer.renderer.sphereCorrection),this.vector3ToSphericalCoords(af)):t}sphericalCoordsToTextureCoords(e){if(!this.state.textureData?.panoData)throw new Z(`Current adapter does not support texture coordinates or no texture has been loaded`);return(!of.equals(this.viewer.renderer.panoramaPose)||!of.equals(this.viewer.renderer.sphereCorrection))&&(this.sphericalCoordsToVector3(e,af),Il(af,this.viewer.renderer.sphereCorrection),Il(af,this.viewer.renderer.panoramaPose),e=this.vector3ToSphericalCoords(af)),this.viewer.adapter.sphericalCoordsToTextureCoords(e,this.state.textureData.panoData)}sphericalCoordsToVector3(e,t,n=kc){return t||=new U,t.x=n*-Math.cos(e.pitch)*Math.sin(e.yaw),t.y=n*Math.sin(e.pitch),t.z=n*Math.cos(e.pitch)*Math.cos(e.yaw),t}vector3ToSphericalCoords(e){let t=Math.acos(e.y/Math.sqrt(e.x*e.x+e.y*e.y+e.z*e.z)),n=Math.atan2(e.x,e.z);return{yaw:n<0?-n:Math.PI*2-n,pitch:Math.PI/2-t}}viewerCoordsToVector3(e){let t=this.viewer.renderer.getIntersections(e).filter(e=>e.object.userData[Ac]);return t.length?t[0].point:null}viewerCoordsToSphericalCoords(e){let t=this.viewerCoordsToVector3(e);return t?this.vector3ToSphericalCoords(t):null}vector3ToViewerCoords(e){let t=e.clone();return t.project(this.viewer.renderer.camera),{x:Math.round((t.x+1)/2*this.state.size.width),y:Math.round((1-t.y)/2*this.state.size.height)}}sphericalCoordsToViewerCoords(e){return this.sphericalCoordsToVector3(e,af),this.vector3ToViewerCoords(af)}isPointVisible(e){let t,n;if(e instanceof U)t=e,n=this.vector3ToViewerCoords(e);else if(xl(e))t=this.sphericalCoordsToVector3(e,af),n=this.vector3ToViewerCoords(t);else return!1;return t.dot(this.viewer.state.direction)>0&&n.x>=0&&n.x<=this.viewer.state.size.width&&n.y>=0&&n.y<=this.viewer.state.size.height}cleanPosition(e){if(`yaw`in e||`pitch`in e){if(!(`yaw`in e)||!(`pitch`in e))throw new Z(`Position is missing 'yaw' or 'pitch'`);return{yaw:Nl(e.yaw),pitch:Nl(e.pitch,!0)}}return this.textureCoordsToSphericalCoords(e)}cleanSphereCorrection(e){return{pan:Nl(e?.pan||0),tilt:Nl(e?.tilt||0,!0),roll:Nl(e?.roll||0,!0,!1)}}cleanPanoramaPose(e){return{pan:V.degToRad(e?.poseHeading||0),tilt:V.degToRad(e?.posePitch||0),roll:V.degToRad(e?.poseRoll||0)}}cleanPanoramaOptions(e,t){return t?.isEquirectangular?(fl(e.zoom)&&!fl(t.initialFov)&&(e={...e,zoom:this.fovToZoomLevel(this.hFovToVFov(t.initialFov))}),fl(e.position)&&!fl(t.initialHeading)&&!fl(t.initialPitch)&&(e={...e,position:{yaw:Nl(t.initialHeading),pitch:Nl(t.initialPitch,!0)}}),e):e}},cf=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path fill="currentColor" d="M33.38 33.2a1.96 1.96 0 0 0 1.5-3.23 10.61 10.61 0 0 1 7.18-17.51c.7-.06 1.31-.49 1.61-1.12a13.02 13.02 0 0 1 11.74-7.43c7.14 0 12.96 5.8 12.96 12.9 0 3.07-1.1 6.05-3.1 8.38-.7.82-.61 2.05.21 2.76.83.7 2.07.6 2.78-.22a16.77 16.77 0 0 0 4.04-10.91C72.3 7.54 64.72 0 55.4 0a16.98 16.98 0 0 0-14.79 8.7 14.6 14.6 0 0 0-12.23 14.36c0 3.46 1.25 6.82 3.5 9.45.4.45.94.69 1.5.69m45.74 43.55a22.13 22.13 0 0 1-5.23 12.4c-4 4.55-9.53 6.86-16.42 6.86-12.6 0-20.1-10.8-20.17-10.91a1.82 1.82 0 0 0-.08-.1c-5.3-6.83-14.55-23.82-17.27-28.87-.05-.1 0-.21.02-.23a6.3 6.3 0 0 1 8.24 1.85l9.38 12.59a1.97 1.97 0 0 0 3.54-1.17V25.34a4 4 0 0 1 1.19-2.87 3.32 3.32 0 0 1 2.4-.95c1.88.05 3.4 1.82 3.4 3.94v24.32a1.96 1.96 0 0 0 3.93 0v-33.1a3.5 3.5 0 0 1 7 0v35.39a1.96 1.96 0 0 0 3.93 0v-.44c.05-2.05 1.6-3.7 3.49-3.7 1.93 0 3.5 1.7 3.5 3.82v5.63c0 .24.04.48.13.71l.1.26a1.97 1.97 0 0 0 3.76-.37c.33-1.78 1.77-3.07 3.43-3.07 1.9 0 3.45 1.67 3.5 3.74l-1.77 18.1zM77.39 51c-1.25 0-2.45.32-3.5.9v-.15c0-4.27-3.33-7.74-7.42-7.74-1.26 0-2.45.33-3.5.9V16.69a7.42 7.42 0 0 0-14.85 0v1.86a7 7 0 0 0-3.28-.94 7.21 7.21 0 0 0-5.26 2.07 7.92 7.92 0 0 0-2.38 5.67v37.9l-5.83-7.82a10.2 10.2 0 0 0-13.35-2.92 4.1 4.1 0 0 0-1.53 5.48C20 64.52 28.74 80.45 34.07 87.34c.72 1.04 9.02 12.59 23.4 12.59 7.96 0 14.66-2.84 19.38-8.2a26.06 26.06 0 0 0 6.18-14.6l1.78-18.2v-.2c0-4.26-3.32-7.73-7.42-7.73z"/><!--Created by AomAm from the Noun Project--></svg>
...
`,uf=class e{constructor(){this.$=e.IDLE}is(...e){return e.some(e=>this.$&e)}set(e){this.$=e}add(e){this.$|=e}remove(e){this.$&=~e}};uf.IDLE=0,uf.CLICK=1,uf.MOVING=2;var df=uf,ff=class extends rf{constructor(e){super(e),this.data={startMouseX:0,startMouseY:0,mouseX:0,mouseY:0,pinchDist:0,moveDelta:{yaw:0,pitch:0,zoom:0},accumulatorFactor:0,ctrlKeyDown:!1,dblclickData:null,dblclickTimeout:null,longtouchTimeout:null,twofingersTimeout:null,ctrlZoomTimeout:null},this.step=new df,this.keyHandler=new Gl,this.resizeObserver=new ResizeObserver(sl(()=>this.viewer.autoSize(),50)),this.moveThreshold=wc*cd.pixelRatio}init(){window.addEventListener(`keydown`,this,{passive:!1}),window.addEventListener(`keyup`,this),this.viewer.container.addEventListener(`mousedown`,this),window.addEventListener(`mousemove`,this,{passive:!1}),window.addEventListener(`mouseup`,this),this.viewer.container.addEventListener(`touchstart`,this,{passive:!1}),window.addEventListener(`touchmove`,this,{passive:!1}),window.addEventListener(`touchend`,this,{passive:!1}),this.viewer.container.addEventListener(`wheel`,this,{passive:!1}),document.addEventListener(`fullscreenchange`,this),this.resizeObserver.observe(this.viewer.container),this.viewer.addEventListener($l.type,this),this.viewer.addEventListener(Yu.type,this)}destroy(){window.removeEventListener(`keydown`,this),window.removeEventListener(`keyup`,this),this.viewer.container.removeEventListener(`mousedown`,this),window.removeEventListener(`mousemove`,this),window.removeEventListener(`mouseup`,this),this.viewer.container.removeEventListener(`touchstart`,this),window.removeEventListener(`touchmove`,this),window.removeEventListener(`touchend`,this),this.viewer.container.removeEventListener(`wheel`,this),document.removeEventListener(`fullscreenchange`,this),this.resizeObserver.disconnect(),this.viewer.removeEventListener($l.type,this),this.viewer.removeEventListener(Yu.type,this),clearTimeout(this.data.dblclickTimeout),clearTimeout(this.data.longtouchTimeout),clearTimeout(this.data.twofingersTimeout),clearTimeout(this.data.ctrlZoomTimeout),super.destroy()}handleEvent(e){switch(e.type){case`keydown`:this.__onKeyDown(e);break;case`keyup`:this.__onKeyUp();break;case`mousemove`:this.__onMouseMove(e);break;case`mouseup`:this.__onMouseUp(e);break;case`touchmove`:this.__onTouchMove(e);break;case`touchend`:this.__onTouchEnd(e);break;case`fullscreenchange`:this.__onFullscreenChange();break;case $l.type:this.__applyMoveDelta();break;case Yu.type:this.__clearMoveDelta()}if(!Zc(e,`.`+jc))switch(e.type){case`mousedown`:this.__onMouseDown(e);break;case`touchstart`:this.__onTouchStart(e);break;case`wheel`:this.__onMouseWheel(e)}}__onKeyDown(e){if(this.config.mousewheelCtrlKey&&(this.data.ctrlKeyDown=e.key===Pc.Control,this.data.ctrlKeyDown&&(clearTimeout(this.data.ctrlZoomTimeout),this.viewer.overlay.hide(Nc.CTRL_ZOOM))),this.viewer.dispatchEvent(new yu(e.key,e))&&!(!this.state.keyboardEnabled||!this.config.keyboardActions||this.keyHandler.pending)){for(let[t,n]of Object.entries(this.config.keyboardActions))if(al(e,t)){if(typeof n==`function`)n(this.viewer,e);else{switch(n!==`ZOOM_IN`&&n!==`ZOOM_OUT`&&this.viewer.stopAll(),n){case`ROTATE_UP`:this.viewer.dynamics.position.roll({pitch:!1});break;case`ROTATE_DOWN`:this.viewer.dynamics.position.roll({pitch:!0});break;case`ROTATE_RIGHT`:this.viewer.dynamics.position.roll({yaw:!1});break;case`ROTATE_LEFT`:this.viewer.dynamics.position.roll({yaw:!0});break;case`ZOOM_IN`:this.viewer.dynamics.zoom.roll(!1);break;case`ZOOM_OUT`:this.viewer.dynamics.zoom.roll(!0)}this.keyHandler.down(n)}e.preventDefault();return}}}__onKeyUp(){this.data.ctrlKeyDown=!1,this.state.keyboardEnabled&&this.keyHandler.up(e=>{e===`ZOOM_IN`||e===`ZOOM_OUT`?this.viewer.dynamics.zoom.stop():(this.viewer.dynamics.position.stop(),this.viewer.resetIdleTimer())})}__onMouseDown(e){this.step.add(df.CLICK),this.data.startMouseX=e.clientX,this.data.startMouseY=e.clientY,this.config.mousemove&&e.preventDefault()}__onMouseUp(e){this.step.is(df.CLICK,df.MOVING)&&this.__stopMove(e.clientX,e.clientY,e,e.button===2)}__onMouseMove(e){this.config.mousemove&&this.step.is(df.CLICK,df.MOVING)&&(e.preventDefault(),this.__doMove(e.clientX,e.clientY)),this.__handleObjectsEvents(e)}__onTouchStart(e){e.touches.length===1?(this.step.add(df.CLICK),this.data.startMouseX=e.touches[0].clientX,this.data.startMouseY=e.touches[0].clientY,this.data.longtouchTimeout||(this.data.longtouchTimeout=setTimeout(()=>{let t=e.touches[0];this.__stopMove(t.clientX,t.clientY,e,!0),this.data.longtouchTimeout=null},Ec))):e.touches.length===2&&(this.step.set(df.IDLE),this.__cancelLongTouch(),this.config.mousemove&&(this.__cancelTwoFingersOverlay(),this.__startMoveZoom(e),e.preventDefault()))}__onTouchEnd(e){if(this.__cancelLongTouch(),this.step.is(df.CLICK,df.MOVING)){if(e.preventDefault(),this.__cancelTwoFingersOverlay(),e.touches.length===1)this.__stopMove(this.data.mouseX,this.data.mouseY);else if(e.touches.length===0){let t=e.changedTouches[0];this.__stopMove(t.clientX,t.clientY,e)}}}__onTouchMove(e){if(this.__cancelLongTouch(),this.config.mousemove){if(e.touches.length===1){if(this.config.touchmoveTwoFingers)this.step.is(df.CLICK)&&!this.data.twofingersTimeout&&(this.data.twofingersTimeout=setTimeout(()=>{this.viewer.overlay.show({id:Nc.TWO_FINGERS,image:cf,title:this.config.lang.twoFingers})},Dc));else if(this.step.is(df.CLICK,df.MOVING)){e.preventDefault();let t=e.touches[0];this.__doMove(t.clientX,t.clientY)}}else this.__doMoveZoom(e),this.__cancelTwoFingersOverlay()}}__cancelLongTouch(){this.data.longtouchTimeout&&(clearTimeout(this.data.longtouchTimeout),this.data.longtouchTimeout=null)}__cancelTwoFingersOverlay(){this.config.touchmoveTwoFingers&&(this.data.twofingersTimeout&&(clearTimeout(this.data.twofingersTimeout),this.data.twofingersTimeout=null),this.viewer.overlay.hide(Nc.TWO_FINGERS))}__onMouseWheel(e){if(!this.config.mousewheel||!e.deltaY)return;if(this.config.mousewheelCtrlKey&&!this.data.ctrlKeyDown){this.viewer.overlay.show({id:Nc.CTRL_ZOOM,image:lf,title:this.config.lang.ctrlZoom}),clearTimeout(this.data.ctrlZoomTimeout),this.data.ctrlZoomTimeout=setTimeout(()=>this.viewer.overlay.hide(Nc.CTRL_ZOOM),Oc);return}e.preventDefault(),e.stopPropagation();let t=e.deltaY/Math.abs(e.deltaY)*5*this.config.zoomSpeed;t!==0&&this.viewer.dynamics.zoom.step(-t,5)}__onFullscreenChange(){let e=this.viewer.isFullscreenEnabled();this.config.keyboard===`fullscreen`&&(e?this.viewer.startKeyboardControl():this.viewer.stopKeyboardControl()),this.viewer.dispatchEvent(new lu(e))}__resetMove(){this.step.set(df.IDLE),this.data.mouseX=0,this.data.mouseY=0,this.data.startMouseX=0,this.data.startMouseY=0}__startMoveZoom(e){this.viewer.stopAll(),this.__resetMove();let t=el(e);this.step.set(df.MOVING),this.data.accumulatorFactor=this.config.moveInertia,{distance:this.data.pinchDist,center:{x:this.data.mouseX,y:this.data.mouseY}}=t}__stopMove(e,t,n,r=!1){this.step.is(df.CLICK)&&!this.__moveThresholdReached(e,t)&&this.__doClick(e,t,n,r),this.config.moveInertia&&(this.data.accumulatorFactor=this.config.moveInertia**.5),this.__resetMove(),this.viewer.resetIdleTimer()}__doClick(e,t,n,r=!1){let i=this.viewer.container.getBoundingClientRect(),a=e-i.left,o=t-i.top,s=this.viewer.renderer.getIntersections({x:a,y:o}),c=s.find(e=>e.object.userData[Ac]);if(c){let i=this.viewer.dataHelper.vector3ToSphericalCoords(c.point),l={rightclick:r,originalEvent:n,target:Xc(n),clientX:e,clientY:t,viewerX:a,viewerY:o,yaw:i.yaw,pitch:i.pitch,objects:s.map(e=>e.object).filter(e=>!e.userData[Ac])};try{let e=this.viewer.dataHelper.sphericalCoordsToTextureCoords(l);Object.assign(l,e)}catch{}this.data.dblclickTimeout?(Math.abs(this.data.dblclickData.clientX-l.clientX)<this.moveThreshold&&Math.abs(this.data.dblclickData.clientY-l.clientY)<this.moveThreshold&&this.viewer.dispatchEvent(new su(this.data.dblclickData)),clearTimeout(this.data.dblclickTimeout),this.data.dblclickTimeout=null,this.data.dblclickData=null):(this.viewer.dispatchEvent(new ru(l)),this.data.dblclickData=ul(l),this.data.dblclickTimeout=setTimeout(()=>{this.data.dblclickTimeout=null,this.data.dblclickData=null},Tc))}}__handleObjectsEvents(e){if(!dl(this.state.objectsObservers)&&e.composedPath().includes(this.viewer.container)){let t=Qc(this.viewer.container),n={x:e.clientX-t.x,y:e.clientY-t.y},r=this.viewer.renderer.getIntersections(n),i=(t,r,i)=>{this.viewer.dispatchEvent(new i(e,t,n,r))};for(let[e,t]of Object.entries(this.state.objectsObservers)){let n=r.find(t=>t.object.userData[e]);n?(t&&n.object!==t&&(i(t,e,nd),this.state.objectsObservers[e]=null),t?i(n.object,e,id):(this.state.objectsObservers[e]=n.object,i(n.object,e,ed))):t&&(i(t,e,nd),this.state.objectsObservers[e]=null)}}}__doMove(e,t){if(this.step.is(df.CLICK)&&this.__moveThresholdReached(e,t))this.viewer.stopAll(),this.__resetMove(),this.step.set(df.MOVING),this.data.mouseX=e,this.data.mouseY=t,this.data.accumulatorFactor=this.config.moveInertia;else if(this.step.is(df.MOVING)){let n=(e-this.data.mouseX)*Math.cos(this.state.roll)-(t-this.data.mouseY)*Math.sin(this.state.roll),r=(t-this.data.mouseY)*Math.cos(this.state.roll)+(e-this.data.mouseX)*Math.sin(this.state.roll),i={yaw:this.config.moveSpeed*(n/this.state.size.width)*V.degToRad(this.state.hFov),pitch:this.config.moveSpeed*(r/this.state.size.height)*V.degToRad(this.state.vFov)};this.data.moveDelta.yaw+=i.yaw,this.data.moveDelta.pitch+=i.pitch,this.data.mouseX=e,this.data.mouseY=t}}__moveThresholdReached(e,t){return Math.abs(e-this.data.startMouseX)>=this.moveThreshold||Math.abs(t-this.data.startMouseY)>=this.moveThreshold}__doMoveZoom(e){if(this.step.is(df.MOVING)){e.preventDefault();let t=el(e);this.__doMove(t.center.x,t.center.y),this.data.moveDelta.zoom+=this.config.zoomSpeed*((t.distance-this.data.pinchDist)/cd.pixelRatio),this.data.pinchDist=t.distance}}__applyMoveDelta(){let e=.001;if(Math.abs(this.data.moveDelta.yaw)>0||Math.abs(this.data.moveDelta.pitch)>0){let t=this.viewer.getPosition();this.viewer.rotate({yaw:t.yaw-this.data.moveDelta.yaw*(1-this.config.moveInertia),pitch:t.pitch+this.data.moveDelta.pitch*(1-this.config.moveInertia)}),this.data.moveDelta.yaw*=this.data.accumulatorFactor,this.data.moveDelta.pitch*=this.data.accumulatorFactor,Math.abs(this.data.moveDelta.yaw)<=e&&(this.data.moveDelta.yaw=0),Math.abs(this.data.moveDelta.pitch)<=e&&(this.data.moveDelta.pitch=0)}if(Math.abs(this.data.moveDelta.zoom)>0){let t=this.viewer.getZoomLevel();this.viewer.zoom(t+this.data.moveDelta.zoom*(1-this.config.moveInertia)),this.data.moveDelta.zoom*=this.config.moveInertia,Math.abs(this.data.moveDelta.zoom)<=e&&(this.data.moveDelta.zoom=0)}}__clearMoveDelta(){this.data.moveDelta.yaw=0,this.data.moveDelta.pitch=0,this.data.moveDelta.zoom=0}};G.enabled=!1;var pf=new H,mf=new K,hf=new Rt,gf=class extends rf{constructor(e){super(e),this.frustumNeedsUpdate=!0,this.renderer=new uc(this.config.rendererParameters),this.renderer.setPixelRatio(cd.pixelRatio),this.renderer.outputColorSpace=Me,this.renderer.toneMapping=1,this.renderer.domElement.className=`psv-canvas`,this.renderer.domElement.style.background=this.config.canvasBackground,this.scene=new ii,this.camera=new Yr(50,16/9,.1,2*kc),this.camera.matrixAutoUpdate=!1;let t=new Nr(new gi(kc).scale(-1,1,1),new or({opacity:0,transparent:!0,depthTest:!1,depthWrite:!1}));t.userData={[Ac]:!0},this.scene.add(t),this.raycaster=new na,this.frustum=new fi,this.container=document.createElement(`div`),this.container.className=`psv-canvas-container`,this.container.appendChild(this.renderer.domElement),this.viewer.container.appendChild(this.container),this.container.addEventListener(`contextmenu`,e=>e.preventDefault()),this.viewer.addEventListener(qu.type,this),this.viewer.addEventListener(Zu.type,this),this.viewer.addEventListener(ju.type,this),this.viewer.addEventListener(Nu.type,this),this.viewer.addEventListener(au.type,this),this.hide()}get panoramaPose(){return this.mesh.rotation}get sphereCorrection(){return this.meshContainer.rotation}init(){this.show(),this.renderer.setAnimationLoop(e=>this.__renderLoop(e))}destroy(){this.renderer.setAnimationLoop(null),this.cleanScene(this.scene),this.renderer.dispose(),this.viewer.container.removeChild(this.container),this.viewer.removeEventListener(qu.type,this),this.viewer.removeEventListener(Zu.type,this),this.viewer.removeEventListener(ju.type,this),this.viewer.removeEventListener(Nu.type,this),this.viewer.removeEventListener(au.type,this),super.destroy()}handleEvent(e){switch(e.type){case qu.type:this.__onSizeUpdated();break;case Zu.type:this.__onZoomUpdated();break;case ju.type:this.__onPositionUpdated();break;case Nu.type:this.__onPositionUpdated();break;case au.type:e.containsOptions(`fisheye`)&&this.__onPositionUpdated(),e.containsOptions(`canvasBackground`)&&(this.renderer.domElement.style.background=this.config.canvasBackground)}}hide(){this.container.style.opacity=`0`}show(){this.container.style.opacity=`1`}setCustomRenderer(e){this.customRenderer=e?e(this.renderer):null,this.viewer.needsUpdate()}__onSizeUpdated(){this.renderer.setSize(this.state.size.width,this.state.size.height),this.camera.aspect=this.state.aspect,this.camera.updateProjectionMatrix(),this.viewer.needsUpdate(),this.frustumNeedsUpdate=!0}__onZoomUpdated(){this.camera.fov=this.state.vFov,this.camera.updateProjectionMatrix(),this.viewer.needsUpdate(),this.frustumNeedsUpdate=!0}__onPositionUpdated(){this.camera.position.set(0,0,0),this.camera.lookAt(this.state.direction),this.config.fisheye&&this.camera.position.copy(this.state.direction).multiplyScalar(this.config.fisheye/2).negate(),this.camera.rotateZ(-this.state.roll),this.camera.updateMatrix(),this.camera.updateMatrixWorld(),this.viewer.needsUpdate(),this.frustumNeedsUpdate=!0}__renderLoop(e){let t=this.timestamp?e-this.timestamp:0;this.timestamp=e,this.viewer.dispatchEvent(new $l(e,t)),this.viewer.dynamics.update(t),(this.state.needsUpdate||this.state.continuousUpdateCount>0)&&(this.state.needsUpdate=!1,(this.customRenderer||this.renderer).render(this.scene,this.camera),this.viewer.dispatchEvent(new Lu))}setTexture(e){this.meshContainer||(this.meshContainer=new ti,this.scene.add(this.meshContainer)),this.state.textureData&&this.viewer.adapter.disposeTexture(this.state.textureData),this.mesh&&(this.meshContainer.remove(this.mesh),this.viewer.adapter.disposeMesh(this.mesh)),this.mesh=this.viewer.adapter.createMesh(e.panoData),this.viewer.adapter.setTexture(this.mesh,e,!1),this.meshContainer.add(this.mesh),this.state.textureData=e,this.viewer.needsUpdate()}setPanoramaPose(e,t=this.mesh){let n=this.viewer.dataHelper.cleanPanoramaPose(e);t.rotation.set(n.tilt,n.pan,n.roll,`YXZ`)}setSphereCorrection(e,t=this.meshContainer){let n=this.viewer.dataHelper.cleanSphereCorrection(e);t.rotation.set(n.tilt,n.pan,n.roll,`YXZ`)}transition(e,t,n){let r=n.effect===`fade`||n.rotation,i=!fl(t.position),a=!fl(t.zoom),o=new Zl(i?this.viewer.dataHelper.cleanPosition(t.position):void 0,t.zoom);this.viewer.dispatchEvent(o);let s=new ti,c=this.viewer.adapter.createMesh(e.panoData);if(this.viewer.adapter.setTexture(c,e,!0),this.viewer.adapter.setTextureOpacity(c,0),this.setPanoramaPose(e.panoData,c),this.setSphereCorrection(t.sphereCorrection,s),i&&!n.rotation){let e=this.viewer.getPosition(),t=new U(0,1,0);s.rotateOnWorldAxis(t,o.position.yaw-e.yaw);let n=new U(0,1,0).cross(this.camera.getWorldDirection(new U)).normalize();s.rotateOnWorldAxis(n,o.position.pitch-e.pitch)}s.add(c),this.scene.add(s),this.renderer.setRenderTarget(new Ft),this.renderer.render(this.scene,this.camera),this.renderer.setRenderTarget(null);let{duration:l,properties:u}=this.viewer.dataHelper.getAnimationProperties(n.speed,n.rotation?o.position:null,r?o.zoomLevel:null),d=new Hl({properties:{...u,opacity:{start:0,end:1}},duration:l,easing:`inOutCubic`,onTick:e=>{switch(n.effect){case`fade`:this.viewer.adapter.setTextureOpacity(c,e.opacity);break;case`black`:case`white`:e.opacity<.5?this.renderer.toneMappingExposure=n.effect===`black`?V.mapLinear(e.opacity,0,.5,1,0):V.mapLinear(e.opacity,0,.5,1,5):(this.renderer.toneMappingExposure=n.effect===`black`?V.mapLinear(e.opacity,.5,1,0,1):V.mapLinear(e.opacity,.5,1,5,1),this.mesh.visible=!1,this.viewer.adapter.setTextureOpacity(c,1),a&&!r&&this.viewer.dynamics.zoom.setValue(o.zoomLevel))}i&&n.rotation&&this.viewer.dynamics.position.setValue({yaw:e.yaw,pitch:e.pitch}),a&&r&&this.viewer.dynamics.zoom.setValue(e.zoom),this.viewer.needsUpdate()}});return d.then(r=>{s.remove(c),this.scene.remove(s),r?(this.viewer.adapter.disposeTexture(this.state.textureData),this.meshContainer.remove(this.mesh),this.viewer.adapter.disposeMesh(this.mesh),this.mesh=c,this.meshContainer.add(c),this.state.textureData=e,this.setPanoramaPose(e.panoData),this.setSphereCorrection(t.sphereCorrection),i&&!n.rotation&&this.viewer.rotate(t.position)):(this.viewer.adapter.disposeTexture(e),this.viewer.adapter.disposeMesh(c))}),d}getIntersections(e){pf.x=2*e.x/this.state.size.width-1,pf.y=-2*e.y/this.state.size.height+1,this.raycaster.setFromCamera(pf,this.camera);let t=this.raycaster.intersectObjects(this.scene.children,!0).filter(e=>e.object.visible).filter(e=>e.object.isMesh&&!!e.object.userData);return this.customRenderer?.getIntersections&&t.push(...this.customRenderer.getIntersections(this.raycaster,pf)),t}isObjectVisible(e){if(!e)return!1;if(this.frustumNeedsUpdate&&=(mf.multiplyMatrices(this.camera.projectionMatrix,this.camera.matrixWorldInverse),this.frustum.setFromProjectionMatrix(mf),!1),e.isVector3)return this.frustum.containsPoint(e);if(e.isMesh&&e.geometry){let t=e;return t.geometry.boundingBox||t.geometry.computeBoundingBox(),hf.copy(t.geometry.boundingBox).applyMatrix4(t.matrixWorld),this.frustum.intersectsBox(hf)}return e.isObject3D?this.frustum.intersectsObject(e):!1}addObject(e){this.scene.add(e)}removeObject(e){this.scene.remove(e)}cleanScene(e){let t=e=>{e.map?.dispose(),e.uniforms&&Object.values(e.uniforms).forEach(e=>{e.value?.dispose?.()}),e.dispose()};e.traverse(n=>{n.geometry?.dispose(),n.material&&(Array.isArray(n.material)?n.material.forEach(e=>{t(e)}):t(n.material)),n instanceof ii||n.dispose?.(),n!==e&&this.cleanScene(n)})}},_f=class extends Bi{constructor(){super(...arguments),this._abortController=new AbortController}abort(){return this._abortController.abort(),this._abortController=new AbortController,this}load(e,t,n,r){let i=this._abortController.signal,a=super.load(e,e=>{s(),t(e)},n,e=>{if(s(),i.aborted){let e=Error();e.name=`AbortError`,e.message=`The operation was aborted.`,r(e)}else r(e)});function o(){a.src=``}function s(){i.removeEventListener(`abort`,o,!1)}return i.addEventListener(`abort`,o,!1),a}},vf=class extends rf{constructor(e){super(e),this.fileLoader=new Ri,this.fileLoader.setResponseType(`blob`),this.imageLoader=new _f}destroy(){this.abortLoading(),super.destroy()}abortLoading(){this.fileLoader.abort?.(),this.imageLoader.abort()}loadFile(e,t,n){let r=Jd.get(e,n);if(r){if(r instanceof Blob)return t?.(100),Promise.resolve(r);Jd.remove(e,n)}this.config.requestHeaders&&this.fileLoader.setRequestHeader(this.config.requestHeaders(e)),this.fileLoader.setWithCredentials(this.config.withCredentials(e));let i=0;return t?.(i),this.fileLoader.loadAsync(e,e=>{if(e.lengthComputable){let n=e.loaded/e.total*100;n>i&&(i=n,t?.(i))}}).then(r=>(i=100,t?.(i),Jd.add(e,n,r),r))}loadImage(e,t,n){let r=Jd.get(e,n);return r?(t?.(100),r instanceof Blob?this.blobToImage(r):Promise.resolve(r)):!t&&!this.config.requestHeaders?(this.imageLoader.setWithCredentials(this.config.withCredentials(e)),this.imageLoader.loadAsync(e).then(t=>(Jd.add(e,n,t),t))):this.loadFile(e,t,n).then(e=>this.blobToImage(e))}blobToImage(e){return new Promise((t,n)=>{let r=document.createElement(`img`);r.onload=()=>{URL.revokeObjectURL(r.src),t(r)},r.onerror=n,r.src=URL.createObjectURL(e)})}preloadPanorama(e){return this.viewer.adapter.supportsPreload(e)?this.viewer.adapter.loadTexture(e,!1):Promise.reject(new Z(`Current adapter does not support preload`))}dispatchProgress(e){this.viewer.loader.setProgress(e),this.viewer.dispatchEvent(new xu(Math.round(e)))}},yf=class extends rf{constructor(e){super(e),this.zoom=new Ul(e=>{this.viewer.state.vFov=this.viewer.dataHelper.zoomLevelToFov(e),this.viewer.state.hFov=this.viewer.dataHelper.vFovToHFov(this.viewer.state.vFov),this.viewer.dispatchEvent(new Zu(e))},{defaultValue:this.viewer.config.defaultZoomLvl,min:0,max:100,wrap:!1}),this.position=new Wl(e=>{this.viewer.dataHelper.sphericalCoordsToVector3(e,this.viewer.state.direction),this.viewer.dispatchEvent(new ju(e))},{yaw:new Ul(null,{defaultValue:this.config.defaultYaw,min:0,max:2*Math.PI,wrap:!0}),pitch:new Ul(null,{defaultValue:this.config.defaultPitch,min:-Math.PI/2,max:Math.PI/2,wrap:!1})}),this.roll=new Ul(e=>{this.viewer.state.roll=e,this.viewer.dispatchEvent(new Nu(e))},{defaultValue:0,min:-Math.PI,max:Math.PI,wrap:!1}),this.updateSpeeds()}updateSpeeds(){this.zoom.setSpeed(this.config.zoomSpeed*50),this.position.setSpeed(V.degToRad(this.config.moveSpeed*50)),this.roll.setSpeed(V.degToRad(this.config.moveSpeed*50))}update(e){this.zoom.update(e),this.position.update(e),this.roll.update(e)}},bf=class{constructor(){this.ready=!1,this.needsUpdate=!1,this.continuousUpdateCount=0,this.keyboardEnabled=!1,this.direction=new U(0,0,kc),this.roll=0,this.vFov=60,this.hFov=60,this.aspect=1,this.animation=null,this.transitionAnimation=null,this.loadingPromise=null,this.idleTime=-1,this.objectsObservers={},this.size={width:0,height:0}}},xf=class extends Yl{constructor(e){if(super(),this.plugins={},this.children=[],this.parent=Wc(e.container),!this.parent)throw new Z(`"container" element not found.`);this.parent[Ac]=this,this.container=document.createElement(`div`),this.container.classList.add(`psv-container`),this.parent.appendChild(this.container),Bl(this.parent),Rl(this.container,`core`),this.state=new bf,this.config=Hd(e),this.__setSize(this.config.size),this.overlay=new Zd(this);try{cd.load()}catch(e){console.error(e),this.showError(this.config.lang.webglError);return}Jd.init(),this.adapter=new this.config.adapter[0](this,this.config.adapter[1]),this.renderer=new gf(this),this.textureLoader=new vf(this),this.eventsHandler=new ff(this),this.dataHelper=new sf(this),this.dynamics=new yf(this),this.adapter.init?.(),this.loader=new Yd(this),this.navbar=new qd(this),this.panel=new ef(this),this.notification=new Xd(this),this.autoSize(),this.setCursor(null),gl(cd.isTouchEnabled,e=>{Gc(this.container,`psv--is-touch`,e)}),this.config.plugins.forEach(([e,t])=>{this.plugins[e.id]=new e(this,t)});for(let e of Object.values(this.plugins))e.init?.();this.config.navbar&&this.navbar.setButtons(this.config.navbar),this.state.loadingPromise||(this.config.panorama?this.setPanorama(this.config.panorama,{sphereCorrection:this.config.sphereCorrection,panoData:this.config.panoData}):this.loader.show())}destroy(){this.stopAll(),this.stopKeyboardControl(),this.exitFullscreen();for(let[e,t]of Object.entries(this.plugins))t.destroy(),delete this.plugins[e];this.children.slice().forEach(e=>e.destroy()),this.children.length=0,this.eventsHandler?.destroy(),this.renderer?.destroy(),this.textureLoader?.destroy(),this.dataHelper?.destroy(),this.adapter?.destroy(),this.dynamics?.destroy(),this.parent.removeChild(this.container),delete this.parent[Ac]}init(){this.eventsHandler.init(),this.renderer.init(),this.config.navbar&&this.navbar.show(),this.config.keyboard===`always`&&this.startKeyboardControl(),this.resetIdleTimer(),this.state.ready=!0,this.dispatchEvent(new Fu)}resetIdleTimer(){this.state.idleTime=performance.now()}disableIdleTimer(){this.state.idleTime=-1}getPlugin(e){if(typeof e==`string`)return this.plugins[e];{let t=Rd(e);return t?this.plugins[t.id]:null}}getPosition(){return this.dataHelper.cleanPosition(this.dynamics.position.current)}getZoomLevel(){return this.dynamics.zoom.current}getSize(){return{...this.state.size}}isFullscreenEnabled(){return nl(this.parent,cd.isIphone)}needsUpdate(){this.state.needsUpdate=!0}needsContinuousUpdate(e){e?this.state.continuousUpdateCount++:this.state.continuousUpdateCount>0&&this.state.continuousUpdateCount--}autoSize(){(this.container.clientWidth!==this.state.size.width||this.container.clientHeight!==this.state.size.height)&&(this.state.size.width=Math.round(this.container.clientWidth),this.state.size.height=Math.round(this.container.clientHeight),this.state.aspect=this.state.size.width/this.state.size.height,this.state.hFov=this.dataHelper.vFovToHFov(this.state.vFov),this.dispatchEvent(new qu(this.getSize())),this.navbar.autoSize())}setPanorama(e,t={}){this.textureLoader.abortLoading(),this.state.transitionAnimation?.cancel();let n=this.dataHelper.getTransitionOptions(t);t.showLoader===void 0&&(t.showLoader=!0),t.caption===void 0&&(t.caption=this.config.caption),t.description===void 0&&(t.description=this.config.description),!t.panoData&&typeof this.config.panoData==`function`&&(t.panoData=this.config.panoData),this.hideError(),this.resetIdleTimer(),this.config.panorama=e,this.config.caption=t.caption,this.config.description=t.description,this.config.sphereCorrection=t.sphereCorrection,(typeof this.config.panoData!=`function`||typeof t.panoData==`function`)&&(this.config.panoData=t.panoData);let r=t=>{if(yl(t))return!1;if(this.loader.hide(),this.state.loadingPromise=null,t)throw this.navbar.setCaption(null),this.showError(this.config.lang.loadError),console.error(t),this.dispatchEvent(new Du(e,t)),t;return this.navbar.setCaption(this.config.caption),!0};this.navbar.setCaption(`<em>${this.config.lang.loading}</em>`),(t.showLoader||!this.state.ready)&&this.loader.show(),this.dispatchEvent(new Cu(e));let i=this.adapter.loadTexture(this.config.panorama,!0,t.panoData).then(e=>{if(e.panorama!==this.config.panorama)throw this.adapter.disposeTexture(e),vl();let n=this.dataHelper.cleanPanoramaOptions(t,e.panoData);return(!fl(n.zoom)||!fl(n.position))&&this.stopAll(),{textureData:e,cleanOptions:n}});return!n||!this.state.ready||!this.adapter.supportsTransition(this.config.panorama)?this.state.loadingPromise=i.then(({textureData:e,cleanOptions:n})=>{this.renderer.show(),this.renderer.setTexture(e),this.renderer.setPanoramaPose(e.panoData),this.renderer.setSphereCorrection(t.sphereCorrection),this.state.ready||this.init(),this.dispatchEvent(new Tu(e)),fl(n.zoom)||this.zoom(n.zoom),fl(n.position)||this.rotate(n.position)}).then(()=>r(),e=>r(e)):this.state.loadingPromise=i.then(({textureData:e,cleanOptions:t})=>(this.loader.hide(),this.dispatchEvent(new Tu(e)),this.state.transitionAnimation=this.renderer.transition(e,t,n),this.state.transitionAnimation)).then(e=>{if(this.state.transitionAnimation=null,this.dispatchEvent(new ku(e)),!e)throw vl()}).then(()=>r(),e=>r(e)),this.state.loadingPromise}setOptions(e){let t={...this.config,...e};for(let[n,r]of Object.entries(e)){if(!(n in zd)){bl(`Unknown option ${n}`);continue}if(n in Bd){bl(Bd[n]);continue}switch(n in Vd&&(r=Vd[n](r,{rawConfig:t,defValue:zd[n]})),this.config[n]=r,n){case`mousemove`:this.state.cursorOverride||this.setCursor(null);break;case`caption`:this.navbar.setCaption(this.config.caption);break;case`size`:this.resize(this.config.size);break;case`sphereCorrection`:this.renderer.setSphereCorrection(this.config.sphereCorrection);break;case`navbar`:case`lang`:this.navbar.setButtons(this.config.navbar);break;case`moveSpeed`:case`zoomSpeed`:this.dynamics.updateSpeeds();break;case`minFov`:case`maxFov`:this.dynamics.zoom.setValue(this.dataHelper.fovToZoomLevel(this.state.vFov)),this.dispatchEvent(new Zu(this.getZoomLevel()));break;case`keyboard`:this.config.keyboard===`always`?this.startKeyboardControl():this.stopKeyboardControl()}}this.needsUpdate(),this.dispatchEvent(new au(Object.keys(e)))}setOption(e,t){this.setOptions({[e]:t})}showError(e){this.overlay.show({id:Nc.ERROR,image:nf,title:e,dismissible:!1})}hideError(){this.overlay.hide(Nc.ERROR)}rotate(e){let t=new tu(this.dataHelper.cleanPosition(e));this.dispatchEvent(t),!t.defaultPrevented&&this.dynamics.position.setValue(t.position)}zoom(e){this.dynamics.zoom.setValue(e)}zoomIn(e=1){this.dynamics.zoom.step(e)}zoomOut(e=1){this.dynamics.zoom.step(-e)}animate(e){let t=xl(e),n=!fl(e.zoom),r=new Zl(t?this.dataHelper.cleanPosition(e):void 0,e.zoom);if(this.dispatchEvent(r),r.defaultPrevented)return;this.stopAll();let{duration:i,properties:a}=this.dataHelper.getAnimationProperties(e.speed,r.position,r.zoomLevel);return i?(this.state.animation=new Hl({properties:a,duration:i,easing:e.easing||`inOutSine`,onTick:e=>{t&&this.dynamics.position.setValue({yaw:e.yaw,pitch:e.pitch}),n&&this.dynamics.zoom.setValue(e.zoom)}}),this.state.animation.then(()=>{this.state.animation=null,this.resetIdleTimer()}),this.state.animation):(t&&this.rotate(r.position),n&&this.zoom(r.zoomLevel),new Hl(null))}stopAnimation(){return this.state.animation?(this.state.animation.cancel(),this.state.animation):Promise.resolve()}resize(e){this.__setSize(e),this.autoSize()}__setSize(e){[`width`,`height`].forEach(t=>{e?.[t]&&(/^[0-9.]+$/.test(e[t])&&(e[t]+=`px`),this.parent.style[t]=e[t])})}enterFullscreen(){this.isFullscreenEnabled()||rl(this.parent,cd.isIphone)}exitFullscreen(){this.isFullscreenEnabled()&&il(cd.isIphone)}toggleFullscreen(){this.isFullscreenEnabled()?this.exitFullscreen():this.enterFullscreen()}startKeyboardControl(){this.state.keyboardEnabled=!0}stopKeyboardControl(){this.state.keyboardEnabled=!1}createTooltip(e){return new tf(this,e)}setCursor(e){this.state.cursorOverride=e,e?this.container.style.cursor=e:this.container.style.cursor=this.config.mousemove?`move`:`default`}observeObjects(e){this.state.objectsObservers[e]||(this.state.objectsObservers[e]=null)}unobserveObjects(e){delete this.state.objectsObservers[e]}stopAll(){return this.dispatchEvent(new Yu),this.disableIdleTimer(),this.stopAnimation()}},Sf=Object.defineProperty;((e,t)=>{for(var n in t)Sf(e,n,{get:t[n],enumerable:!0})})({},{EnterMarkerEvent:()=>jf,GotoMarkerDoneEvent:()=>Df,HideMarkersEvent:()=>zf,LeaveMarkerEvent:()=>kf,MarkerVisibilityEvent:()=>Tf,MarkersPluginEvent:()=>Cf,RenderMarkersListEvent:()=>Gf,SelectMarkerEvent:()=>Nf,SelectMarkerListEvent:()=>Ff,SetMarkersEvent:()=>Vf,ShowMarkersEvent:()=>Uf,UnselectMarkerEvent:()=>Lf});var Cf=class extends Jl{},wf=class e extends Cf{constructor(t,n){super(e.type),this.marker=t,this.visible=n}};wf.type=`marker-visibility`;var Tf=wf,Ef=class e extends Cf{constructor(t){super(e.type),this.marker=t}};Ef.type=`goto-marker-done`;var Df=Ef,Of=class e extends Cf{constructor(t){super(e.type),this.marker=t}};Of.type=`leave-marker`;var kf=Of,Af=class e extends Cf{constructor(t){super(e.type),this.marker=t}};Af.type=`enter-marker`;var jf=Af,Mf=class e extends Cf{constructor(t,n,r){super(e.type),this.marker=t,this.doubleClick=n,this.rightClick=r}};Mf.type=`select-marker`;var Nf=Mf,Pf=class e extends Cf{constructor(t){super(e.type),this.marker=t}};Pf.type=`select-marker-list`;var Ff=Pf,If=class e extends Cf{constructor(t){super(e.type),this.marker=t}};If.type=`unselect-marker`;var Lf=If,Rf=class e extends Cf{constructor(){super(e.type)}};Rf.type=`hide-markers`;var zf=Rf,Bf=class e extends Cf{constructor(t){super(e.type),this.markers=t}};Bf.type=`set-markers`;var Vf=Bf,Hf=class e extends Cf{constructor(){super(e.type)}};Hf.type=`show-markers`;var Uf=Hf,Wf=class e extends Cf{constructor(t){super(e.type),this.markers=t}};Wf.type=`render-markers-list`;var Gf=Wf,Kf=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="10 9 81 81"><path fill="currentColor" d="M50.5 90S22.9 51.9 22.9 36.6 35.2 9 50.5 9s27.6 12.4 27.6 27.6S50.5 90 50.5 90zm0-66.3c-6.1 0-11 4.9-11 11s4.9 11 11 11 11-4.9 11-11-4.9-11-11-11z"/><!--Created by Rohith M S from the Noun Project--></svg>
`,qf=class extends vd{constructor(e){super(e,{className:`psv-markers-button`,icon:Kf,hoverScale:!0,collapsable:!0,tabbable:!0}),this.plugin=this.viewer.getPlugin(`markers`),this.plugin&&(this.plugin.addEventListener(Uf.type,this),this.plugin.addEventListener(zf.type,this),this.toggleActive(!0))}destroy(){this.plugin&&(this.plugin.removeEventListener(Uf.type,this),this.plugin.removeEventListener(zf.type,this)),super.destroy()}isSupported(){return!!this.plugin}handleEvent(e){e instanceof Uf?this.toggleActive(!0):e instanceof zf&&this.toggleActive(!1)}onClick(){this.plugin.toggleAllMarkers()}};qf.id=`markers`;var Jf=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="9 9 81 81"><path fill="currentColor" d="M37.5 90S9.9 51.9 9.9 36.6 22.2 9 37.5 9s27.6 12.4 27.6 27.6S37.5 90 37.5 90zm0-66.3c-6.1 0-11 4.9-11 11s4.9 11 11 11 11-4.9 11-11-4.9-11-11-11zM86.7 55H70c-1.8 0-3.3-1.5-3.3-3.3s1.5-3.3 3.3-3.3h16.7c1.8 0 3.3 1.5 3.3 3.3S88.5 55 86.7 55zm0-25h-15a3.3 3.3 0 0 1-3.3-3.3c0-1.8 1.5-3.3 3.3-3.3h15c1.8 0 3.3 1.5 3.3 3.3 0 1.8-1.5 3.3-3.3 3.3zM56.5 73h30c1.8 0 3.3 1.5 3.3 3.3 0 1.8-1.5 3.3-3.3 3.3h-30a3.3 3.3 0 0 1-3.3-3.3 3.2 3.2 0 0 1 3.3-3.3z"/><!--Created by Rohith M S from the Noun Project--></svg>
`,Yf=`http://www.w3.org/2000/svg`,Xf=`psvMarker`,Zf=X.dasherize(Xf),Qf=`marker`,$f=`markersList`,ep={amount:2,duration:100,easing:`linear`},tp=(e,t)=>`
<div class="psv-panel-menu psv-panel-menu--stripped">
    <h1 class="psv-panel-menu-title">${Jf} ${t}</h1>
    <ul class="psv-panel-menu-list">
    ${e.map(e=>`
...
`,np=class extends vd{constructor(e){super(e,{className:` psv-markers-list-button`,icon:Jf,hoverScale:!0,collapsable:!0,tabbable:!0}),this.plugin=this.viewer.getPlugin(`markers`),this.plugin&&(this.viewer.addEventListener(Q.ShowPanelEvent.type,this),this.viewer.addEventListener(Q.HidePanelEvent.type,this))}destroy(){this.viewer.removeEventListener(Q.ShowPanelEvent.type,this),this.viewer.removeEventListener(Q.HidePanelEvent.type,this),super.destroy()}isSupported(){return!!this.plugin}handleEvent(e){e instanceof Q.ShowPanelEvent?this.toggleActive(e.panelId===$f):e instanceof Q.HidePanelEvent&&this.toggleActive(!1)}onClick(){this.plugin.toggleMarkersList()}};np.id=`markersList`;var rp=new U,ip=new ut,ap=new U,op=class extends Rn{constructor(e=document.createElement(`div`)){super(),this.isCSS3DObject=!0,this.element=e,this.element.style.position=`absolute`,this.element.style.pointerEvents=`auto`,this.element.style.userSelect=`none`,this.element.setAttribute(`draggable`,!1),this.addEventListener(`removed`,function(){this.traverse(function(e){e.element instanceof e.element.ownerDocument.defaultView.Element&&e.element.parentNode!==null&&e.element.remove()})})}copy(e,t){return super.copy(e,t),this.element=e.element.cloneNode(!0),this}},sp=new K,cp=new K,lp=class{constructor(e={}){let t=this,n,r,i,a,o={camera:{style:``},objects:new WeakMap},s=e.element===void 0?document.createElement(`div`):e.element;s.style.overflow=`hidden`,this.domElement=s;let c=document.createElement(`div`);c.style.transformOrigin=`0 0`,c.style.pointerEvents=`none`,s.appendChild(c);let l=document.createElement(`div`);l.style.transformStyle=`preserve-3d`,c.appendChild(l),this.getSize=function(){return{width:n,height:r}},this.render=function(e,t){let s=t.projectionMatrix.elements[5]*a;t.view&&t.view.enabled?(c.style.transform=`translate( ${-t.view.offsetX*(n/t.view.width)}px, ${-t.view.offsetY*(r/t.view.height)}px )`,c.style.transform+=`scale( ${t.view.fullWidth/t.view.width}, ${t.view.fullHeight/t.view.height} )`):c.style.transform=``,e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld();let f,p;t.isOrthographicCamera&&(f=-(t.right+t.left)/2,p=(t.top+t.bottom)/2);let h=t.view&&t.view.enabled?t.view.height/t.view.fullHeight:1,g=t.isOrthographicCamera?`scale( ${h} )scale(`+s+`)translate(`+u(f)+`px,`+u(p)+`px)`+d(t.matrixWorldInverse):`scale( ${h} )translateZ(`+s+`px)`+d(t.matrixWorldInverse),_=(t.isPerspectiveCamera?`perspective(`+s+`px) `:``)+g+`translate(`+i+`px,`+a+`px)`;o.camera.style!==_&&(l.style.transform=_,o.camera.style=_),m(e,e,t,g)},this.setSize=function(e,t){n=e,r=t,i=n/2,a=r/2,s.style.width=e+`px`,s.style.height=t+`px`,c.style.width=e+`px`,c.style.height=t+`px`,l.style.width=e+`px`,l.style.height=t+`px`};function u(e){return Math.abs(e)<1e-10?0:e}function d(e){let t=e.elements;return`matrix3d(`+u(t[0])+`,`+u(-t[1])+`,`+u(t[2])+`,`+u(t[3])+`,`+u(t[4])+`,`+u(-t[5])+`,`+u(t[6])+`,`+u(t[7])+`,`+u(t[8])+`,`+u(-t[9])+`,`+u(t[10])+`,`+u(t[11])+`,`+u(t[12])+`,`+u(-t[13])+`,`+u(t[14])+`,`+u(t[15])+`)`}function f(e){let t=e.elements;return`translate(-50%,-50%)`+(`matrix3d(`+u(t[0])+`,`+u(t[1])+`,`+u(t[2])+`,`+u(t[3])+`,`+u(-t[4])+`,`+u(-t[5])+`,`+u(-t[6])+`,`+u(-t[7])+`,`+u(t[8])+`,`+u(t[9])+`,`+u(t[10])+`,`+u(t[11])+`,`+u(t[12])+`,`+u(t[13])+`,`+u(t[14])+`,`+u(t[15])+`)`)}function p(e){e.isCSS3DObject&&(e.element.style.display=`none`);for(let t=0,n=e.children.length;t<n;t++)p(e.children[t])}function m(e,n,r,i){if(e.visible===!1){p(e);return}if(e.isCSS3DObject){let i=e.layers.test(r.layers)===!0,a=e.element;if(a.style.display=i===!0?``:`none`,i===!0){e.onBeforeRender(t,n,r);let i;e.isCSS3DSprite?(sp.copy(r.matrixWorldInverse),sp.transpose(),e.rotation2D!==0&&sp.multiply(cp.makeRotationZ(e.rotation2D)),e.matrixWorld.decompose(rp,ip,ap),sp.setPosition(rp),sp.scale(ap),sp.elements[3]=0,sp.elements[7]=0,sp.elements[11]=0,sp.elements[15]=1,i=f(sp)):i=f(e.matrixWorld);let s=o.objects.get(e);if(s===void 0||s.style!==i){a.style.transform=i;let t={style:i};o.objects.set(e,t)}a.parentNode!==l&&l.appendChild(a),e.onAfterRender(t,n,r)}}for(let t=0,a=e.children.length;t<a;t++)m(e.children[t],n,r,i)}}},up=class{constructor(e){this.viewer=e,this.element=document.createElement(`div`),this.element.className=`psv-markers-css3d-container`,this.renderer=new lp({element:this.element}),this.scene=new ii,this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(e=>{let t=e.target[Xf];t.config.visible&&(t.viewportIntersection=e.isIntersecting)})},{root:this.element}),e.addEventListener(Q.ReadyEvent.type,this,{once:!0}),e.addEventListener(Q.SizeUpdatedEvent.type,this),e.addEventListener(Q.RenderEvent.type,this)}handleEvent(e){switch(e.type){case Q.ReadyEvent.type:case Q.SizeUpdatedEvent.type:this.updateSize();break;case Q.RenderEvent.type:this.render()}}destroy(){this.viewer.removeEventListener(Q.ReadyEvent.type,this),this.viewer.removeEventListener(Q.SizeUpdatedEvent.type,this),this.viewer.removeEventListener(Q.RenderEvent.type,this),this.intersectionObserver.disconnect()}updateSize(){let e=this.viewer.getSize();this.renderer.setSize(e.width,e.height)}render(){this.renderer.render(this.scene,this.viewer.renderer.camera)}addObject(e){this.scene.add(e.threeElement),this.intersectionObserver.observe(e.domElement)}removeObject(e){this.scene.remove(e.threeElement),this.intersectionObserver.unobserve(e.domElement)}},dp=(e=>(e.image=`image`,e.html=`html`,e.element=`element`,e.imageLayer=`imageLayer`,e.videoLayer=`videoLayer`,e.elementLayer=`elementLayer`,e.polygon=`polygon`,e.polygonPixels=`polygonPixels`,e.polyline=`polyline`,e.polylinePixels=`polylinePixels`,e.square=`square`,e.rect=`rect`,e.circle=`circle`,e.ellipse=`ellipse`,e.path=`path`,e))(dp||{});function fp(e,t=!1){let n=[];if(Object.keys(dp).forEach(t=>{e[t]&&n.push(t)}),n.length===0&&!t)throw new Z(`missing marker content, either ${Object.keys(dp).join(`, `)}`);if(n.length>1)throw new Z(`multiple marker content, either ${Object.keys(dp).join(`, `)}`);return n[0]}var pp=class{constructor(e,t,n){if(this.viewer=e,this.plugin=t,this.state={anchor:null,visible:!1,staticTooltip:!1,position:null,position2D:null,positions3D:null,size:null},!n.id)throw new Z(`missing marker id`);this.type=fp(n),this.createElement(),this.update(n)}get id(){return this.config.id}get data(){return this.config.data}get domElement(){return null}get threeElement(){return null}get video(){return null}destroy(){delete this.viewer,delete this.plugin,delete this.element,this.hideTooltip()}is3d(){return!1}isNormal(){return!1}isPoly(){return!1}isSvg(){return!1}isCss3d(){return!1}update(e){let t=fp(e,!0);if(t!==void 0&&t!==this.type)throw new Z(`cannot change marker ${e.id} type`);if(this.config=X.deepmerge(this.config,e),typeof this.config.tooltip==`string`&&(this.config.tooltip={content:this.config.tooltip}),this.config.tooltip&&!this.config.tooltip.trigger&&(this.config.tooltip.trigger=`hover`),X.isNil(this.config.visible)&&(this.config.visible=!0),X.isNil(this.config.zIndex)&&(this.config.zIndex=1),X.isNil(this.config.opacity)&&(this.config.opacity=1),this.config.rotation){let e=this.config.rotation;typeof e==`object`?this.config.rotation={yaw:e.yaw?X.parseAngle(e.yaw,!0,!1):0,pitch:e.pitch?X.parseAngle(e.pitch,!0,!1):0,roll:e.roll?X.parseAngle(e.roll,!0,!1):0}:this.config.rotation={yaw:0,pitch:0,roll:X.parseAngle(e,!0,!1)}}else this.config.rotation={yaw:0,pitch:0,roll:0};this.state.anchor=X.parsePoint(this.config.anchor)}getListContent(){return this.config.listContent?this.config.listContent:this.config.tooltip?.content?this.config.tooltip.content:this.config.html?this.config.html:this.id}showTooltip(e,t,n=!1){if(this.state.visible&&this.config.tooltip?.content&&this.state.position2D){let r={...this.config.tooltip,style:{pointerEvents:this.state.staticTooltip?`auto`:`none`},data:this,top:0,left:0};if(this.isPoly()||this.is3d()||this.isCss3d()){if(e||t){let n=X.getPosition(this.viewer.container);r.top=t-n.y+10,r.left=e-n.x,r.box={width:20,height:20}}else r.top=this.state.position2D.y,r.left=this.state.position2D.x}else{let e=this.viewer.dataHelper.vector3ToViewerCoords(this.state.positions3D[0]),t=this.state.size.width,n=this.state.size.height;this.config.hoverScale&&!this.state.staticTooltip&&(t*=this.config.hoverScale.amount,n*=this.config.hoverScale.amount),r.top=e.y-n*this.state.anchor.y+n/2,r.left=e.x-t*this.state.anchor.x+t/2,r.box={width:t,height:n}}this.tooltip?n?this.tooltip.update(this.config.tooltip.content,r):this.tooltip.move(r):this.tooltip=this.viewer.createTooltip(r)}}hideTooltip(){this.tooltip&&=(this.tooltip.hide(),null)}},mp=class extends pp{get domElement(){return this.element}constructor(e,t,n){super(e,t,n)}afterCreateElement(){this.element[Xf]=this}destroy(){delete this.element[Xf],super.destroy()}update(e){super.update(e);let t=this.domElement;t.id=`psv-marker-${this.config.id}`,t.setAttribute(`class`,`psv-marker`),this.state.visible&&t.classList.add(`psv-marker--visible`),this.config.tooltip&&t.classList.add(`psv-marker--has-tooltip`),this.config.content&&t.classList.add(`psv-marker--has-content`),this.config.className&&X.addClasses(t,this.config.className),t.style.opacity=`${this.config.opacity}`,t.style.zIndex=`${30+this.config.zIndex}`,this.config.style&&Object.assign(t.style,this.config.style)}},hp=class extends mp{constructor(e,t,n){super(e,t,n)}afterCreateElement(){super.afterCreateElement(),this.domElement.addEventListener(`transitionend`,()=>{this.domElement.style.transition=``})}render({viewerPosition:e,zoomLevel:t,hoveringMarker:n}){this.__updateSize();let r=this.viewer.dataHelper.vector3ToViewerCoords(this.state.positions3D[0]);return r.x-=this.state.size.width*this.state.anchor.x,r.y-=this.state.size.height*this.state.anchor.y,this.state.positions3D[0].dot(this.viewer.state.direction)>0&&r.x+this.state.size.width>=0&&r.x-this.state.size.width<=this.viewer.state.size.width&&r.y+this.state.size.height>=0&&r.y-this.state.size.height<=this.viewer.state.size.height?(this.domElement.style.translate=`${r.x}px ${r.y}px 0px`,this.applyScale({zoomLevel:t,viewerPosition:e,mouseover:this===n}),r):null}update(e){if(super.update(e),!X.isExtendedPosition(this.config.position))throw new Z(`missing marker ${this.id} position`);try{this.state.position=this.viewer.dataHelper.cleanPosition(this.config.position)}catch(e){throw new Z(`invalid marker ${this.id} position`,e)}this.state.positions3D=[this.viewer.dataHelper.sphericalCoordsToVector3(this.state.position)];let t=this.domElement;t.classList.add(`psv-marker--normal`),this.config.scale&&Array.isArray(this.config.scale)&&(this.config.scale={zoom:this.config.scale}),typeof this.config.hoverScale==`boolean`?this.config.hoverScale=this.config.hoverScale?this.plugin.config.defaultHoverScale||ep:null:typeof this.config.hoverScale==`number`?this.config.hoverScale={amount:this.config.hoverScale}:this.config.hoverScale||(this.config.hoverScale=this.plugin.config.defaultHoverScale),this.config.hoverScale&&(this.config.hoverScale={...this.plugin.config.defaultHoverScale,...this.config.hoverScale}),t.style.rotate=this.config.rotation.roll===0?null:V.radToDeg(this.config.rotation.roll)+`deg`,t.style.transformOrigin=`${this.state.anchor.x*100}% ${this.state.anchor.y*100}%`}__updateSize(){if(!this.needsUpdateSize)return;let e=this.domElement,t=!this.state.visible||!this.state.size;if(t&&e.classList.add(`psv-marker--transparent`),this.isSvg()){let t=e.firstElementChild.getBoundingClientRect();this.state.size={width:t.width,height:t.height}}else this.state.size={width:e.offsetWidth,height:e.offsetHeight};t&&e.classList.remove(`psv-marker--transparent`),this.isSvg()&&(e.style.width=this.state.size.width+`px`,e.style.height=this.state.size.height+`px`),this.type!==`element`&&(this.needsUpdateSize=!1)}applyScale({zoomLevel:e,viewerPosition:t,mouseover:n}){n!==null&&this.config.hoverScale&&(this.domElement.style.transition=`scale ${this.config.hoverScale.duration}ms ${this.config.hoverScale.easing}`);let r=1;if(typeof this.config.scale==`function`)r=this.config.scale(e,t);else if(this.config.scale){if(Array.isArray(this.config.scale.zoom)){let[t,n]=this.config.scale.zoom;r*=t+(n-t)*pc.EASINGS.inQuad(e/100)}if(Array.isArray(this.config.scale.yaw)){let[e,n]=this.config.scale.yaw,i=V.degToRad(this.viewer.state.hFov)/2,a=Math.abs(X.getShortestArc(this.state.position.yaw,t.yaw));r*=n+(e-n)*pc.EASINGS.outQuad(Math.max(0,(i-a)/i))}}n&&this.config.hoverScale&&(r*=this.config.hoverScale.amount),this.domElement.style.scale=`${r}`}},gp=`// https://www.8thwall.com/playground/chromakey-threejs
...
`,vp=class extends Wr{get map(){return this.uniforms.map.value}set map(e){this.uniforms.map.value=e}set alpha(e){this.uniforms.alpha.value=e}get offset(){return this.uniforms.offset.value}get repeat(){return this.uniforms.repeat.value}set chromaKey(e){this.uniforms.keying.value=e?.enabled===!0,e?.enabled&&(typeof e.color==`object`&&`r`in e.color?this.uniforms.color.value.set(e.color.r/255,e.color.g/255,e.color.b/255):this.uniforms.color.value.set(e.color??65280),this.uniforms.similarity.value=e.similarity??.2,this.uniforms.smoothness.value=e.smoothness??.2)}constructor(e){super({transparent:!0,depthTest:!1,depthWrite:!1,uniforms:{map:{value:e?.map},repeat:{value:new H(1,1)},offset:{value:new H(0,0)},alpha:{value:e?.alpha??1},keying:{value:!1},color:{value:new q(65280)},similarity:{value:.2},smoothness:{value:.2},spill:{value:.1}},vertexShader:_p,fragmentShader:gp}),this.chromaKey=e?.chromaKey}};function yp({src:e,withCredentials:t,muted:n,autoplay:r}){let i=document.createElement(`video`);return i.crossOrigin=t?`use-credentials`:`anonymous`,i.loop=!0,i.playsInline=!0,i.autoplay=r,i.muted=n,i.preload=`metadata`,e instanceof MediaStream?i.srcObject=e:i.src=e,i}function bp(e,t,n){let[r,i]=e,[a,o]=t,s=X.greatArcDistance(e,t),c=Math.sin((1-n)*s)/Math.sin(s),l=Math.sin(n*s)/Math.sin(s),u=c*Math.cos(i)*Math.cos(r)+l*Math.cos(o)*Math.cos(a),d=c*Math.cos(i)*Math.sin(r)+l*Math.cos(o)*Math.sin(a),f=c*Math.sin(i)+l*Math.sin(o);return[Math.atan2(d,u),Math.atan2(f,Math.sqrt(u*u+d*d))]}function xp(e){let t=[e[0]],n=0;for(let r=1;r<e.length;r++){let i=e[r-1][0]-e[r][0];i>Math.PI?n+=1:i<-Math.PI&&--n,t.push([e[r][0]+n*2*Math.PI,e[r][1]])}return t}function Sp(e){return e.reduce((e,t)=>e.add(t),new U).normalize()}function Cp(e){let t=xp(e),n=0,r=[];for(let e=0;e<t.length-1;e++){let i=X.greatArcDistance(t[e],t[e+1])*pc.SPHERE_RADIUS;r.push(i),n+=i}let i=0;for(let e=0;e<t.length-1;e++){if(i+r[e]>n/2){let a=(n/2-i)/r[e];return bp(t[e],t[e+1],a)}i+=r[e]}return t[Math.round(t.length/2)]}var wp=new U,Tp=new U,Ep=new U,Dp=new U,Op=new U,kp=new U;function Ap(e,t,n){wp.copy(n).normalize(),Tp.crossVectors(e,t).normalize(),Ep.crossVectors(Tp,e).normalize(),Dp.copy(e).multiplyScalar(-wp.dot(Ep)),Op.copy(Ep).multiplyScalar(wp.dot(e));let r=new U().addVectors(Dp,Op).normalize();return kp.crossVectors(r,wp),r.applyAxisAngle(kp,.01).multiplyScalar(pc.SPHERE_RADIUS)}var jp=class extends pp{get threeElement(){return this.element}get threeMesh(){return this.threeElement.children[0]}get video(){return this.type===`videoLayer`?this.threeMesh.material.map.image:null}constructor(e,t,n){super(e,t,n)}is3d(){return!0}createElement(){let e=new vp({alpha:0}),t=new Nr(new hi(1,1),e);t.userData={[Xf]:this},Object.defineProperty(t,"visible",{enumerable:!0,get:function(){return this.userData[Xf].config.visible},set:function(e){this.userData[Xf].config.visible=e}}),this.element=new ti().add(t),this.type===`videoLayer`&&this.viewer.needsContinuousUpdate(!0)}destroy(){delete this.threeMesh.userData[Xf],this.type===`videoLayer`&&(this.video.pause(),this.viewer.needsContinuousUpdate(!1)),super.destroy()}render(){return this.viewer.renderer.isObjectVisible(this.threeMesh)?this.viewer.dataHelper.sphericalCoordsToViewerCoords(this.state.position):null}update(e){super.update(e);let t=this.threeMesh,n=t.parent,r=t.material;if(X.isExtendedPosition(this.config.position)){try{this.state.position=this.viewer.dataHelper.cleanPosition(this.config.position)}catch(e){throw new Z(`invalid marker ${this.id} position`,e)}if(!this.config.size)throw new Z(`missing marker ${this.id} size`);this.state.size=this.config.size,t.scale.set(this.config.size.width/100,this.config.size.height/100,1),t.position.set(t.scale.x*(.5-this.state.anchor.x),t.scale.y*(this.state.anchor.y-.5),0),t.rotation.set(0,0,0),this.viewer.dataHelper.sphericalCoordsToVector3(this.state.position,n.position),n.lookAt(0,n.position.y,0),t.rotateY(-this.config.rotation.yaw),t.rotateX(-this.config.rotation.pitch),t.rotateZ(-this.config.rotation.roll);let e=t.geometry.getAttribute(`position`);this.state.positions3D=[0,1,3,2].map(n=>{let r=new U;return r.fromBufferAttribute(e,n),t.localToWorld(r)})}else{if(this.config.position?.length!==4)throw new Z(`missing marker ${this.id} position`);let e;try{e=this.config.position.map(e=>this.viewer.dataHelper.cleanPosition(e))}catch(e){throw new Z(`invalid marker ${this.id} position`,e)}let n=e.map(e=>this.viewer.dataHelper.sphericalCoordsToVector3(e)),i=Sp(n);this.state.position=this.viewer.dataHelper.vector3ToSphericalCoords(i),this.state.positions3D=n;let a=t.geometry.getAttribute(`position`);[n[0],n[1],n[3],n[2]].forEach((e,t)=>{a.setX(t,e.x),a.setY(t,e.y),a.setZ(t,e.z)}),a.needsUpdate=!0,this.__setTextureWrap(r)}switch(this.type){case`videoLayer`:if(this.definition!==this.config.videoLayer){r.map?.dispose();let e=yp({src:this.config.videoLayer,withCredentials:this.viewer.config.withCredentials(this.config.videoLayer),muted:!0,autoplay:this.config.autoplay??!0});r.map=new pi(e),r.alpha=0,e.addEventListener(`loadedmetadata`,()=>{this.viewer&&(r.alpha=this.config.opacity,X.isExtendedPosition(this.config.position)||(t.material.userData[Xf]={width:e.videoWidth,height:e.videoHeight},this.__setTextureWrap(r)))},{once:!0}),e.autoplay&&e.play(),this.definition=this.config.videoLayer}else r.alpha=this.config.opacity;break;case`imageLayer`:if(this.definition!==this.config.imageLayer){r.map?.dispose();let e=new Mt;r.map=e,r.alpha=0,this.viewer.textureLoader.loadImage(this.config.imageLayer).then(n=>{this.viewer&&(X.isExtendedPosition(this.config.position)||(t.material.userData[Xf]={width:n.width,height:n.height},this.__setTextureWrap(r)),e.image=n,e.anisotropy=4,e.needsUpdate=!0,r.alpha=this.config.opacity,this.viewer.needsUpdate())}),this.definition=this.config.imageLayer}else r.alpha=this.config.opacity}r.chromaKey=this.config.chromaKey,t.renderOrder=1e3+this.config.zIndex,t.geometry.boundingBox=null}__setTextureWrap(e){let t=e.userData[Xf];if(!t||!t.height||!t.width){e.repeat.set(1,1),e.offset.set(0,0);return}let n=this.config.position.map(e=>this.viewer.dataHelper.cleanPosition(e)),r=X.greatArcDistance([n[0].yaw,n[0].pitch],[n[1].yaw,n[1].pitch]),i=X.greatArcDistance([n[3].yaw,n[3].pitch],[n[2].yaw,n[2].pitch]),a=X.greatArcDistance([n[1].yaw,n[1].pitch],[n[2].yaw,n[2].pitch]),o=X.greatArcDistance([n[0].yaw,n[0].pitch],[n[3].yaw,n[3].pitch]),s=(r+i)/(a+o),c=t.width/t.height,l=0,u=0;s<c?l=c-s:u=1/c-1/s,e.repeat.set(1-l,1-u),e.offset.set(l/2,u/2)}},Mp=class extends mp{constructor(e,t,n){super(e,t,n),this.viewportIntersection=!1}get threeElement(){return this.object}isCss3d(){return!0}createElement(){this.element=document.createElement(`div`),this.object=new op(this.element),this.object.userData={[Xf]:this},Object.defineProperty(this.object,"visible",{enumerable:!0,get:function(){return this.userData[Xf].config.visible},set:function(e){this.userData[Xf].config.visible=e}}),this.afterCreateElement()}destroy(){delete this.object.userData[Xf],delete this.object,super.destroy()}render({viewerPosition:e,zoomLevel:t}){let n=this.domElement;if(this.state.size={width:n.offsetWidth,height:n.offsetHeight},this.state.positions3D[0].dot(this.viewer.state.direction)>0&&this.viewportIntersection){let n=this.viewer.dataHelper.sphericalCoordsToViewerCoords(this.state.position);return this.config.elementLayer.updateMarker?.({marker:this,position:n,viewerPosition:e,zoomLevel:t,viewerSize:this.viewer.state.size}),n}return null}update(e){if(super.update(e),!X.isExtendedPosition(this.config.position))throw new Z(`missing marker ${this.id} position`);try{this.state.position=this.viewer.dataHelper.cleanPosition(this.config.position)}catch(e){throw new Z(`invalid marker ${this.id} position`,e)}this.state.positions3D=[this.viewer.dataHelper.sphericalCoordsToVector3(this.state.position)];let t=this.threeElement,n=this.domElement;n.classList.add(`psv-marker--css3d`),n.childNodes.forEach(e=>e.remove()),n.appendChild(this.config.elementLayer),this.config.elementLayer.style.display=`block`,t.position.copy(this.state.positions3D[0]).multiplyScalar(100),t.lookAt(0,this.state.positions3D[0].y*100,0),t.rotateY(-this.config.rotation.yaw),t.rotateX(-this.config.rotation.pitch),t.rotateZ(-this.config.rotation.roll)}},Np=class extends hp{constructor(e,t,n){super(e,t,n)}isNormal(){return!0}createElement(){this.element=document.createElement(`div`),this.afterCreateElement()}render(e){let t=super.render(e);return t&&this.type===`element`&&this.config.element.updateMarker?.({marker:this,position:t,viewerPosition:e.viewerPosition,zoomLevel:e.zoomLevel,viewerSize:this.viewer.state.size}),t}update(e){super.update(e);let t=this.domElement;if(this.config.image&&!this.config.size)throw new Z(`missing marker ${this.id} size`);switch(this.config.size?(this.needsUpdateSize=!1,this.state.size=this.config.size,t.style.width=this.config.size.width+`px`,t.style.height=this.config.size.height+`px`):this.needsUpdateSize=!0,this.type){case`image`:this.definition=this.config.image,t.style.backgroundImage=`url("${this.config.image}")`;break;case`html`:this.definition=this.config.html,t.innerHTML=this.config.html;break;case`element`:this.definition!==this.config.element&&(this.definition=this.config.element,t.childNodes.forEach(e=>e.remove()),t.appendChild(this.config.element),this.config.element.style.display=`block`)}}},Pp=class extends mp{constructor(e,t,n){super(e,t,n)}createElement(){this.element=document.createElementNS(Yf,`path`),this.element[Xf]=this}isPoly(){return!0}get isPixels(){return this.type===`polygonPixels`||this.type===`polylinePixels`}get isPolygon(){return this.type===`polygon`||this.type===`polygonPixels`}get isPolyline(){return this.type===`polyline`||this.type===`polylinePixels`}get coords(){return this.definition}render(){let e=this.__getAllPolyPositions();if(e[0].length>(this.isPolygon?2:1)){let t=this.viewer.dataHelper.sphericalCoordsToViewerCoords(this.state.position),n=e.filter(e=>e.length>0).map(e=>{let n=`M`;return n+=e.map(e=>`${e.x-t.x},${e.y-t.y}`).join(`L`),this.isPolygon&&(n+=`Z`),n}).join(` `);return this.domElement.setAttributeNS(null,`d`,n),this.domElement.setAttributeNS(null,`transform`,`translate(${t.x} ${t.y})`),t}return null}update(e){super.update(e);let t=this.domElement;t.classList.add(`psv-marker--poly`),this.config.svgStyle?(Object.entries(this.config.svgStyle).forEach(([e,n])=>{t.setAttributeNS(null,X.dasherize(e),n)}),this.isPolyline&&!this.config.svgStyle.fill&&t.setAttributeNS(null,`fill`,`none`)):this.isPolygon?t.setAttributeNS(null,`fill`,`rgba(0,0,0,0.5)`):this.isPolyline&&(t.setAttributeNS(null,`fill`,`none`),t.setAttributeNS(null,`stroke`,`rgb(0,0,0)`));try{let e=this.config[this.type];if(!Array.isArray(e[0])&&typeof e[0]!=`object`)for(let t=0;t<e.length;t++)e.splice(t,2,[e[t],e[t+1]]);if(!Array.isArray(e[0][0])&&typeof e[0][0]!=`object`&&(e=[e]),this.isPolyline&&e.length>1)throw new Z(`polylines cannot have holes`);this.definition=this.isPixels?e.map(e=>e.map(e=>{let t;return t=X.isExtendedPosition(e)?this.viewer.dataHelper.cleanPosition(e):this.viewer.dataHelper.textureCoordsToSphericalCoords({textureX:e[0],textureY:e[1]}),[t.yaw,t.pitch]})):e.map(e=>e.map(e=>{let t;return t=X.isExtendedPosition(e)?this.viewer.dataHelper.cleanPosition(e):this.viewer.dataHelper.cleanPosition({yaw:e[0],pitch:e[1]}),[t.yaw,t.pitch]}))}catch(e){throw new Z(`invalid marker ${this.id} position`,e)}if(this.positions3D=this.coords.map(e=>e.map(e=>this.viewer.dataHelper.sphericalCoordsToVector3({yaw:e[0],pitch:e[1]}))),this.isPolygon){let e=Sp(this.positions3D[0]);this.state.position=this.viewer.dataHelper.vector3ToSphericalCoords(e)}else{let e=Cp(this.coords[0]);this.state.position={yaw:e[0],pitch:e[1]}}this.state.positions3D=this.positions3D[0]}__getAllPolyPositions(){return this.positions3D.map(e=>this.__getPolyPositions(e))}__getPolyPositions(e){let t=e.length,n=e.map(e=>({vector:e,visible:e.dot(this.viewer.state.direction)>0})),r=[];return n.forEach((e,i)=>{e.visible||[i===0?n[t-1]:n[i-1],i===t-1?n[0]:n[i+1]].forEach(t=>{t.visible&&r.push({visible:t.vector,invisible:e.vector,index:i})})}),r.reverse().forEach(e=>{n.splice(e.index,0,{vector:Ap(e.visible,e.invisible,this.viewer.state.direction),visible:!0})}),n.filter(e=>e.visible).map(e=>this.viewer.dataHelper.vector3ToViewerCoords(e.vector))}},Fp=class extends hp{get svgElement(){return this.domElement.firstElementChild}constructor(e,t,n){super(e,t,n)}isSvg(){return!0}createElement(){let e=this.type===`square`?`rect`:this.type,t=document.createElementNS(Yf,e);this.element=document.createElementNS(Yf,`svg`),this.element.appendChild(t),this.afterCreateElement()}update(e){super.update(e);let t=this.svgElement;switch(this.needsUpdateSize=!0,this.type){case`square`:this.definition={x:0,y:0,width:this.config.square,height:this.config.square};break;case`rect`:this.definition=Array.isArray(this.config.rect)?{x:0,y:0,width:this.config.rect[0],height:this.config.rect[1]}:{x:0,y:0,width:this.config.rect.width,height:this.config.rect.height};break;case`circle`:this.definition={cx:this.config.circle,cy:this.config.circle,r:this.config.circle};break;case`ellipse`:this.definition=Array.isArray(this.config.ellipse)?{cx:this.config.ellipse[0],cy:this.config.ellipse[1],rx:this.config.ellipse[0],ry:this.config.ellipse[1]}:{cx:this.config.ellipse.rx,cy:this.config.ellipse.ry,rx:this.config.ellipse.rx,ry:this.config.ellipse.ry};break;case`path`:this.definition={d:this.config.path}}Object.entries(this.definition).forEach(([e,n])=>{t.setAttributeNS(null,e,n)}),this.config.svgStyle?Object.entries(this.config.svgStyle).forEach(([e,n])=>{t.setAttributeNS(null,X.dasherize(e),n)}):t.setAttributeNS(null,`fill`,`rgba(0,0,0,0.5)`)}},Ip=X.getConfigParser({clickEventOnMarker:!1,gotoMarkerSpeed:`8rpm`,markers:null,defaultHoverScale:null},{defaultHoverScale(e){return e?(e===!0&&(e=ep),typeof e==`number`&&(e={amount:e}),{...ep,...e}):null}});function Lp(e){switch(fp(e,!1)){case`image`:case`html`:case`element`:return Np;case`imageLayer`:case`videoLayer`:return jp;case`elementLayer`:return Mp;case`polygon`:case`polyline`:case`polygonPixels`:case`polylinePixels`:return Pp;case`square`:case`rect`:case`circle`:case`ellipse`:case`path`:return Fp;default:throw new Z(`invalid marker type`)}}var Rp=class e extends Ld{constructor(e,t){super(e,t),this.markers={},this.state={allVisible:!0,showAllTooltips:!1,currentMarker:null,hoveringMarker:null,needsReRender:!1,lastClientX:null,lastClientY:null},this.container=document.createElement(`div`),this.container.className=`psv-markers`,this.viewer.container.appendChild(this.container),this.container.addEventListener(`contextmenu`,e=>e.preventDefault()),this.svgContainer=document.createElementNS(Yf,`svg`),this.svgContainer.setAttribute(`class`,`psv-markers-svg-container`),this.container.appendChild(this.svgContainer),this.css3DContainer=new up(e),this.container.appendChild(this.css3DContainer.element),this.container.addEventListener(`mouseenter`,this,!0),this.container.addEventListener(`mouseleave`,this,!0),this.container.addEventListener(`mousemove`,this,!0)}static withConfig(t){return[e,t]}init(){super.init(),X.checkStylesheet(this.viewer.container,`markers-plugin`),this.viewer.addEventListener(Q.ClickEvent.type,this),this.viewer.addEventListener(Q.DoubleClickEvent.type,this),this.viewer.addEventListener(Q.RenderEvent.type,this),this.viewer.addEventListener(Q.ConfigChangedEvent.type,this),this.viewer.addEventListener(Q.ObjectEnterEvent.type,this),this.viewer.addEventListener(Q.ObjectHoverEvent.type,this),this.viewer.addEventListener(Q.ObjectLeaveEvent.type,this),this.viewer.addEventListener(Q.ReadyEvent.type,this,{once:!0})}destroy(){this.clearMarkers(!1),this.viewer.unobserveObjects(Xf),this.viewer.removeEventListener(Q.ClickEvent.type,this),this.viewer.removeEventListener(Q.DoubleClickEvent.type,this),this.viewer.removeEventListener(Q.RenderEvent.type,this),this.viewer.removeEventListener(Q.ObjectEnterEvent.type,this),this.viewer.removeEventListener(Q.ObjectHoverEvent.type,this),this.viewer.removeEventListener(Q.ObjectLeaveEvent.type,this),this.viewer.removeEventListener(Q.ReadyEvent.type,this),this.css3DContainer.destroy(),this.viewer.container.removeChild(this.container),super.destroy()}handleEvent(e){switch(e.type){case Q.ReadyEvent.type:this.config.markers&&(this.setMarkers(this.config.markers),delete this.config.markers);break;case Q.RenderEvent.type:this.renderMarkers();break;case Q.ClickEvent.type:this.__onClick(e,!1);break;case Q.DoubleClickEvent.type:this.__onClick(e,!0);break;case Q.ObjectEnterEvent.type:case Q.ObjectLeaveEvent.type:case Q.ObjectHoverEvent.type:if(e.userDataKey===Xf){let t=e.originalEvent,n=e.object.userData[Xf];switch(e.type){case Q.ObjectEnterEvent.type:n.config.style?.cursor?this.viewer.setCursor(n.config.style.cursor):(n.config.tooltip||n.config.content)&&this.viewer.setCursor(`pointer`),this.__onEnterMarker(t,n);break;case Q.ObjectLeaveEvent.type:this.viewer.setCursor(null),this.__onLeaveMarker(n);break;case Q.ObjectHoverEvent.type:this.__onHoverMarker(t,n)}}break;case`mouseenter`:{let t=this.__getTargetMarker(X.getEventTarget(e));this.__onEnterMarker(e,t);break}case`mouseleave`:{let t=this.__getTargetMarker(X.getEventTarget(e));this.__onLeaveMarker(t);break}case`mousemove`:{let t=this.__getTargetMarker(X.getEventTarget(e),!0);this.__onHoverMarker(e,t);break}}}toggleAllMarkers(){this.state.allVisible?this.hideAllMarkers():this.showAllMarkers()}showAllMarkers(){this.state.allVisible=!0,Object.values(this.markers).forEach(e=>{e.config.visible=!0}),this.renderMarkers(),this.dispatchEvent(new Uf)}hideAllMarkers(){this.state.allVisible=!1,Object.values(this.markers).forEach(e=>{e.config.visible=!1}),this.renderMarkers(),this.dispatchEvent(new zf)}toggleAllTooltips(){this.state.showAllTooltips?this.hideAllTooltips():this.showAllTooltips()}showAllTooltips(){this.state.showAllTooltips=!0,Object.values(this.markers).forEach(e=>{e.state.staticTooltip=!0,e.showTooltip()})}hideAllTooltips(){this.state.showAllTooltips=!1,Object.values(this.markers).forEach(e=>{e.state.staticTooltip=!1,e.hideTooltip()})}getNbMarkers(){return Object.keys(this.markers).length}getMarkers(){return Object.values(this.markers)}addMarker(e,t=!0){if(this.markers[e.id])throw new Z(`marker "${e.id}" already exists`);let n=new(Lp(e))(this.viewer,this,e);n.isPoly()?this.svgContainer.appendChild(n.domElement):n.isCss3d()?this.css3DContainer.addObject(n):n.is3d()?this.viewer.renderer.addObject(n.threeElement):this.container.appendChild(n.domElement),this.markers[n.id]=n,this.state.showAllTooltips&&(n.state.staticTooltip=!0),t&&this.__afterChangeMarkers()}getMarker(e){let t=typeof e==`object`?e.id:e;if(!this.markers[t])throw new Z(`cannot find marker "${t}"`);return this.markers[t]}getCurrentMarker(){return this.state.currentMarker}updateMarker(e,t=!0){let n=this.getMarker(e.id);n.update(e),t&&(this.__afterChangeMarkers(),(n===this.state.hoveringMarker&&n.config.tooltip?.trigger===`hover`||n.state.staticTooltip)&&n.showTooltip(this.state.lastClientX,this.state.lastClientY,!0))}removeMarker(e,t=!0){let n=this.getMarker(e);n.isPoly()?this.svgContainer.removeChild(n.domElement):n.isCss3d()?this.css3DContainer.removeObject(n):n.is3d()?this.viewer.renderer.removeObject(n.threeElement):this.container.removeChild(n.domElement),this.state.hoveringMarker===n&&(this.state.hoveringMarker=null),this.state.currentMarker===n&&(this.state.currentMarker=null),n.destroy(),delete this.markers[n.id],t&&this.__afterChangeMarkers()}removeMarkers(e,t=!0){e.forEach(e=>this.removeMarker(e,!1)),t&&this.__afterChangeMarkers()}setMarkers(e,t=!0){this.clearMarkers(!1),e?.forEach(e=>{this.addMarker(e,!1)}),t&&this.__afterChangeMarkers()}clearMarkers(e=!0){Object.keys(this.markers).forEach(e=>{this.removeMarker(e,!1)}),e&&this.__afterChangeMarkers()}gotoMarker(e,t=this.config.gotoMarkerSpeed){let n=this.getMarker(e);return t?this.viewer.animate({...n.state.position,zoom:n.config.zoomLvl,speed:t}).then(()=>{this.dispatchEvent(new Df(n))}):(this.viewer.rotate(n.state.position),X.isNil(n.config.zoomLvl)||this.viewer.zoom(n.config.zoomLvl),this.dispatchEvent(new Df(n)),Promise.resolve())}hideMarker(e){this.toggleMarker(e,!1)}showMarker(e){this.toggleMarker(e,!0)}showMarkerTooltip(e){let t=this.getMarker(e);t.state.staticTooltip=!0,t.showTooltip()}hideMarkerTooltip(e){let t=this.getMarker(e);t.state.staticTooltip=!1,t.hideTooltip()}toggleMarker(e,t){let n=this.getMarker(e);n.config.visible=X.isNil(t)?!n.config.visible:t,this.renderMarkers()}showMarkerPanel(e){let t=this.getMarker(e);t.config.content?this.viewer.panel.show({id:Qf,content:t.config.content}):this.hideMarkerPanel()}hideMarkerPanel(){this.viewer.panel.hide(Qf)}toggleMarkersList(){this.viewer.panel.isVisible($f)?this.hideMarkersList():this.showMarkersList()}showMarkersList(){let e=[];Object.values(this.markers).forEach(t=>{t.config.visible&&!t.config.hideList&&e.push(t)});let t=new Gf(e);this.dispatchEvent(t),e=t.markers,this.viewer.panel.show({id:$f,content:tp(e,this.viewer.config.lang[qf.id]),noMargin:!0,clickHandler:e=>{let t=X.getClosest(e,`.psv-panel-menu-item`),n=t?t.dataset[Xf]:void 0;if(n){let e=this.getMarker(n);this.dispatchEvent(new Ff(e)),this.gotoMarker(e.id),this.hideMarkersList()}}})}hideMarkersList(){this.viewer.panel.hide($f)}renderMarkers(){if(this.state.needsReRender){this.state.needsReRender=!1;return}let e=this.viewer.getZoomLevel(),t=this.viewer.getPosition(),n=this.state.hoveringMarker;Object.values(this.markers).forEach(r=>{let i=r.config.visible,a=!1,o=null;i&&=(o=r.render({viewerPosition:t,zoomLevel:e,hoveringMarker:n}),!!o),a=r.state.visible!==i,r.state.visible=i,r.state.position2D=o,r.domElement&&X.toggleClass(r.domElement,`psv-marker--visible`,i),i?r.state.staticTooltip?r.showTooltip():r!==this.state.hoveringMarker&&r.hideTooltip():r.hideTooltip(),a&&(this.dispatchEvent(new Tf(r,i)),(r.is3d()||r.isCss3d())&&(this.state.needsReRender=!0))}),this.state.needsReRender&&this.viewer.needsUpdate()}__getTargetMarker(e,t=!1){if(e instanceof Node){let n=t?X.getClosest(e,`.psv-marker`):e;return n?n[Xf]:void 0}return Array.isArray(e)?e.map(e=>e.userData[Xf]).filter(e=>!!e).sort((e,t)=>t.config.zIndex-e.config.zIndex)[0]:null}__onEnterMarker(e,t){t&&(this.state.hoveringMarker=t,this.state.lastClientX=e.clientX,this.state.lastClientY=e.clientY,this.dispatchEvent(new jf(t)),t instanceof hp&&t.applyScale({zoomLevel:this.viewer.getZoomLevel(),viewerPosition:this.viewer.getPosition(),mouseover:!0}),!t.state.staticTooltip&&t.config.tooltip?.trigger===`hover`&&t.showTooltip(e.clientX,e.clientY))}__onLeaveMarker(e){e&&(this.dispatchEvent(new kf(e)),e instanceof hp&&e.applyScale({zoomLevel:this.viewer.getZoomLevel(),viewerPosition:this.viewer.getPosition(),mouseover:!1}),this.state.hoveringMarker=null,!e.state.staticTooltip&&e.config.tooltip?.trigger===`hover`?e.hideTooltip():e.state.staticTooltip&&e.showTooltip())}__onHoverMarker(e,t){t&&(this.state.lastClientX=e.clientX,this.state.lastClientY=e.clientY,(t.isPoly()||t.is3d()||t.isCss3d())&&t.config.tooltip?.trigger===`hover`&&t.showTooltip(e.clientX,e.clientY))}__onClick(e,t){let n=this.__getTargetMarker(e.data.objects),r=this.__getTargetMarker(e.data.target,!0)||n;this.state.currentMarker&&this.state.currentMarker!==r&&(this.dispatchEvent(new Lf(this.state.currentMarker)),this.viewer.panel.hide(Qf),!this.state.showAllTooltips&&this.state.currentMarker.config.tooltip?.trigger===`click`&&this.hideMarkerTooltip(this.state.currentMarker.id),this.state.currentMarker=null),r&&(this.state.currentMarker=r,this.dispatchEvent(new Nf(r,t,e.data.rightclick)),this.config.clickEventOnMarker?e.data.marker=r:e.stopImmediatePropagation(),this.markers[r.id]&&!e.data.rightclick&&(r.config.tooltip?.trigger===`click`?r.tooltip?this.hideMarkerTooltip(r.id):this.showMarkerTooltip(r.id):this.showMarkerPanel(r.id)))}__afterChangeMarkers(){this.__refreshUi(),this.__checkObjectsObserver(),this.viewer.needsUpdate(),this.dispatchEvent(new Vf(this.getMarkers()))}__refreshUi(){let e=Object.values(this.markers).filter(e=>!e.config.hideList).length;e===0?(this.viewer.panel.hide(Qf),this.viewer.panel.hide($f)):this.viewer.panel.isVisible($f)?this.showMarkersList():this.viewer.panel.isVisible(Qf)&&(this.state.currentMarker?this.showMarkerPanel(this.state.currentMarker.id):this.viewer.panel.hide()),this.viewer.navbar.getButton(qf.id,!1)?.toggle(e>0),this.viewer.navbar.getButton(np.id,!1)?.toggle(e>0)}__checkObjectsObserver(){Object.values(this.markers).some(e=>e.is3d())?this.viewer.observeObjects(Xf):this.viewer.unobserveObjects(Xf)}};Rp.id=`markers`,Rp.VERSION=`5.14.0`,Rp.configParser=Ip,Rp.readonlyOptions=[`markers`];var zp=Rp;zd.lang[qf.id]=`Markers`,zd.lang[np.id]=`Markers list`,Kd(qf,`caption:left`),Kd(np,`caption:left`);var Bp=Object.defineProperty;((e,t)=>{for(var n in t)Bp(e,n,{get:t[n],enumerable:!0})})({},{HideGalleryEvent:()=>Wp,ShowGalleryEvent:()=>Hp});var Vp=class e extends Jl{constructor(t){super(e.type),this.fullscreen=t}};Vp.type=`show-gallery`;var Hp=Vp,Up=class e extends Jl{constructor(){super(e.type)}};Up.type=`hide-gallery`;var Wp=Up,Gp=`<svg viewBox="185 115 330 330" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M186.7 326.7V163.3c0-15 8.3-23.3 23.3-23.3h210c15 0 23.3 8.3 23.3 23.3v163.4c0 15-8.3 23.3-23.3 23.3H210c-15 0-23.3-8.3-23.3-23.3zm70 70v-23.4H420c30.2 0 46.7-16.4 46.7-46.6V210H490c15 0 23.3 8.3 23.3 23.3v163.4c0 15-8.3 23.3-23.3 23.3H280c-15 0-23.3-8.3-23.3-23.3zm-23.8-105H397l-40-50.4-26.7 29.7-44.3-54.5zm106.7-76c9.6 0 17.8-7.8 17.8-17.2a18 18 0 0 0-17.8-17.8c-9.4 0-17.2 8.2-17.2 17.8 0 9.4 7.8 17.2 17.2 17.2z"/><!--Created by Wolf Böse from the Noun Project--></svg>`,Kp=class extends vd{constructor(e){super(e,{className:`psv-gallery-button`,hoverScale:!0,collapsable:!0,tabbable:!0,icon:Gp}),this.plugin=this.viewer.getPlugin(`gallery`),this.plugin&&(this.plugin.addEventListener(Hp.type,this),this.plugin.addEventListener(Wp.type,this))}destroy(){this.plugin&&(this.plugin.removeEventListener(Hp.type,this),this.plugin.removeEventListener(Wp.type,this)),super.destroy()}handleEvent(e){e instanceof Hp?this.toggleActive(!0):e instanceof Wp&&this.toggleActive(!1)}isSupported(){return!!this.plugin}onClick(){this.plugin.toggle()}};Kp.id=`gallery`;var qp=`psvGalleryItem`,Jp=X.dasherize(qp),Yp=`psv-gallery-item--active`,Xp=(e,t)=>`
${e.map(e=>`
...
`,Qp=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
  <defs>
...
</svg>`;function $p(e,t){let n;e.addEventListener(`mousedown`,()=>{t(),clearInterval(n),n=setInterval(()=>{e.style.pointerEvents===`none`?clearInterval(n):t()},500)}),e.addEventListener(`mouseup`,()=>{clearInterval(n)})}var em=class extends gd{constructor(e,t){super(t,{className:`psv-gallery ${pc.CAPTURE_EVENTS_CLASS}`}),this.plugin=e,this.state={visible:!0,mousedown:!1,initMouse:null,mouse:null,itemMargin:null,breakpoint:null,scrollLeft:0,scrollTop:0,isAboveBreakpoint:null},this.container.innerHTML=Qp,this.container.querySelector(`svg`).style.display=`none`;let n=document.createElement(`div`);n.className=`psv-panel-close-button`,n.innerHTML=pc.ICONS.close,this.container.appendChild(n),n.addEventListener(`click`,()=>this.plugin.hide()),this.items=document.createElement(`div`),this.items.className=`psv-gallery-container`,this.container.appendChild(this.items),this.config.navigationArrows&&(this.arrowLeft=document.createElement(`div`),this.arrowLeft.className=`psv-gallery-arrow`,this.arrowLeft.innerHTML=Zp,this.container.appendChild(this.arrowLeft),this.arrowRight=document.createElement(`div`),this.arrowRight.className=`psv-gallery-arrow`,this.arrowRight.innerHTML=Zp,this.container.appendChild(this.arrowRight),$p(this.arrowLeft,()=>this.__scroll(-1)),$p(this.arrowRight,()=>this.__scroll(1))),this.state.itemMargin=parseInt(X.getStyleProperty(this.items,`padding-left`),10),this.state.breakpoint=parseInt(X.getStyleProperty(this.container,`--psv-gallery-breakpoint`),10),this.observer=new IntersectionObserver(e=>{e.forEach(e=>{if(e.intersectionRatio>0){let t=e.target;t.style.backgroundImage=`url("${t.dataset.src}")`,delete t.dataset.src,this.observer.unobserve(e.target)}})},{root:this.viewer.container}),this.viewer.addEventListener(Q.SizeUpdatedEvent.type,this),this.container.addEventListener(`transitionend`,this),this.container.addEventListener(`keydown`,this),this.items.addEventListener(`wheel`,this),this.items.addEventListener(`scroll`,this),this.items.addEventListener(`mousedown`,this),this.items.addEventListener(`mousemove`,this),this.items.addEventListener(`click`,this),window.addEventListener(`mouseup`,this),this.hide()}get isAboveBreakpoint(){return this.items.offsetWidth>this.state.breakpoint}get config(){return this.plugin.config}destroy(){window.removeEventListener(`mouseup`,this),this.viewer.removeEventListener(Q.SizeUpdatedEvent.type,this),this.observer.disconnect(),super.destroy()}handleEvent(e){switch(e.type){case`transitionend`:this.isVisible()&&e.target===this.container&&this.__focusActiveOrFirst();break;case`keydown`:if(this.isVisible())switch(e.key){case pc.KEY_CODES.Escape:this.plugin.hide();break;case pc.KEY_CODES.Enter:this.__click(e)}break;case`wheel`:{let t=e;this.__scroll(t.deltaY>0?1:-1),e.preventDefault();break}case`scroll`:case Q.SizeUpdatedEvent.type:this.__updateArrows();break;case`mousedown`:this.state.mousedown=!0,this.isAboveBreakpoint?this.state.initMouse=e.clientX:this.state.initMouse=e.clientY,this.state.mouse=this.state.initMouse;break;case`mousemove`:if(this.state.mousedown){if(this.isAboveBreakpoint){let t=this.state.mouse-e.clientX;this.items.scrollLeft+=t,this.state.scrollLeft=this.items.scrollLeft,this.state.mouse=e.clientX}else{let t=this.state.mouse-e.clientY;this.items.scrollTop+=t,this.state.scrollTop=this.items.scrollTop,this.state.mouse=e.clientY}}break;case`mouseup`:this.state.mousedown=!1,this.state.mouse=null,e.preventDefault();break;case`click`:{let t=this.isAboveBreakpoint?e.clientX:e.clientY;Math.abs(this.state.initMouse-t)<10&&this.__click(e);break}}}show(){this.container.classList.add(`psv-gallery--open`),this.state.visible=!0}hide(){this.container.classList.remove(`psv-gallery--open`),this.state.visible=!1,X.hasParent(document.activeElement,this.container)&&this.viewer.navbar.focusButton(Kp.id)}setItems(e){this.items.innerHTML=Xp(e,this.plugin.config.thumbnailSize),this.observer&&(this.observer.disconnect(),this.items.querySelectorAll(`[data-src]`).forEach(e=>{this.observer.observe(e)})),this.__updateArrows()}setActive(e){if(this.items.querySelector(`.`+Yp)?.classList.remove(Yp),e){let t=this.items.querySelector(`[data-${Jp}="${e}"]`);t&&(t.classList.add(Yp),this.items.scrollLeft=t.offsetLeft+t.clientWidth/2-this.items.clientWidth/2)}}__click(e){let t=X.getMatchingTarget(e,`.psv-gallery-item`);if(!t)return;let n=t.dataset[qp];this.plugin.applyItem(n),this.setActive(n),(this.config.hideOnClick||!this.isAboveBreakpoint)&&this.hide()}__focusActiveOrFirst(){(this.items.querySelector(`.`+Yp)??this.items.firstElementChild)?.focus()}__scroll(e){if(this.isAboveBreakpoint){let t=this.items.scrollWidth-this.items.offsetWidth,n=this.plugin.config.thumbnailSize.width+(this.state.itemMargin??0);this.state.scrollLeft=V.clamp(this.state.scrollLeft+e*n,0,t),e===-1&&this.state.scrollLeft<n*.8&&(this.state.scrollLeft=0),e===1&&this.state.scrollLeft>t-n*.8&&(this.state.scrollLeft=t),this.items.scroll({left:this.state.scrollLeft,behavior:`smooth`})}else{let t=this.items.scrollHeight-this.items.offsetHeight,n=this.items.querySelector(`:first-child`).offsetHeight*2+(this.state.itemMargin??0);this.state.scrollTop=V.clamp(this.state.scrollTop+e*n,0,t),e===-1&&this.state.scrollTop<n*.8&&(this.state.scrollTop=0),e===1&&this.state.scrollTop>t-n*.8&&(this.state.scrollTop=t),this.items.scroll({top:this.state.scrollTop,behavior:`smooth`})}}__updateArrows(){if(!this.config.navigationArrows)return;this.state.isAboveBreakpoint!==this.isAboveBreakpoint&&(X.toggleClass(this.arrowLeft,`psv-gallery-arrow--left`,this.isAboveBreakpoint),X.toggleClass(this.arrowLeft,`psv-gallery-arrow--top`,!this.isAboveBreakpoint),X.toggleClass(this.arrowRight,`psv-gallery-arrow--right`,this.isAboveBreakpoint),X.toggleClass(this.arrowRight,`psv-gallery-arrow--bottom`,!this.isAboveBreakpoint),this.state.isAboveBreakpoint=this.isAboveBreakpoint);let e=(e,t)=>{t?(e.style.opacity=`1`,e.style.pointerEvents=`auto`):(e.style.opacity=`0`,e.style.pointerEvents=`none`)};if(this.isAboveBreakpoint){let t=this.items.scrollWidth-this.items.offsetWidth;e(this.arrowLeft,this.items.scrollLeft>50),e(this.arrowRight,this.items.scrollLeft<t-50)}else{let t=this.items.scrollHeight-this.items.offsetHeight;e(this.arrowLeft,this.items.scrollTop>50),e(this.arrowRight,this.items.scrollTop<t-50)}}},tm=X.getConfigParser({items:[],navigationArrows:!0,visibleOnLoad:!1,hideOnClick:!0,thumbnailSize:{width:200,height:100}}),nm=class e extends Ld{constructor(e,t){super(e,t),this.items=[],this.gallery=new em(this,this.viewer)}static withConfig(t){return[e,t]}init(){super.init(),X.checkStylesheet(this.viewer.container,`gallery-plugin`),this.map=this.viewer.getPlugin(`map`),this.plan=this.viewer.getPlugin(`plan`),this.viewer.addEventListener(Q.PanoramaLoadedEvent.type,this),this.viewer.addEventListener(Q.ShowPanelEvent.type,this),this.config.visibleOnLoad&&this.viewer.addEventListener(Q.ReadyEvent.type,()=>{this.items.length&&this.show()},{once:!0}),this.setItems(this.config.items),delete this.config.items,setTimeout(()=>this.__updateButton())}destroy(){this.viewer.removeEventListener(Q.PanoramaLoadedEvent.type,this),this.viewer.removeEventListener(Q.ShowPanelEvent.type,this),this.gallery.destroy(),super.destroy()}setOptions(e){super.setOptions(e),e.thumbnailSize&&this.gallery.setItems(this.items)}handleEvent(e){if(e instanceof Q.PanoramaLoadedEvent){let t=this.items.find(t=>X.deepEqual(t.panorama,e.data.panorama));this.currentId=t?.id,this.gallery.setActive(this.currentId)}else e instanceof Q.ShowPanelEvent&&this.gallery.isVisible()&&this.hide()}show(){return this.map?.minimize(),this.plan?.minimize(),this.dispatchEvent(new Hp(!this.gallery.isAboveBreakpoint)),this.gallery.show()}hide(){return this.dispatchEvent(new Wp),this.gallery.hide()}toggle(){this.gallery.isVisible()?this.hide():this.show()}isVisible(){return this.gallery.isVisible()}setItems(e,t){if(e?e.forEach((e,t)=>{if(!e.id)throw new Z(`Item ${t} has no "id".`);if(!e.panorama)throw new Z(`Item "${e.id}" has no "panorama".`)}):e=[],this.handler=t,this.items=e.map(e=>({...e,id:`${e.id}`})),this.gallery.setItems(this.items),this.currentId){let e=this.items.find(e=>e.id===this.currentId);this.currentId=e?.id,this.gallery.setActive(this.currentId)}this.items.length||this.gallery.hide(),this.__updateButton()}applyItem(e){if(e!==this.currentId){if(this.handler)this.handler(e);else{let t=this.items.find(t=>t.id===e);this.viewer.setPanorama(t.panorama,{caption:t.name,...t.options})}this.currentId=e}}__updateButton(){this.viewer.navbar.getButton(Kp.id,!1)?.toggle(this.items.length>0)}};nm.id=`gallery`,nm.VERSION=`5.14.0`,nm.configParser=tm,nm.readonlyOptions=[`items`,`navigationArrows`,`visibleOnLoad`];var rm=nm;zd.lang[Kp.id]=`Gallery`,Kd(Kp,`caption:left`);var im=Object.defineProperty;((e,t)=>{for(var n in t)im(e,n,{get:t[n],enumerable:!0})})({},{EnterArrowEvent:()=>cm,LeaveArrowEvent:()=>um,NodeChangedEvent:()=>om});var am=class e extends Jl{constructor(t,n){super(e.type),this.node=t,this.data=n}};am.type=`node-changed`;var om=am,sm=class e extends Jl{constructor(t,n){super(e.type),this.link=t,this.node=n}};sm.type=`enter-arrow`;var cm=sm,lm=class e extends Jl{constructor(t,n){super(e.type),this.link=t,this.node=n}};lm.type=`leave-arrow`;var um=lm,dm=class extends Rn{constructor(e=document.createElement(`div`)){super(),this.isCSS2DObject=!0,this.element=e,this.element.style.position=`absolute`,this.element.style.userSelect=`none`,this.element.setAttribute(`draggable`,!1),this.center=new H(.5,.5),this.addEventListener(`removed`,function(){this.traverse(function(e){e.element instanceof e.element.ownerDocument.defaultView.Element&&e.element.parentNode!==null&&e.element.remove()})})}copy(e,t){return super.copy(e,t),this.element=e.element.cloneNode(!0),this.center=e.center,this}},fm=new U,pm=new K,mm=new K,hm=new U,gm=new U,_m=class{constructor(e={}){let t=this,n,r,i,a,o={objects:new WeakMap},s=e.element===void 0?document.createElement(`div`):e.element;s.style.overflow=`hidden`,this.domElement=s,this.getSize=function(){return{width:n,height:r}},this.render=function(e,t){e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),pm.copy(t.matrixWorldInverse),mm.multiplyMatrices(t.projectionMatrix,pm),l(e,e,t),f(e)},this.setSize=function(e,t){n=e,r=t,i=n/2,a=r/2,s.style.width=e+`px`,s.style.height=t+`px`};function c(e){e.isCSS2DObject&&(e.element.style.display=`none`);for(let t=0,n=e.children.length;t<n;t++)c(e.children[t])}function l(e,n,r){if(e.visible===!1){c(e);return}if(e.isCSS2DObject){fm.setFromMatrixPosition(e.matrixWorld),fm.applyMatrix4(mm);let c=fm.z>=-1&&fm.z<=1&&e.layers.test(r.layers)===!0,l=e.element;l.style.display=c===!0?``:`none`,c===!0&&(e.onBeforeRender(t,n,r),l.style.transform=`translate(`+-100*e.center.x+`%,`+-100*e.center.y+`%)translate(`+(fm.x*i+i)+`px,`+(-fm.y*a+a)+`px)`,l.parentNode!==s&&s.appendChild(l),e.onAfterRender(t,n,r));let d={distanceToCameraSquared:u(r,e)};o.objects.set(e,d)}for(let t=0,i=e.children.length;t<i;t++)l(e.children[t],n,r)}function u(e,t){return hm.setFromMatrixPosition(e.matrixWorld),gm.setFromMatrixPosition(t.matrixWorld),hm.distanceToSquared(gm)}function d(e){let t=[];return e.traverseVisible(function(e){e.isCSS2DObject&&t.push(e)}),t}function f(e){let t=d(e).sort(function(e,t){return e.renderOrder===t.renderOrder?o.objects.get(e).distanceToCameraSquared-o.objects.get(t).distanceToCameraSquared:t.renderOrder-e.renderOrder}),n=t.length;for(let e=0,r=t.length;e<r;e++)t[e].element.style.zIndex=n-e}}},vm=new U,ym=new ut,bm=new U,xm=class extends Rn{constructor(e=document.createElement(`div`)){super(),this.isCSS3DObject=!0,this.element=e,this.element.style.position=`absolute`,this.element.style.pointerEvents=`auto`,this.element.style.userSelect=`none`,this.element.setAttribute(`draggable`,!1),this.addEventListener(`removed`,function(){this.traverse(function(e){e.element instanceof e.element.ownerDocument.defaultView.Element&&e.element.parentNode!==null&&e.element.remove()})})}copy(e,t){return super.copy(e,t),this.element=e.element.cloneNode(!0),this}},Sm=new K,Cm=new K,wm=class{constructor(e={}){let t=this,n,r,i,a,o={camera:{style:``},objects:new WeakMap},s=e.element===void 0?document.createElement(`div`):e.element;s.style.overflow=`hidden`,this.domElement=s;let c=document.createElement(`div`);c.style.transformOrigin=`0 0`,c.style.pointerEvents=`none`,s.appendChild(c);let l=document.createElement(`div`);l.style.transformStyle=`preserve-3d`,c.appendChild(l),this.getSize=function(){return{width:n,height:r}},this.render=function(e,t){let s=t.projectionMatrix.elements[5]*a;t.view&&t.view.enabled?(c.style.transform=`translate( ${-t.view.offsetX*(n/t.view.width)}px, ${-t.view.offsetY*(r/t.view.height)}px )`,c.style.transform+=`scale( ${t.view.fullWidth/t.view.width}, ${t.view.fullHeight/t.view.height} )`):c.style.transform=``,e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld();let f,p;t.isOrthographicCamera&&(f=-(t.right+t.left)/2,p=(t.top+t.bottom)/2);let h=t.view&&t.view.enabled?t.view.height/t.view.fullHeight:1,g=t.isOrthographicCamera?`scale( ${h} )scale(`+s+`)translate(`+u(f)+`px,`+u(p)+`px)`+d(t.matrixWorldInverse):`scale( ${h} )translateZ(`+s+`px)`+d(t.matrixWorldInverse),_=(t.isPerspectiveCamera?`perspective(`+s+`px) `:``)+g+`translate(`+i+`px,`+a+`px)`;o.camera.style!==_&&(l.style.transform=_,o.camera.style=_),m(e,e,t,g)},this.setSize=function(e,t){n=e,r=t,i=n/2,a=r/2,s.style.width=e+`px`,s.style.height=t+`px`,c.style.width=e+`px`,c.style.height=t+`px`,l.style.width=e+`px`,l.style.height=t+`px`};function u(e){return Math.abs(e)<1e-10?0:e}function d(e){let t=e.elements;return`matrix3d(`+u(t[0])+`,`+u(-t[1])+`,`+u(t[2])+`,`+u(t[3])+`,`+u(t[4])+`,`+u(-t[5])+`,`+u(t[6])+`,`+u(t[7])+`,`+u(t[8])+`,`+u(-t[9])+`,`+u(t[10])+`,`+u(t[11])+`,`+u(t[12])+`,`+u(-t[13])+`,`+u(t[14])+`,`+u(t[15])+`)`}function f(e){let t=e.elements;return`translate(-50%,-50%)`+(`matrix3d(`+u(t[0])+`,`+u(t[1])+`,`+u(t[2])+`,`+u(t[3])+`,`+u(-t[4])+`,`+u(-t[5])+`,`+u(-t[6])+`,`+u(-t[7])+`,`+u(t[8])+`,`+u(t[9])+`,`+u(t[10])+`,`+u(t[11])+`,`+u(t[12])+`,`+u(t[13])+`,`+u(t[14])+`,`+u(t[15])+`)`)}function p(e){e.isCSS3DObject&&(e.element.style.display=`none`);for(let t=0,n=e.children.length;t<n;t++)p(e.children[t])}function m(e,n,r,i){if(e.visible===!1){p(e);return}if(e.isCSS3DObject){let i=e.layers.test(r.layers)===!0,a=e.element;if(a.style.display=i===!0?``:`none`,i===!0){e.onBeforeRender(t,n,r);let i;e.isCSS3DSprite?(Sm.copy(r.matrixWorldInverse),Sm.transpose(),e.rotation2D!==0&&Sm.multiply(Cm.makeRotationZ(e.rotation2D)),e.matrixWorld.decompose(vm,ym,bm),Sm.setPosition(vm),Sm.scale(bm),Sm.elements[3]=0,Sm.elements[7]=0,Sm.elements[11]=0,Sm.elements[15]=1,i=f(Sm)):i=f(e.matrixWorld);let s=o.objects.get(e);if(s===void 0||s.style!==i){a.style.transform=i;let t={style:i};o.objects.set(e,t)}a.parentNode!==l&&l.appendChild(a),e.onAfterRender(t,n,r)}}for(let t=0,a=e.children.length;t<a;t++)m(e.children[t],n,r,i)}}},Tm=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
    <path fill-rule="even-odd" fill="currentColor" d="
        ...
        a 3.5,3.5 0 0 1 5,0
    "/>
</svg>`,Em=`tourLink`,Dm=`__tour-link__`,Om={className:`psv-virtual-tour-tooltip`,content:`<div class="psv-virtual-tour-loader"><div></div><div></div><div></div></div>`},km={element:()=>{let e=document.createElement(`button`);return e.className=`psv-virtual-tour-arrow`,e.innerHTML=Tm,e},size:{width:80,height:80}},Am=`arrow`,jm=class extends gd{constructor(e,t){super(e,{className:`psv-virtual-tour-arrows`}),this.plugin=t,this.renderer=this.is3D?new wm({element:this.container}):new _m({element:this.container}),this.camera=this.is3D?new Yr(30,1):null,this.scene=new ii,this.viewer.addEventListener(Q.ReadyEvent.type,this,{once:!0}),this.viewer.addEventListener(Q.PositionUpdatedEvent.type,this),this.viewer.addEventListener(Q.SizeUpdatedEvent.type,this),this.viewer.addEventListener(Q.RenderEvent.type,this),this.viewer.addEventListener(Q.ClickEvent.type,this),this.container.addEventListener(`mouseenter`,this,!0),this.container.addEventListener(`mouseleave`,this,!0),this.container.addEventListener(`mousemove`,this,!0),this.container.addEventListener(`contextmenu`,e=>e.preventDefault())}get is3D(){return this.plugin.is3D}get arrowsPosition(){return this.plugin.config.arrowsPosition}get arrowStyle(){return this.plugin.config.arrowStyle}init(){this.is3D&&(this.gallery=this.viewer.getPlugin(`gallery`),this.gallery?.addEventListener(`show-gallery`,this),this.gallery?.addEventListener(`hide-gallery`,this))}destroy(){this.viewer.removeEventListener(Q.ReadyEvent.type,this),this.viewer.removeEventListener(Q.PositionUpdatedEvent.type,this),this.viewer.removeEventListener(Q.SizeUpdatedEvent.type,this),this.viewer.removeEventListener(Q.RenderEvent.type,this),this.viewer.removeEventListener(Q.ClickEvent.type,this),this.gallery?.removeEventListener(`show-gallery`,this),this.gallery?.removeEventListener(`hide-gallery`,this),super.destroy()}handleEvent(e){switch(e.type){case Q.ReadyEvent.type:case Q.SizeUpdatedEvent.type:case Q.PositionUpdatedEvent.type:this.__updateCamera();break;case Q.RenderEvent.type:this.render();break;case Q.ClickEvent.type:{if(e.data.rightclick)break;let t=this.__getTargetLink(e.data.target,!0);t&&this.plugin.setCurrentNode(t.nodeId,null,t);break}case`mouseenter`:{let t=this.__getTargetLink(X.getEventTarget(e));t&&this.plugin.__onEnterArrow(t,e);break}case`mouseleave`:{let t=this.__getTargetLink(X.getEventTarget(e));t&&this.plugin.__onLeaveArrow(t);break}case`mousemove`:this.__getTargetLink(X.getEventTarget(e),!0)&&this.plugin.__onHoverArrow(e);break;case`hide-gallery`:this.__onToggleGallery(!1);break;case`show-gallery`:e.fullscreen||this.__onToggleGallery(!0)}}__updateCamera(){let e=this.viewer.getSize();if(this.renderer.setSize(e.width,e.height),this.is3D){let t=this.viewer.getPosition();t.pitch=V.clamp(t.pitch,-this.arrowsPosition.maxPitch,-this.arrowsPosition.minPitch),this.viewer.dataHelper.sphericalCoordsToVector3(t,this.camera.position,e.height*2).negate(),this.camera.lookAt(0,0,0),this.camera.translateY(e.height/3),this.camera.updateProjectionMatrix()}}render(){if(this.is3D){let e=this.viewer.getPosition(),t=[],n=2**53-1;this.scene.children.forEach(r=>{let i=r.userData[Am];if(i.conflict){let a=Math.abs(X.getShortestArc(e.yaw,i.yaw));n=Math.min(n,a),t.push([r,a])}}),t.forEach(([e,t])=>{let r=t!==n;e.element.style.opacity=r?`0.5`:null,e.element.style.zIndex=r?`-1`:null}),this.renderer.render(this.scene,this.camera)}else this.renderer.render(this.scene,this.viewer.renderer.camera)}clear(){this.scene.clear()}__buildArrowElement(e,t){if(t?.image){let e=document.createElement(`img`);return e.src=t.image,e}if(t?.element)return typeof t.element==`function`?t.element(e):t.element}addLinkArrow(e,t,n=1){let r=this.__buildArrowElement(e,e.arrowStyle);r||=this.__buildArrowElement(e,this.arrowStyle),r[Em]=e;let i={...this.arrowStyle,...e.arrowStyle};if(r.classList.add(`psv-virtual-tour-link`),i.className&&X.addClasses(r,i.className),i.style&&Object.assign(r.style,i.style),this.is3D){r.style.width=i.size.width*1.5+`px`,r.style.height=i.size.height*1.5+`px`;let e=!1;this.scene.children.forEach(n=>{let r=n.userData[Am];Math.abs(X.getShortestArc(r.yaw,t.yaw))<this.arrowsPosition.linkOverlapAngle&&(r.conflict=!0,e=!0)});let a=new xm(r);a.userData[Am]={yaw:t.yaw,conflict:e},a.rotation.set(-Math.PI/2,0,Math.PI-t.yaw),this.viewer.dataHelper.sphericalCoordsToVector3({yaw:t.yaw,pitch:0},a.position,n*100),this.scene.add(a)}else{r.style.width=i.size.width+`px`,r.style.height=i.size.height+`px`,r.style.pointerEvents=`auto`;let e=new dm(r);this.viewer.dataHelper.sphericalCoordsToVector3(t,e.position),this.scene.add(e)}}__getTargetLink(e,t=!1){let n=t?X.getClosest(e,`.psv-virtual-tour-link`):e;return n?n[Em]:void 0}__onToggleGallery(e){e?this.container.style.marginBottom=this.viewer.container.querySelector(`.psv-gallery`).offsetHeight+`px`:this.container.style.marginBottom=``}},Mm=class{constructor(e,t){this.plugin=e,this.viewer=t,this.nodes={}}destroy(){}checkNode(e){if(!e.id)throw new Z(`No id given for node`);if(!e.panorama)throw new Z(`No panorama provided for node ${e.id}`);if(this.plugin.isGps&&!(e.gps?.length>=2))throw new Z(`No GPS position provided for node ${e.id}`);if(!this.plugin.isGps&&e.markers?.some(e=>e.gps&&!e.position))throw new Z(`Cannot use GPS positioning for markers in manual mode`);e.links||=(X.logWarn(`Node ${e.id} has no links`),[])}checkLink(e,t){if(!t.nodeId)throw new Z(`Link of node ${e.id} has no target id`);if(t.nodeId===e.id)throw new Z(`Node ${e.id} links to itself`);if(!this.plugin.isGps&&!X.isExtendedPosition(t.position))throw new Z(`No position provided for link ${t.nodeId} of node ${e.id}`);if(this.plugin.isGps&&!t.gps)throw new Z(`No GPS position provided for link ${t.nodeId} of node ${e.id}`)}},Nm=class extends Mm{async loadNode(e){if(this.nodes[e])return this.nodes[e];throw new Z(`Node ${e} not found`)}setNodes(e){if(!e?.length)throw new Z(`No nodes provided`);let t={},n={};e.forEach(e=>{if(this.checkNode(e),t[e.id])throw new Z(`Duplicate node ${e.id}`);t[e.id]=e}),e.forEach(e=>{this.__checkLinks(e,t),e.links.forEach(e=>{n[e.nodeId]=!0})}),e.forEach(e=>{n[e.id]||X.logWarn(`Node ${e.id} is never linked to`)}),this.nodes=t}updateNode(e){if(!e.id)throw new Z(`No id given for node`);let t=this.nodes[e.id];if(!t)throw new Z(`Node ${e.id} does not exist`);return Object.assign(t,e),this.checkNode(t),this.__checkLinks(t,this.nodes),t}__checkLinks(e,t){e.links.forEach(n=>{if(!t[n.nodeId])throw new Z(`Target node ${n.nodeId} of node ${e.id} does not exists`);n.gps=n.gps||t[n.nodeId].gps,this.checkLink(e,n)})}},Pm=class extends Mm{constructor(e,t){if(super(e,t),!e.config.getNode)throw new Z(`Missing getNode() option.`);this.nodeResolver=e.config.getNode}async loadNode(e){if(this.nodes[e])return this.nodes[e];{let t=await this.nodeResolver(e);return this.checkNode(t),t.links.forEach(e=>{this.checkLink(t,e)}),this.nodes[e]=t,t}}clearCache(){this.nodes={}}};function Fm(e,t){let n=Im(e),r=Im(t),i=e[2]??0,a=t[2]??0,o=0;return i!==a&&(o=Math.atan((a-i)/Lm(n,r))),{yaw:Rm(n,r),pitch:o}}function Im(e){return[V.degToRad(e[0]),V.degToRad(e[1])]}function Lm(e,t){return X.greatArcDistance(e,t)*6371e3}function Rm(e,t){let[n,r]=e,[i,a]=t,o=Math.sin(i-n)*Math.cos(a),s=Math.cos(r)*Math.sin(a)-Math.sin(r)*Math.cos(a)*Math.cos(i-n);return Math.atan2(o,s)}var zm=X.getConfigParser({dataMode:`client`,positionMode:`manual`,renderMode:`3d`,nodes:null,getNode:null,startNodeId:null,preload:!1,transitionOptions:{showLoader:!0,speed:`20rpm`,effect:`fade`,rotation:!0},linksOnCompass:!0,showLinkTooltip:!0,getLinkTooltip:null,arrowStyle:km,arrowsPosition:{minPitch:.3,maxPitch:Math.PI/2,linkOverlapAngle:Math.PI/4,linkPitchOffset:-.1},map:null},{dataMode(e){if(e!==`client`&&e!==`server`)throw new Z(`VirtualTourPlugin: invalid dataMode`);return e},positionMode(e){if(e!==`gps`&&e!==`manual`)throw new Z(`VirtualTourPlugin: invalid positionMode`);return e},renderMode(e){if(e!==`3d`&&e!==`2d`)throw new Z(`VirtualTourPlugin: invalid renderMode`);return e},arrowsPosition(e,{defValue:t}){return{...t,...e}},arrowStyle(e,{defValue:t}){return{...t,...e}},map(e,{rawConfig:t}){if(e){if(t.dataMode===`server`)return X.logWarn(`VirtualTourPlugin: The map cannot be used in server side mode`),null;if(!e.imageUrl)return X.logWarn(`VirtualTourPlugin: configuring the map requires at least "imageUrl"`),null}return e}}),Bm=class e extends Ld{constructor(e,t){super(e,t),this.state={currentNode:null,currentTooltip:null,loadingNode:null,preload:{}},this.arrowsRenderer=new jm(this.viewer,this)}get is3D(){return this.config.renderMode===`3d`}get isServerSide(){return this.config.dataMode===`server`}get isGps(){return this.config.positionMode===`gps`}static withConfig(t){return[e,t]}init(){super.init(),this.arrowsRenderer.init(),X.checkStylesheet(this.viewer.container,`virtual-tour-plugin`),this.markers=this.viewer.getPlugin(`markers`),this.compass=this.viewer.getPlugin(`compass`),this.markers?.config.markers&&(X.logWarn("No default markers can be configured on the MarkersPlugin when using the VirtualTourPlugin. Consider defining `markers` on each tour node."),delete this.markers.config.markers),this.isGps&&(this.plan=this.viewer.getPlugin(`plan`)),this.isServerSide||(this.gallery=this.viewer.getPlugin(`gallery`),this.map=this.viewer.getPlugin(`map`),this.config.map&&!this.map&&X.logWarn(`The map is configured on the VirtualTourPlugin but the MapPlugin is not loaded.`)),this.datasource=this.isServerSide?new Pm(this,this.viewer):new Nm(this,this.viewer),this.map&&(this.map.addEventListener(`select-hotspot`,this),this.map.setImage(this.config.map.imageUrl)),this.plan?.addEventListener(`select-hotspot`,this),this.isServerSide?this.config.startNodeId&&this.setCurrentNode(this.config.startNodeId):this.config.nodes&&(this.setNodes(this.config.nodes,this.config.startNodeId),delete this.config.nodes)}destroy(){this.map?.removeEventListener(`select-hotspot`,this),this.plan?.removeEventListener(`select-hotspot`,this),this.datasource.destroy(),this.arrowsRenderer.destroy(),delete this.datasource,delete this.markers,delete this.compass,delete this.gallery,delete this.arrowsRenderer,super.destroy()}handleEvent(e){if(e instanceof Q.ClickEvent){let t=e.data.objects.find(e=>e.userData[Em])?.userData[Em];t&&this.setCurrentNode(t.nodeId,null,t)}else if(e.type===`select-hotspot`){let t=e.hotspotId;t.startsWith(Dm)&&this.setCurrentNode(t.substring(Dm.length))}}getCurrentNode(){return this.state.currentNode}setNodes(e,t){if(this.isServerSide)throw new Z(`Cannot set nodes in server side mode`);this.__hideTooltip(),this.state.currentNode=null,this.datasource.setNodes(e),t?this.datasource.nodes[t]||(t=e[0].id,X.logWarn(`startNodeId not found is provided nodes, resetted to ${t}`)):t=e[0].id,this.setCurrentNode(t),this.__setGalleryItems(),this.__setMapHotspots(),this.__setPlanHotspots()}setCurrentNode(e,t,n){if(e===this.state.currentNode?.id&&!t?.forceUpdate)return Promise.resolve(!0);t?.forceUpdate&&this.isServerSide&&this.datasource.clearCache(),this.viewer.hideError(),this.state.loadingNode=e;let r=this.state.currentNode,i=r&&n?this.__getLinkPosition(r,n):null;return Promise.resolve(this.state.preload[e]).then(()=>{if(this.state.loadingNode!==e)throw X.getAbortError();return this.datasource.loadNode(e)}).then(a=>{if(this.state.loadingNode!==e)throw X.getAbortError();let o={...zm.defaults.transitionOptions,rotateTo:i,zoomTo:i?this.viewer.getZoomLevel():null,...typeof this.config.transitionOptions==`function`?this.config.transitionOptions(a,r,n):this.config.transitionOptions,...t};return o.effect||=`none`,this.viewer.panel.hide(`description`),this.__hideTooltip(),this.arrowsRenderer.clear(),this.gallery?.config.hideOnClick&&this.gallery.hide(),this.map?.config.minimizeOnHotspotClick&&this.map.minimize(),this.plan?.config.minimizeOnHotspotClick&&this.plan.minimize(),o.rotation&&o.effect===`none`?this.viewer.animate({...o.rotateTo,zoom:o.zoomTo,speed:o.speed}).then(()=>[a,o]):Promise.resolve([a,o])}).then(([t,n])=>{if(this.state.loadingNode!==e)throw X.getAbortError();return this.markers?.clearMarkers(),this.config.linksOnCompass&&this.compass?.clearHotspots(),this.viewer.setPanorama(t.panorama,{caption:t.caption,description:t.description,panoData:t.panoData,sphereCorrection:t.sphereCorrection,showLoader:n.showLoader,position:n.rotateTo,zoom:n.zoomTo,transition:n.effect!==`none`&&{effect:n.effect,rotation:n.rotation,speed:n.speed}}).then(e=>{if(!e)throw X.getAbortError();return t})}).then(t=>{if(this.state.loadingNode!==e)throw X.getAbortError();return this.state.currentNode=t,this.map&&this.map.setCenter(this.__getNodeMapPosition(t)??this.map.config.center),this.plan?.setCoordinates(t.gps),this.__addNodeMarkers(t),this.__renderLinks(t),this.__preload(t),this.state.loadingNode=null,this.dispatchEvent(new om(t,{fromNode:r,fromLink:n,fromLinkPosition:i})),this.viewer.resetIdleTimer(),!0}).catch(e=>{if(X.isAbortError(e))return!1;throw this.viewer.showError(this.viewer.config.lang.loadError),this.viewer.loader.hide(),this.viewer.navbar.setCaption(``),this.state.loadingNode=null,e})}async gotoLink(e,t=`8rpm`){let n=this.getLinkPosition(e);t?await this.viewer.animate({...n,speed:t}):this.viewer.rotate(n)}getLinkPosition(e){let t=this.state.currentNode?.links.find(t=>t.nodeId===e);if(!t)throw new Z(`Cannot find link "${e}"`);return this.__getLinkPosition(this.state.currentNode,t)}updateNode(e){if(this.isServerSide)throw new Z(`Cannot update node in server side mode`);let t=this.datasource.updateNode(e);if((e.name||e.thumbnail||e.panorama)&&this.__setGalleryItems(),(e.name||e.gps||e.map)&&this.__setMapHotspots(),(e.name||e.gps||e.plan)&&this.__setPlanHotspots(),this.state.currentNode?.id===t.id){if(this.__hideTooltip(),e.panorama||e.panoData||e.sphereCorrection){this.setCurrentNode(t.id,{forceUpdate:!0});return}e.caption&&this.viewer.setOption(`caption`,t.caption),e.description&&this.viewer.setOption(`description`,t.description),(e.links||e.gps)&&this.__renderLinks(t),e.gps&&this.plan?.setCoordinates(t.gps),(e.map||e.gps)&&this.map?.setCenter(this.__getNodeMapPosition(t)),(e.markers||e.gps)&&this.__addNodeMarkers(t)}}__setGalleryItems(){this.gallery&&this.gallery.setItems(Object.values(this.datasource.nodes).filter(e=>e.showInGallery!==!1).map(e=>({id:e.id,panorama:e.panorama,name:e.name,thumbnail:e.thumbnail})),e=>{this.setCurrentNode(e)})}__setMapHotspots(){this.map&&this.map.setHotspots(Object.values(this.datasource.nodes).filter(e=>e.map!==!1).map(e=>({tooltip:e.name,...e.map||{},...this.__getNodeMapPosition(e),id:Dm+e.id})))}__setPlanHotspots(){this.plan&&this.plan.setHotspots(Object.values(this.datasource.nodes).filter(e=>e.plan!==!1).map(e=>({tooltip:e.name,...e.plan||{},coordinates:e.gps,id:Dm+e.id})))}__renderLinks(e){this.arrowsRenderer.clear();let t=[];e.links.forEach(n=>{let r=this.__getLinkPosition(e,n);r.yaw+=n.linkOffset?.yaw??0,r.pitch+=n.linkOffset?.pitch??0,this.isGps&&!this.is3D&&(r.pitch+=this.config.arrowsPosition.linkPitchOffset),t.push(r),this.arrowsRenderer.addLinkArrow(n,r,n.linkOffset?.depth)}),this.arrowsRenderer.render(),this.config.linksOnCompass&&this.compass?.setHotspots(t)}__getLinkPosition(e,t){return this.isGps?Fm(e.gps,t.gps):this.viewer.dataHelper.cleanPosition(t.position)}async __getTooltipContent(e){let t=await this.datasource.loadNode(e.nodeId),n=[];(t.name||t.thumbnail||t.caption)&&(t.name&&n.push(`<h3>${t.name}</h3>`),t.thumbnail&&n.push(`<img src="${t.thumbnail}">`),t.caption&&n.push(`<p>${t.caption}</p>`));let r=n.join(``);return this.config.getLinkTooltip&&(r=this.config.getLinkTooltip(r,e,t)),r}__onEnterArrow(e,t){let n=X.getPosition(this.viewer.container),r={x:t.clientX-n.x,y:t.clientY-n.y};this.config.showLinkTooltip&&(this.state.currentTooltip=this.viewer.createTooltip({...Om,left:r.x,top:r.y,box:{width:20,height:20}}),this.__getTooltipContent(e).then(e=>{e?this.state.currentTooltip.update(e):this.__hideTooltip()})),this.map?.setActiveHotspot(Dm+e.nodeId),this.plan?.setActiveHotspot(Dm+e.nodeId),this.dispatchEvent(new cm(e,this.state.currentNode))}__onHoverArrow(e){let t=X.getPosition(this.viewer.container),n={x:e.clientX-t.x,y:e.clientY-t.y};this.state.currentTooltip?.move({left:n.x,top:n.y})}__onLeaveArrow(e){this.__hideTooltip(),this.map?.setActiveHotspot(null),this.plan?.setActiveHotspot(null),this.dispatchEvent(new um(e,this.state.currentNode))}__hideTooltip(){this.state.currentTooltip?.hide(),this.state.currentTooltip=null}__preload(e){this.config.preload&&(this.state.preload[e.id]=!0,this.state.currentNode.links.filter(e=>!this.state.preload[e.nodeId]).filter(e=>typeof this.config.preload!=`function`||this.config.preload(this.state.currentNode,e)).forEach(e=>{this.state.preload[e.nodeId]=this.datasource.loadNode(e.nodeId).then(e=>this.viewer.textureLoader.preloadPanorama(e.panorama)).then(()=>{this.state.preload[e.nodeId]=!0}).catch(()=>{delete this.state.preload[e.nodeId]})}))}__addNodeMarkers(e){e.markers&&(this.markers?this.markers.setMarkers(e.markers.map(t=>(t.gps&&this.isGps&&(t.position=Fm(e.gps,t.gps),t.data?.map&&Object.assign(t.data.map,this.__getGpsMapPosition(t.gps)),t.data?.plan&&(t.data.plan.coordinates=t.gps)),t))):X.logWarn(`Node ${e.id} markers ignored because the plugin is not loaded.`))}__getNodeMapPosition(e){return this.__getGpsMapPosition(e.gps)||(e.map?{x:e.map.x,y:e.map.y}:null)}__getGpsMapPosition(e){let t=this.config.map;return this.isGps&&t&&t.extent&&t.size?{x:V.mapLinear(e[0],t.extent[0],t.extent[2],0,t.size.width),y:V.mapLinear(e[1],t.extent[1],t.extent[3],0,t.size.height)}:null}};Bm.id=`virtual-tour`,Bm.VERSION=`5.14.0`,Bm.configParser=zm,Bm.readonlyOptions=Object.keys(zm.defaults);var Vm=Bm,Hm=`https://photo-sphere-viewer-data.netlify.app/assets/`,Um=`./`.endsWith(`/`)?`./`:`.//`,Wm=e=>`${Um}${e.replace(/^\//,``)}`,Gm=typeof window<`u`?window.matchMedia(`(max-width: 768px)`):null,Km={width:180,height:110},qm={width:200,height:100},Jm=()=>Gm?.matches??!1,Ym=()=>Jm()?qm:Km,Xm=[`salavista1.jpg`,`salavista2.jpg`,`sala1.jpg`,`sala2.jpg`,`sala3.jpg`,`sala4.jpg`,`antesala.jpg`,`banheiroantesala.jpg`,`corredor1.jpg`,`corredor2.jpg`,`corredor3.jpg`,`quarto1.jpg`,`quarto1vista.jpg`,`banheiromeio.jpg`,`quarto2.jpg`,`quarto2vista.jpg`,`quarto3.jpg`,`quarto3vista.jpg`,`banheiroquarto3.jpg`,`cozinha1.jpg`,`cozinha2.jpg`,`cozinha3.jpg`,`banheiroempregada.jpg`,`empregadaquarto1.jpg`,`empregadaquarto2.jpg`],Zm={"salavista1.jpg":`Sala - Vista 1`,"salavista2.jpg":`Sala  Vista 2`,"sala1.jpg":`Sala Ambiente 1`,"sala2.jpg":`Sala Ambiente 2`,"sala3.jpg":`Sala Ambiente 3`,"sala4.jpg":`Sala Ambiente 4`,"antesala.jpg":`Antesala`,"banheiroantesala.jpg":`Banheiro da Antesala`,"corredor1.jpg":`Corredor 1`,"corredor2.jpg":`Corredor 2`,"corredor3.jpg":`Corredor 3`,"quarto1.jpg":`Quarto 1`,"quarto1vista.jpg":`Quarto 1 - Vista`,"banheiromeio.jpg":`Banheiro Social`,"quarto2.jpg":`Quarto 2`,"quarto2vista.jpg":`Quarto 2 - Vista`,"quarto3.jpg":`Quarto 3`,"quarto3vista.jpg":`Quarto 3 - Vista`,"banheiroquarto3.jpg":`Banheiro da Suíte 3`,"cozinha1.jpg":`Cozinha 1`,"cozinha2.jpg":`Cozinha 2`,"cozinha3.jpg":`Cozinha 3`,"banheiroempregada.jpg":`Banheiro de Serviço`,"empregadaquarto1.jpg":`Quarto de Serviço 1`,"empregadaquarto2.jpg":`Quarto de Serviço 2`},Qm=e=>e.replace(/\.(jpg|png)$/i,``).replace(/[-_]/g,` `).replace(/([a-z])([0-9])/gi,`$1 $2`).replace(/([0-9])([a-z])/gi,`$1 $2`).replace(/\b\w/g,e=>e.toUpperCase()),$m={};Xm.forEach(e=>{$m[e]||($m[e]=[])});var eh=new Set([...Xm,`seta.png`]),th=[],nh=e=>{th.includes(e)||th.push(e)};Xm.forEach(nh),Object.keys($m).forEach(nh);var rh=th.map(e=>{let t=eh.has(e),n=t?Wm(e):Hm+e,r=Wm(e.replace(/\.jpg$|\.png$/i,`.jpg`)),i=Hm+e.replace(/\.jpg$|\.png$/i,`.jpg`),a=t?r:i,o=Zm[e]??Qm(e);return{id:e.replace(/\W+/g,`-`),file:e,name:o,panorama:n,thumbnail:a}}),ih=new Map(rh.map(e=>[e.file,e.id])),ah=rh.map((e,t)=>{let n=rh[(t-1+rh.length)%rh.length],r=rh[(t+1)%rh.length],i=[];if(rh.length>1){if(i.push({nodeId:r.id,position:{yaw:Math.PI,pitch:0},arrowStyle:{className:`tour-arrow-next`}}),t!==0&&i.push({nodeId:n.id,position:{yaw:0,pitch:0},arrowStyle:{className:`tour-arrow-prev`}}),e.file===`antesala.jpg`){let e=ih.get(`corredor1.jpg`),t=ih.get(`banheiroantesala.jpg`);i.forEach(t=>{let n=t.arrowStyle?.className===`tour-arrow-next`;t.position={yaw:n?-Math.PI/2:Math.PI,pitch:0},n&&e&&(t.nodeId=e)}),t&&!i.some(e=>e.nodeId===t)&&i.push({nodeId:t,position:{yaw:Math.PI/2,pitch:0},arrowStyle:{className:`tour-arrow-next`}})}if(e.file===`corredor1.jpg`){let e=ih.get(`corredor2.jpg`),t=ih.get(`antesala.jpg`),n=ih.get(`cozinha1.jpg`);i.forEach(n=>{let r=n.arrowStyle?.className===`tour-arrow-next`;n.nodeId=r?e??n.nodeId:t??n.nodeId,n.arrowStyle={className:r?`tour-arrow-next`:`tour-arrow-prev`},n.position={yaw:r?Math.PI/2:Math.PI,pitch:0}}),n&&!i.some(e=>e.nodeId===n)&&i.push({nodeId:n,position:{yaw:3*Math.PI/4,pitch:0},arrowStyle:{className:`tour-arrow-next`}})}if(e.file===`cozinha1.jpg`){let e=ih.get(`corredor1.jpg`);i.filter(e=>e.arrowStyle?.className===`tour-arrow-next`).forEach(e=>{e.position={yaw:-Math.PI/2,pitch:0}});let t=i.find(e=>e.arrowStyle?.className===`tour-arrow-prev`);t?(t.position={yaw:Math.PI,pitch:0},t.nodeId=e??t.nodeId):e&&i.push({nodeId:e,position:{yaw:Math.PI,pitch:0},arrowStyle:{className:`tour-arrow-prev`}})}if(e.file===`cozinha2.jpg`){let e=ih.get(`corredor1.jpg`),t=ih.get(`cozinha3.jpg`)??i.find(e=>e.arrowStyle?.className===`tour-arrow-next`)?.nodeId??`cozinha3`,n=i.find(e=>e.arrowStyle?.className===`tour-arrow-prev`)?.nodeId??e??t,r={nodeId:t,position:{yaw:0,pitch:0},arrowStyle:{className:`tour-arrow-next`}},a={nodeId:n,position:{yaw:Math.PI/2,pitch:0},arrowStyle:{className:`tour-arrow-prev`}};i.length=0,i.push(r,a)}if(e.file===`corredor2.jpg`){let e=ih.get(`corredor1.jpg`),t=ih.get(`corredor3.jpg`),n=ih.get(`quarto3.jpg`);i.length=0,t&&i.push({nodeId:t,position:{yaw:0,pitch:0},arrowStyle:{className:`tour-arrow-next`}}),e&&i.push({nodeId:e,position:{yaw:-Math.PI/2,pitch:0},arrowStyle:{className:`tour-arrow-prev`}}),n&&i.push({nodeId:n,position:{yaw:Math.PI/2,pitch:0},arrowStyle:{className:`tour-arrow-next`}})}if(e.file===`banheiroantesala.jpg`){let e=i.find(e=>e.arrowStyle?.className===`tour-arrow-next`),t=ih.get(`antesala.jpg`),n=e?{...e,nodeId:t??e.nodeId,arrowStyle:{className:`tour-arrow-prev`}}:null;i.length=0,n&&i.push(n)}if(e.file===`sala1.jpg`&&i.forEach(e=>{e.arrowStyle?.className===`tour-arrow-next`&&(e.position={yaw:-Math.PI/2,pitch:0})}),e.file===`sala4.jpg`&&i.forEach(e=>{e.arrowStyle?.className===`tour-arrow-next`?e.position={yaw:Math.PI/2,pitch:0}:e.arrowStyle?.className===`tour-arrow-prev`&&(e.position={yaw:0,pitch:0})}),e.file===`salavista2.jpg`&&i.forEach(e=>{e.arrowStyle?.className===`tour-arrow-prev`&&(e.position={yaw:Math.PI/2,pitch:0})}),e.file===`quarto2vista.jpg`){let e=i.find(e=>e.arrowStyle?.className===`tour-arrow-next`),t=i.find(e=>e.arrowStyle?.className===`tour-arrow-prev`)??e;i.splice(0,i.length),t&&(t.arrowStyle={className:`tour-arrow-prev`},t.position=e?.position??t.position??{yaw:0,pitch:0},i.push(t))}if(e.file===`quarto3.jpg`){let e=ih.get(`corredor2.jpg`),t=ih.get(`banheiroquarto3.jpg`),n=ih.get(`quarto3vista.jpg`),r=ih.get(`quarto1.jpg`);i.length=0,e&&i.push({nodeId:e,position:{yaw:-Math.PI/2,pitch:0},arrowStyle:{className:`tour-arrow-prev`}}),r&&i.push({nodeId:r,position:{yaw:Math.PI,pitch:0},arrowStyle:{className:`tour-arrow-next`}}),t&&i.push({nodeId:t,position:{yaw:Math.PI,pitch:0},arrowStyle:{className:`tour-arrow-next`}}),n&&i.push({nodeId:n,position:{yaw:0,pitch:0},arrowStyle:{className:`tour-arrow-next`}})}if(e.file===`quarto1vista.jpg`){let e=i.find(e=>e.arrowStyle?.className===`tour-arrow-prev`);i.splice(0,i.length),e&&(e.position={yaw:Math.PI,pitch:0},i.push(e))}if(e.file===`quarto3vista.jpg`){let e=i.find(e=>e.arrowStyle?.className===`tour-arrow-next`),t=i.find(e=>e.arrowStyle?.className===`tour-arrow-prev`);i.splice(0,i.length);let n=t??e;n&&(n.arrowStyle={className:`tour-arrow-prev`},n.position=e?.position??n.position??{yaw:Math.PI,pitch:0},i.push(n))}if(e.file===`banheiroquarto3.jpg`){let e=ih.get(`quarto3.jpg`)??i[0]?.nodeId;i.length=0,i.push({nodeId:e??`quarto3`,position:{yaw:Math.PI,pitch:0},arrowStyle:{className:`tour-arrow-prev`}})}if(e.file===`quarto2.jpg`){let e=ih.get(`corredor3.jpg`),t=i.find(e=>e.arrowStyle?.className===`tour-arrow-next`),n=i.find(e=>e.arrowStyle?.className===`tour-arrow-prev`);if(t&&n){let r=n.position??{yaw:0,pitch:0},i=t.position??{yaw:Math.PI,pitch:0};t.position=r,n.position=i,e&&(n.nodeId=e)}}if(e.file===`quarto1.jpg`){let e=i.find(e=>e.arrowStyle?.className===`tour-arrow-next`),t=i.find(e=>e.arrowStyle?.className===`tour-arrow-prev`);if(e&&t){let n=t.position??{yaw:Math.PI,pitch:0},r=e.position??{yaw:0,pitch:0};e.position=n,t.position=r}}if(e.file===`corredor3.jpg`){let e=ih.get(`corredor2.jpg`),t=ih.get(`banheiromeio.jpg`),n=ih.get(`quarto1.jpg`),r=ih.get(`quarto2.jpg`);i.length=0,e&&i.push({nodeId:e,position:{yaw:Math.PI,pitch:0},arrowStyle:{className:`tour-arrow-prev`}}),t&&i.push({nodeId:t,position:{yaw:0,pitch:0},arrowStyle:{className:`tour-arrow-next`}}),n&&i.push({nodeId:n,position:{yaw:-Math.PI/2,pitch:0},arrowStyle:{className:`tour-arrow-next`}}),r&&i.push({nodeId:r,position:{yaw:Math.PI/2,pitch:0},arrowStyle:{className:`tour-arrow-next`}})}if(e.file===`banheiromeio.jpg`){let e=ih.get(`corredor3.jpg`)??i[0]?.nodeId;i.length=0,i.push({nodeId:e??`corredor3`,position:{yaw:Math.PI,pitch:0},arrowStyle:{className:`tour-arrow-prev`}})}}return{id:e.id,name:e.name,caption:e.name,panorama:e.panorama,thumbnail:e.thumbnail,markers:$m[e.file]||[],data:{file:e.file},links:i}}),oh=new Map(ah.map(e=>[e.id,e])),sh=ah[0]?.id,ch=new xf({container:`viewer`,panorama:sh?oh.get(sh)?.panorama??Wm(`salavista1.jpg`):Wm(`salavista1.jpg`),caption:`Parc national du Mercantour <b>&copy; Damien Sorel</b>`,loadingImg:`https://photo-sphere-viewer-data.netlify.app/assets/loader.gif`,touchmoveTwoFingers:!1,defaultZoomLvl:0,mousewheelCtrlKey:!1,navbar:[`zoom`,`gallery`,`fullscreen`],plugins:[zp,rm.withConfig({visibleOnLoad:!0,hideOnClick:!1,thumbnailSize:Ym(),items:rh,navigationArrows:!0}),Vm.withConfig({transitionOptions:()=>({effect:`fade`,rotation:!1,rotateTo:null,zoomTo:0})})]}),lh=ch.getPlugin(zp),uh=ch.getPlugin(rm),dh=ch.getPlugin(Vm),fh=e=>{if(!e||!lh||dh)return;let t=$m[e]||[];lh.setMarkers(t)},ph=()=>{Jm()&&ch.zoom(0)},mh=()=>{uh.setOptions({thumbnailSize:Ym()})};Gm?.addEventListener(`change`,()=>{mh(),ph()}),mh(),ph(),dh?.addEventListener(`node-changed`,()=>{ph()});var hh=!1;function gh(e){if(e)return oh.has(e)?oh.get(e):ah.find(t=>t.panorama===e||t.data?.file===e)}function _h(e){if(!e)return;let t=gh(e);if(dh&&t){dh.setCurrentNode(t.id).catch(e=>{console.error(`VirtualTour setCurrentNode error:`,e)});return}let n=t?.data?.file??e,r,i;n.startsWith(`http`)?(r=n,i=n):n.startsWith(`/`)?(r=n.replace(/^\//,``),i=Wm(r)):(r=n,i=eh.has(r)?Wm(r):Hm+r);let a=()=>{fh(r),ph(),ch.removeEventListener(`panorama-loaded`,a)};ch.addEventListener(`panorama-loaded`,a),ch.setPanorama(i,{zoom:0,transition:{duration:1e3,loader:!0}}).catch(e=>{ch.removeEventListener(`panorama-loaded`,a),console.error(`setPanorama error:`,e)})}uh.addEventListener(`select`,({item:e})=>{let t=e?.id??e?.panorama;t&&_h(t),setTimeout(()=>{if(hh)return;let e=document.querySelector(`.psv-gallery`);e&&(e.classList.add(`psv-gallery--open`),e.setAttribute(`aria-hidden`,`false`),e.style.display===`none`&&(e.style.display=``))},0)}),document.addEventListener(`click`,e=>{let t=e.target;if(!t||!t.closest(`.psv-gallery-button`))return;let n=document.querySelector(`.psv-gallery`);n&&(hh=!0,setTimeout(()=>hh=!1,200),n.classList.contains(`psv-gallery--open`)?(n.classList.remove(`psv-gallery--open`),n.setAttribute(`aria-hidden`,`true`),n.style.display=`none`):(n.classList.add(`psv-gallery--open`),n.setAttribute(`aria-hidden`,`false`),n.style.display=``))}),ch.addEventListener(`ready`,()=>{if(dh)try{dh.setNodes(ah,sh)}catch(e){console.error(`VirtualTour setNodes error:`,e)}else sh&&fh(oh.get(sh)?.data?.file);ph()});